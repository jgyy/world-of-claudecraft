...
const baseEnTable = {
  ...
  'log.marketFeePoolRestock':
    'The World Market restocked its shelves with new gear, funded by {pool} in trading fees!',
...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  zh_CN: {
    ...
    'log.marketFeePoolRestock': '世界市场用{pool}的交易手续费补充了新的货品！',
    'aura.tamed': '已驯服',
  ...
  zh_TW: {
    ...
    'log.marketFeePoolRestock': '世界市場用{pool}的交易手續費補充了新的貨品！',
    'aura.tamed': '馴服',
  ...
  ko_KR: {
    ...
    'log.marketFeePoolRestock':
      '월드 마켓이 거래 수수료 {pool}(으)로 새로운 물건을 재입고했습니다!',
    'aura.tamed': '길들여짐',
  ...
  ja_JP: {
    ...
    'log.marketFeePoolRestock': 'ワールドマーケットが取引手数料{pool}で新しい商品を補充しました！',
    'aura.tamed': 'テイム',
  ...
  ru_RU: {
    ...
    'log.marketFeePoolRestock':
      'Мировой рынок пополнил свои полки новым снаряжением за счёт {pool} торговых комиссий!',
    'aura.tamed': 'Приручён',
...
const RULES: Rule[] = [
  ...
  {
    re: /^The World Market restocked its shelves with new gear, funded by (.+) in trading fees!$/,
    build: (m) => tSim('log.marketFeePoolRestock', { pool: m[1] }),
  },
