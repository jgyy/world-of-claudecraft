...
const NPC_IDS = [
  ...
  'loremaster_caddis', 'ranger_elwyn', 'astronomer_veyra',
] as const;
...
const QUEST_IDS = [
  ...
  'q_obs_sightlines', 'q_obs_burrowlight', 'q_obs_cragmaw', 'q_obs_stormglare',
  'q_obs_shardlord', 'q_obs_ogrefires', 'q_obs_crushers', 'q_obs_brutok',
  'q_obs_wyrmwatchers', 'q_obs_deadstar',
] as const;
