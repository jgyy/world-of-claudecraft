...
export const guideStrings = {
  ...
  riftsPage: {
    ...
    forgeBody:
      'The band a ranked first clear mints is not finished when you receive it. Riftwright Maelis, who keeps a forge in the Watch Meadow beside the Breach Scholar in Gullhaven, will upgrade it step by step, lay one enchant on it, and set the coloured gems the rifts drop into its sockets. All of that is paid in Rift Essence and Rift gems, the forge currency that falls from rift bosses and trades freely, so a friend can hand you the essence you are short. Take the band off before you bring it to her: she works on what is in your bags, and she does nothing at all unless you are standing at her forge.',
