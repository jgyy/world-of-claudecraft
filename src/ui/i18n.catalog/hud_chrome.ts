...
export const hudChromeStrings = {
  ...
  bank: {
    ...
    depositAllTooltip:
      'Sends every crafting reagent, junk item, and gathering tool from your bags to the bank in one trip. Equipped gear, quest items, and consumables are never touched.',
