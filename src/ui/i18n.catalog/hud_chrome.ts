...
export const hudChromeStrings = {
  ...
  mounts: {
    ...
    desc_solmane_charger:
      "A radiant charger that runs the same road as a paladin's own Solar Step, its mane and tail blazing like living sunlight with every stride.",
  },
