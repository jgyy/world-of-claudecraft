...
export type TranslationKeyFlat =
  ...
  | 'heroicShop.upgradeAria'
  | 'heroicShop.upgradeConfirmAccept'
  | 'heroicShop.upgradeConfirmBody'
  | 'heroicShop.upgradeConfirmTitle'
  | 'heroicShop.upgradeEmpty'
  | 'heroicShop.upgradeIntro'
  | 'heroicShop.upgradeNotEligible'
  | 'heroicShop.upgradeNotEnoughMarks'
  | 'heroicShop.upgradeOutOfRange'
  | 'heroicShop.upgradeTitle'
  | 'heroicShop.upgraded'
  | 'highscores.desc'
  | 'highscores.title'
  | 'hud.arena.close'
  ...
  | 'hudChrome.soulKey.confirmBody'
  | 'hudChrome.soulKey.confirmCancel'
  | 'hudChrome.soulKey.confirmOk'
  | 'hudChrome.soulKey.confirmTitle'
  | 'hudChrome.soulKey.keyUse'
  | 'hudChrome.soulKey.menuAction'
  | 'hudChrome.soulKey.noneHeld'
  | 'hudChrome.soulKey.notBound'
  | 'hudChrome.soulKey.notEligible'
  | 'hudChrome.soulKey.released'
  | 'hudChrome.soulKey.unboundLine'
