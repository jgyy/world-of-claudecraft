...
export const table: ReliquaryLocaleTable = {
  ...
  horizons_tomes_of_passage: {
    name: 'Фолианты перехода',
    desc: 'Четыре Фолианта перехода, каждый из которых учит мага одной Великой телепортации. Их находят только маги, на рейдовых боссах Склепа Нитраксис и Горнила Последней Весны.',
  },
};
