...
const ITEM_ENTITY_IDS = [
  ...
  "highwatch_warhelm", "highwatch_pauldrons", "highwatch_girdle", "highwatch_gauntlets", "peakwool_hood", "peakwool_mantle", "peakwool_cord", "peakwool_gloves", "ridgestalker_cowl", "ridgestalker_spaulders", "ridgestalker_belt", "ridgestalker_grips",
  "reedwarden_greathelm", "reedwarden_pauldrons", "reedwarden_girdle", "reedwarden_gauntlets", "mistweaver_cowl", "mistweaver_mantle", "mistweaver_cord", "mistweaver_gloves", "marshstalker_hood", "marshstalker_spaulders", "marshstalker_belt", "marshstalker_grips",
  "drownhammer_warblade", "fensteel_longsword", "marshwarden_maul", "reedbinder_mace", "silt_dirk", "mirewhisper_dagger", "eelhide_saber", "boglight_staff", "fenmist_rod", "drownreed_cudgel", "marshlord_greatsword", "venomreed_kris",
  "stormtable_trencher", "ridgeline_meat_pie", "peakberry_tart", "smoked_summit_ram", "hearthstone_bread", "pinewarden_tea", "spiced_summit_cider", "frostmint_draught", "emberbark_brew", "highwatch_mulled_wine",
] as const;
...
const itemNamesEn = {
  ...
  entities: {
    ...
    items: itemTranslations([
      ...
      "Highwatch Warhelm", "Highwatch Pauldrons", "Highwatch War-Girdle", "Highwatch Gauntlets", "Peakwool Hood", "Peakwool Mantle", "Peakwool Cord", "Peakwool Gloves", "Ridgestalker Cowl", "Ridgestalker Spaulders", "Ridgestalker Belt", "Ridgestalker Grips",
            "Reedwarden's Greathelm", "Reedwarden's Pauldrons", "Reedwarden's Girdle", "Reedwarden's Gauntlets", "Mistweaver's Cowl", "Mistweaver's Mantle", "Mistweaver's Cord", "Mistweaver's Gloves", "Marshstalker's Hood", "Marshstalker's Spaulders", "Marshstalker's Belt", "Marshstalker's Grips",
      "Drownhammer Warblade", "Fensteel Longsword", "Marshwarden Maul", "Reedbinder Mace", "Silt-Worn Dirk", "Mirewhisper Dagger", "Eelhide Saber", "Boglight Staff", "Fenmist Rod", "Drownreed Cudgel", "Marshlord's Greatsword", "Venomreed Kris",
  "Stormtable Trencher", "Ridgeline Meat Pie", "Peakberry Tart", "Smoked Summit Ram", "Hearthstone Bread", "Pinewarden Tea", "Spiced Summit Cider", "Frostmint Draught", "Emberbark Brew", "Highwatch Mulled Wine",
]),
...
export const itemNames = {
  ...
  es: {
    ...
    entities: {
      ...
      "Yelmo de guerra de Highwatch", "Hombreras de Highwatch", "Faja de guerra de Highwatch", "Guanteletes de Highwatch", "Capucha de lana de cumbre", "Manto de lana de cumbre", "Cíngulo de lana de cumbre", "Guantes de lana de cumbre", "Capucha del acechador de crestas", "Hombreras del acechador de crestas", "Cinturón del acechador de crestas", "Guantes del acechador de crestas",
            "Yelmo del Guardacañas", "Hombreras del Guardacañas", "Cinturón del Guardacañas", "Guanteletes del Guardacañas", "Cogulla del Tejedor de Niebla", "Manto del Tejedor de Niebla", "Cordón del Tejedor de Niebla", "Guantes del Tejedor de Niebla", "Capucha del Acechador del Pantano", "Hombreras del Acechador del Pantano", "Cinturón del Acechador del Pantano", "Empuñaduras del Acechador del Pantano",
      "Espada de guerra del Martillo Ahogado", "Espadón de acero del pantano", "Mazo del Guardián de la Marisma", "Maza Atajuncos", "Daga gastada por el limo", "Daga susurro del cieno", "Sable de piel de anguila", "Bastón de luz del pantano", "Vara de niebla del pantano", "Garrote de caña ahogada", "Mandoble del Señor de la Marisma", "Cris de caña venenosa",
  "Trinchero de Stormtable", "Pastel de carne de la cordillera", "Tarta de bayas de cumbre", "Carnero ahumado de la cima", "Pan de piedra de hogar", "Té de Pinewarden", "Sidra especiada de la cumbre", "Brebaje de menta helada", "Cerveza de corteza de brasa", "Vino caliente especiado de Highwatch",
]),
  ...
  fr_FR: {
    ...
    entities: {
      ...
      "Heaume de guerre de Highwatch", "Épaulières de Highwatch", "Ceinturon de guerre de Highwatch", "Gantelets de Highwatch", "Capuche en laine des cimes", "Mantelet en laine des cimes", "Cordelière en laine des cimes", "Gants en laine des cimes", "Cagoule du rôdeur des crêtes", "Épaulières du rôdeur des crêtes", "Ceinture du rôdeur des crêtes", "Gants du rôdeur des crêtes",
            "Heaume du Gardien des roseaux", "Spallières du Gardien des roseaux", "Ceinturon du Gardien des roseaux", "Gantelets du Gardien des roseaux", "Coule du Tisse-brume", "Mantelet du Tisse-brume", "Cordon du Tisse-brume", "Gants du Tisse-brume", "Capuche du Traque-marais", "Épaulières du Traque-marais", "Ceinture du Traque-marais", "Poignes du Traque-marais",
      "Lame de guerre du Marteau-noyé", "Épée longue en acier des fens", "Maillet du Gardien des marais", "Masse Lie-roseaux", "Dirk usé par le limon", "Dague Murmure-du-bourbier", "Sabre en peau d'anguille", "Bâton de luciole des marais", "Verge de brume des fens", "Gourdin de roseau noyé", "Grande épée du Seigneur des marais", "Kris de roseau venimeux",
  "Tranchoir de Stormtable", "Tourte à la viande de la crête", "Tarte aux baies des cimes", "Bélier des sommets fumé", "Pain de l'âtre", "Thé de Pinewarden", "Cidre épicé des sommets", "Breuvage de menthe glaciale", "Bière d'écorce de braise", "Vin chaud épicé de Highwatch",
]),
  ...
  it_IT: {
    ...
    entities: {
      ...
      "Elmo da guerra di Highwatch", "Spallacci di Highwatch", "Cintura da guerra di Highwatch", "Manopole di Highwatch", "Cappuccio di lana delle vette", "Mantellina di lana delle vette", "Cordone di lana delle vette", "Guanti di lana delle vette", "Cappuccio del predatore dei crinali", "Spalline del predatore dei crinali", "Cintura del predatore dei crinali", "Guanti del predatore dei crinali",
            "Elmo del Guardiano dei canneti", "Spallacci del Guardiano dei canneti", "Cintura del Guardiano dei canneti", "Guanti d'arme del Guardiano dei canneti", "Cappuccio del Tessitore di nebbia", "Mantellina del Tessitore di nebbia", "Cordone del Tessitore di nebbia", "Guanti del Tessitore di nebbia", "Cappuccio del Cacciatore di palude", "Spalline del Cacciatore di palude", "Cintura del Cacciatore di palude", "Prese del Cacciatore di palude",
      "Lama da guerra del Martello Annegato", "Spadone d'acciaio palustre", "Maglio del Guardiano della Palude", "Mazza Legacanne", "Daga consumata dal limo", "Pugnale Sussurro del Pantano", "Sciabola di pelle d'anguilla", "Bastone di luce palustre", "Verga di nebbia palustre", "Randello di canna annegata", "Spadone del Signore della Palude", "Kris di canna velenosa",
  "Tagliere di Stormtable", "Torta di carne del crinale", "Crostata di bacche di vetta", "Montone affumicato della cima", "Pane del focolare", "Tè di Pinewarden", "Sidro speziato di vetta", "Bevanda di menta gelata", "Birra di corteccia di brace", "Vin brulé speziato di Highwatch",
]),
  ...
  de_DE: {
    ...
    entities: {
      ...
      "Highwatch-Kriegshelm", "Highwatch-Schulterplatten", "Highwatch-Kriegsgürtel", "Highwatch-Panzerhandschuhe", "Gipfelwollkapuze", "Gipfelwollmantel", "Gipfelwollkordel", "Gipfelwollhandschuhe", "Gratpirscher-Gugel", "Gratpirscher-Schulterstücke", "Gratpirscher-Gürtel", "Gratpirscher-Handschuhe",
            "Schilfwächter-Schlachthelm", "Schilfwächter-Schulterstücke", "Schilfwächter-Gürtel", "Schilfwächter-Panzerhandschuhe", "Nebelweber-Kapuze", "Nebelweber-Umhang", "Nebelweber-Kordel", "Nebelweber-Handschuhe", "Sumpfpirscher-Kapuze", "Sumpfpirscher-Schulterstücke", "Sumpfpirscher-Gürtel", "Sumpfpirscher-Griffe",
      "Kriegsklinge des Ertränkhammers", "Fenstahl-Langschwert", "Marschwächter-Streithammer", "Schilfbinder-Streitkolben", "Schlickbenarbter Dolch", "Moorflüster-Dolch", "Aalhaut-Säbel", "Moorlicht-Stab", "Fennebel-Rute", "Ertränkschilf-Knüppel", "Großschwert des Marschfürsten", "Giftschilf-Kris",
  "Stormtable-Brettjause", "Bergkamm-Fleischpastete", "Gipfelbeeren-Törtchen", "Geräucherter Gipfelwidder", "Herdstein-Brot", "Pinewarden-Tee", "Gewürzter Gipfelcider", "Frostminze-Trunk", "Glutborken-Bräu", "Highwatch-Glühwein",
]),
  ...
  zh_CN: {
    ...
    entities: {
      ...
      "高望战盔", "高望护肩", "高望战腰带", "高望护手", "峰羊毛兜帽", "峰羊毛披肩", "峰羊毛束带", "峰羊毛手套", "山脊追猎者头罩", "山脊追猎者护肩", "山脊追猎者腰带", "山脊追猎者手套",
            "苇卫巨盔", "苇卫肩铠", "苇卫腰带", "苇卫战手", "织雾者头巾", "织雾者披肩", "织雾者腰索", "织雾者手套", "沼泽潜行者兜帽", "沼泽潜行者肩饰", "沼泽潜行者腰带", "沼泽潜行者手扣",
      "溺锤战刃", "沼钢长剑", "沼泽守望者重槌", "缚芦钉锤", "淤泥磨蚀短刀", "沼语匕首", "鳗皮军刀", "沼光法杖", "沼雾魔杖", "溺芦短棍", "沼泽领主巨剑", "毒芦波刃刀",
  "风暴餐桌木盘餐", "山脊肉派", "峰顶浆果挞", "烟熏峰巅公羊", "炉石面包", "松卫茶", "香料峰顶苹果酒", "霜薄荷饮剂", "余烬树皮酿", "高守热红酒",
]),
  ...
  zh_TW: {
    ...
    entities: {
      ...
      "高望戰盔", "高望護肩", "高望戰腰帶", "高望護手", "峰羊毛兜帽", "峰羊毛披肩", "峰羊毛束帶", "峰羊毛手套", "山脊追獵者頭罩", "山脊追獵者護肩", "山脊追獵者腰帶", "山脊追獵者手套",
            "葦衛巨盔", "葦衛肩鎧", "葦衛腰帶", "葦衛戰手", "織霧者頭巾", "織霧者披肩", "織霧者腰索", "織霧者手套", "沼澤潛行者兜帽", "沼澤潛行者肩飾", "沼澤潛行者腰帶", "沼澤潛行者手扣",
      "溺錘戰刃", "沼鋼長劍", "沼澤守望者重槌", "縛蘆釘錘", "淤泥磨蝕短刀", "沼語匕首", "鰻皮軍刀", "沼光法杖", "沼霧魔杖", "溺蘆短棍", "沼澤領主巨劍", "毒蘆波刃刀",
  "風暴餐桌木盤餐", "山脊肉派", "峰頂漿果撻", "煙燻峰巔公羊", "爐石麵包", "松衛茶", "香料峰頂蘋果酒", "霜薄荷飲劑", "餘燼樹皮釀", "高守熱紅酒",
]),
  ...
  ko_KR: {
    ...
    entities: {
      ...
      "하이워치 전투 투구", "하이워치 어깨갑옷", "하이워치 전투 허리띠", "하이워치 건틀릿", "봉우리양모 두건", "봉우리양모 망토", "봉우리양모 허리끈", "봉우리양모 장갑", "산등성이추적자 두건", "산등성이추적자 어깨보호구", "산등성이추적자 허리띠", "산등성이추적자 손보호구",
            "갈대수호자의 대투구", "갈대수호자의 견갑", "갈대수호자의 허리띠", "갈대수호자의 건틀릿", "안개술사의 두건", "안개술사의 망토", "안개술사의 끈", "안개술사의 장갑", "늪추적자의 후드", "늪추적자의 어깨보호구", "늪추적자의 벨트", "늪추적자의 손아귀",
      "익사망치 전투검", "펜강철 롱소드", "늪수호자 대형철퇴", "갈대결속 철퇴", "진흙에 닳은 더크", "수렁속삭임 단검", "뱀장어가죽 세이버", "늪빛 지팡이", "펜안개 봉", "익사갈대 곤봉", "늪군주의 대검", "독갈대 크리스",
  "스톰테이블 나무판 요리", "산등성이 고기 파이", "봉우리 베리 타르트", "정상 숫양 훈제구이", "화로석 빵", "파인워든 차", "향신료 봉우리 사이다", "서리박하 음료", "잉걸나무껍질 양조주", "하이워치 뱅쇼",
]),
  ...
  ja_JP: {
    ...
    entities: {
      ...
      "ハイウォッチの戦兜", "ハイウォッチの肩当て", "ハイウォッチの戦帯", "ハイウォッチのガントレット", "峰羊毛のフード", "峰羊毛のマント", "峰羊毛の腰紐", "峰羊毛の手袋", "尾根追跡者の頭巾", "尾根追跡者の肩当て", "尾根追跡者のベルト", "尾根追跡者の手甲",
            "葦守の大兜", "葦守の肩当て", "葦守の帯", "葦守の篭手", "霧織りのフード", "霧織りのマント", "霧織りの腰紐", "霧織りの手袋", "沼の追跡者のフード", "沼の追跡者の肩当て", "沼の追跡者のベルト", "沼の追跡者の握り",
      "溺れ槌の戦刃", "沼鋼のロングソード", "沼守りのモール", "葦縛りのメイス", "泥磨きのダーク", "沼囁きのダガー", "ウナギ皮のサーベル", "沼火の杖", "沼霧のロッド", "溺れ葦のカジェル", "沼領主の大剣", "毒葦のクリス",
  "ストームテーブルの木皿料理", "尾根肉のミートパイ", "頂のベリータルト", "山頂雄羊の燻製", "炉石のパン", "パインワーデン茶", "香辛料入り山頂サイダー", "霜ミントの一杯", "燃え差し樹皮の醸造酒", "ハイウォッチのホットワイン",
]),
  ...
  pt_BR: {
    ...
    entities: {
      ...
      "Elmo de guerra de Highwatch", "Ombreiras de Highwatch", "Cinturão de guerra de Highwatch", "Manoplas de Highwatch", "Capuz de lã das alturas", "Manto de lã das alturas", "Cordão de lã das alturas", "Luvas de lã das alturas", "Capuz do espreitador de cristas", "Ombreiras do espreitador de cristas", "Cinto do espreitador de cristas", "Luvas do espreitador de cristas",
            "Elmo do Guardião dos juncos", "Ombreiras do Guardião dos juncos", "Cinturão do Guardião dos juncos", "Manoplas do Guardião dos juncos", "Capuz do Tecelão de névoa", "Manto do Tecelão de névoa", "Cordão do Tecelão de névoa", "Luvas do Tecelão de névoa", "Capuz do Espreitador do pântano", "Espaldares do Espreitador do pântano", "Cinto do Espreitador do pântano", "Punhos do Espreitador do pântano",
      "Lâmina de guerra do Martelo Afogado", "Espada longa de aço do brejo", "Malho do Guardião do Pântano", "Maça Prendejunco", "Adaga gasta pelo lodo", "Adaga Sussurro do Brejo", "Sabre de pele de enguia", "Cajado de luz do brejo", "Vara de névoa do brejo", "Cacete de junco afogado", "Espadão do Senhor do Pântano", "Kris de junco venenoso",
  "Tábua de pão de Stormtable", "Torta de carne da cordilheira", "Torta de frutas do cume", "Carneiro defumado do cume", "Pão da lareira", "Chá de Pinewarden", "Sidra especiada do cume", "Poção de hortelã gélida", "Cerveja de casca de brasa", "Vinho quente especiado de Highwatch",
]),
  ...
  ru_RU: {
    ...
    entities: {
      ...
      "Боевой шлем Хайвотча", "Наплечники Хайвотча", "Боевой пояс Хайвотча", "Латные перчатки Хайвотча", "Капюшон из горной шерсти", "Накидка из горной шерсти", "Шнур из горной шерсти", "Перчатки из горной шерсти", "Клобук Хребтового Охотника", "Оплечье Хребтового Охотника", "Пояс Хребтового Охотника", "Перчатки Хребтового Охотника",
            "Большой шлем Стража тростников", "Наплечники Стража тростников", "Пояс Стража тростников", "Латные перчатки Стража тростников", "Капюшон Ткача тумана", "Накидка Ткача тумана", "Шнур Ткача тумана", "Перчатки Ткача тумана", "Капюшон Болотного охотника", "Наплечники Болотного охотника", "Пояс Болотного охотника", "Хваты Болотного охотника",
      "Боевой клинок Утонувшего Молота", "Болотностальной длинный меч", "Молот Болотного Стража", "Булава Вязателя Тростника", "Кортик, истёртый илом", "Кинжал Болотного Шёпота", "Сабля из кожи угря", "Посох болотного огонька", "Жезл болотного тумана", "Дубина утонувшего тростника", "Двуручный меч Владыки Болот", "Крис ядовитого тростника",
  "Разделочная доска Штормстола", "Мясной пирог с хребта", "Тарт с горными ягодами", "Копчёный горный баран", "Хлеб с очага", "Чай Пайнвардена", "Пряный горный сидр", "Морозно-мятный напиток", "Эль из тлеющей коры", "Пряный глинтвейн Хайвотча",
]),
...
export const en = {
  ...
  fiesta: {
    ...
    augment: {
      ...
      aug_bulwark: { name: "Bulwark", desc: "Gain 350 armor. Hold the line." },
      aug_zealotry: { name: "Zealotry", desc: "Gain 200 attack power. Swing with purpose." },
      aug_focus: { name: "Focus", desc: "+6% critical strike and +8% spell damage. Sharpen the mind." },
      aug_second_wind: { name: "Second Wind", desc: "Heal for 8% of all damage you deal. Keep moving." },
      aug_executioner: { name: "Executioner", desc: "+22% physical damage and +8% crit. Finish what you start." },
      aug_stormcaller: { name: "Stormcaller", desc: "+22% spell damage and +12% move speed. Kite and burn." },
      aug_bastion: { name: "Bastion", desc: "+15% maximum health, +350 armor and +5% dodge. Weather it." },
      aug_revenant: { name: "Revenant", desc: "Heal for 18% of damage dealt and gain +10% maximum health." },
      aug_warbringer: { name: "Warbringer", desc: "+35% physical damage, +12% crit and +250 attack power." },
      aug_cataclysm: { name: "Cataclysm", desc: "+45% spell damage and +18% crit. Unmake them." },
      aug_immortal: { name: "Immortal", desc: "+35% maximum health, +700 armor and +10% dodge. Refuse to fall." },
      aug_bloodlord: { name: "Bloodlord", desc: "+25% all damage, heal for 20% of damage dealt, +15% move speed." },
    },
    tier: {
      silver: "Silver",
      gold: "Gold",
