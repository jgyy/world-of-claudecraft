...
export const en = {
  ...
  entities: {
    ...
    items: {
      ...
      // fishing catch pack
      raw_brook_minnow: { name: "Raw Brook Minnow" },
      raw_silver_perch: { name: "Raw Silver Perch" },
      raw_mossgill_snapper: { name: "Raw Mossgill Snapper" },
      waterlogged_boot: { name: "Waterlogged Boot" },
      raw_mire_eel: { name: "Raw Mire Eel" },
      raw_bogfin_catfish: { name: "Raw Bogfin Catfish" },
      murky_tangleweed: { name: "Murky Tangleweed" },
      rusted_lockbox: { name: "Rusted Lockbox" },
      raw_thornpeak_grayling: { name: "Raw Thornpeak Grayling" },
      raw_stormcrag_pike: { name: "Raw Stormcrag Pike" },
      glacial_char: { name: "Glacial Char" },
      anglers_lucky_coin: { name: "Angler's Lucky Coin" },
    },
