...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    ...
    "mobs": {
      ...
      "tunnel_gravemite": {
        "name": "Туннельный клещ-могильщик"
      },
      "deep_road_stalker": {
        "name": "Глубинный сталкер"
      },
      "the_old_prospector": {
        "name": "Старый старатель"
      },
      "ironvein_foreman": {
    ...
    "npcs": {
      ...
      "foreman_delke": {
        "name": "Бригадир Делке",
        "title": "Последний из бригады Затонувшей дороги",
        "greeting": "Старая шахтная дорога все еще ведет в Фенбридж, если ты не боишься тамошней нечисти, {className}."
      },
      "tidewatcher_ondrel": {
        "name": "Ондрел Вейн",
    ...
    "quests": {
      ...
      "q_sunken_road": {
        "title": "Расчистка Затонувшей дороги",
        "text": "Моя бригада прорыла эту дорогу до самого Фенбриджа, пока туда не забрались могильщики. Прорядите их, {playerName}, и сталкеров в глубине, чтобы честные люди снова могли ходить по ней.",
        "completion": "Чистый воздух и тихий камень. Спасибо тебе, в Фенбридже тоже об этом услышат.",
        "objectives": {
          "0": {
            "label": "Убийство туннельных клещей-могильщиков"
          },
          "1": {
