...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "account": {
      "open": "Аккаунт",
      "openAria": "Открыть настройки аккаунта",
      "title": "Настройки аккаунта",
      "close": "Закрыть",
      "closeAria": "Закрыть настройки аккаунта",
      "working": "Обработка…",
      "infoHeading": "Аккаунт",
      "usernameLabel": "Имя пользователя",
      "emailInfoLabel": "Эл. почта",
      "emailNone": "Не задано",
      "memberSince": "Дата регистрации",
      "lastLogin": "Последний вход",
      "lastLoginNever": "Никогда",
      "charactersLabel": "Персонажи",
      "emailHeading": "Контактная эл. почта",
      "emailNote": "Необязательно. Сохраняется для будущего восстановления аккаунта — мы пока не отправляем письма.",
      "emailLabel": "Адрес эл. почты",
      "saveEmailBtn": "Сохранить эл. почту",
      "emailSaved": "Эл. почта сохранена.",
      "emailCleared": "Эл. почта удалена.",
      ...
      "dangerHeading": "Деактивация аккаунта",
      "dangerWarning": "Это деактивирует ваш аккаунт и выполнит выход на всех устройствах. Персонажи сохранятся, но войти снова не получится — для повторной активации обратитесь в поддержку.",
      "deletePasswordLabel": "Пароль",
      "deleteConfirmLabel": "Введите имя пользователя для подтверждения",
      "deleteBtn": "Деактивировать аккаунт",
      "deleted": "Аккаунт деактивирован.",
      "errIncorrectPassword": "Неверный пароль.",
      "errSamePassword": "Новый пароль должен отличаться от текущего.",
      "errInvalidEmail": "Введите корректный адрес эл. почты.",
      "errDeleteConfirm": "Введите имя пользователя точно, чтобы подтвердить деактивацию.",
      "errDeleteOnline": "Выйдите из всех персонажей перед деактивацией аккаунта.",
      "errDeactivated": "Этот аккаунт деактивирован. Для повторной активации обратитесь в поддержку.",
      "errAccountNotFound": "Аккаунт не найден.",
      "errRateLimited": "Слишком много запросов — подождите и повторите попытку."
    }
  },
  "skinEvent": {
