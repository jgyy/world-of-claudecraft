...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "voiceChatConsentNote": "Вы будете автоматически подключены к ближайшим игрокам, у которых тоже включена эта функция. Поскольку соединение прямое (без сервера-ретранслятора), подключённые игроки могут видеть ваш публичный IP-адрес. Вы можете отключить это в любой момент.",
      "voiceChatMicDenied": "Доступ к микрофону запрещен. Голосовому чату нужен микрофон для работы.",
      "voiceChatMuted": "Отключить мой микрофон",
      "voiceChatVolume": "Громкость голосового чата",
