...
export const ru_RU: EnTranslations = {
  ...
  "itemUi": {
    ...
    "market": {
      ...
      "jackpotNote": "Торговец копит {pool} комиссии к следующему пополнению запасов.",
