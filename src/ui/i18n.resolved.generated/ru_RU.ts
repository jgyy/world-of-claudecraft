...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_daily_wolves": {
        "title": "Ежедневно: Прореживание стаи",
        "text": "Волки не перестают пробовать северную дорогу на прочность, {playerName}. Проредите их снова сегодня. Убейте 6 лесных волков, и я вам заплачу.",
        "completion": "Отличная работа. День, когда волки несут потери, — это день победы Истбрука.",
        "objectives": {
          "0": {
            "label": "Лесной волк: убито"
          }
      ...
      "q_daily_boars": {
        "title": "Ежедневно: Кабанья напасть",
        "text": "Кабаны на западных лугах роют поля быстрее, чем крестьяне успевают их чинить. Уложите для меня 6 диких кабанов, {playerName}.",
        "completion": "Крестьяне будут вам благодарны, пусть даже кабаны — нет.",
        "objectives": {
          "0": {
            "label": "Дикий кабан: убито"
          }
        }
      },
      "q_daily_spiders": {
        "title": "Ежедневно: Расчистка паутины",
        "text": "Затаившиеся в восточном лесу плодятся быстрее, чем мы жжём их паутину. Истребите сегодня 5 соболиных затаившихся, {playerName}.",
        "completion": "Одним гнездом для беспокойства меньше. Благодарю.",
        "objectives": {
          "0": {
            "label": "Соболиный затаившийся: убито"
          }
        }
      },
      "q_daily_murlocs": {
        "title": "Ежедневно: Оттеснить мутноплавов",
        "text": "Мутноплавы каждую ночь подбираются всё выше от озера. Загоните 5 из них обратно на мелководье, {playerName}.",
        "completion": "Берег озера стал чуть безопаснее. Хорошо сделано.",
        "objectives": {
          "0": {
            "label": "Мутноплав-пролаза: убито"
          }
        }
      },
      "q_daily_bandits": {
        "title": "Ежедневно: Правосудие на дороге",
        "text": "Дорожные разбойники снова обнаглели. Предайте 4 из них правосудию, {playerName}, и караваны пойдут спокойнее.",
        "completion": "На четыре ножа на дороге меньше. Караваны у вас в долгу.",
        "objectives": {
          "0": {
            "label": "Долинный разбойник: убито"
          }
        }
      },
      "q_daily_rats": {
        "title": "Ежедневно: Борьба с вредителями",
        "text": "Шахтёры не могут удержать роющих вредителей подальше от копей. Уложите сегодня 6 глубинных землекопов, и они смогут работать спокойно.",
        "completion": "Ха! Шахтёры вернутся к кирке и лопате. Благодарю, {playerName}.",
        "objectives": {
          "0": {
            "label": "Глубинный землекоп: убито"
          }
        }
      },
      "q_daily_fangs": {
        "title": "Ежедневно: Трофей из клыков",
        "text": "В этом сезоне награду платят за клыки. Принесите мне 5 волчьих клыков от лесных волков, {playerName}.",
        "completion": "Пять чистых клыков. Награда ваша.",
        "objectives": {
          "0": {
            "label": "Волчий клык"
          }
      ...
      "q_daily_legs": {
        "title": "Ежедневно: Паучьи части",
        "text": "Аптекарше нужны паучьи лапы для её настоек, и она платит за каждую. Соберите 5 паучьих лап в восточном лесу, {playerName}.",
        "completion": "Она будет довольна. Вот ваша доля.",
        "objectives": {
          "0": {
            "label": "Паучья лапа"
          }
