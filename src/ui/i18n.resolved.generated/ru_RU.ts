...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "autoFaceOnCast": "Автоповорот к цели при касте",
      "autoFaceOnCastHelp": "Когда вы применяете способность по выбранной цели, ваш персонаж поворачивается лицом к ней, чтобы удары и снаряды исходили спереди. Отключите для классического поведения: применение по цели, к которой вы не повёрнуты, отклоняется, и вам нужно повернуться самостоятельно.",
