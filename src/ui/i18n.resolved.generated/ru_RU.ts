...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bank": {
      ...
      "depositAllTooltip": "Отправляет в банк все материалы для крафта, хлам и инструменты для добычи из ваших сумок за один раз. Надетое снаряжение, квестовые предметы и расходники не затрагиваются.",
