...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "economy": {
      ...
      "marketGiveawayBody": "그 작은 수수료는 단순한 수수료가 아닙니다. 공동 기금으로 쌓여 정기적으로 상인의 진열대에 새 장비를 채워 넣으며, 전액 거래 수수료로 조달됩니다. 참가하거나 받을 필요가 없습니다. 새 물건은 그냥 상인의 상시 재고 속에 나타나며, 다른 상시 매물과 마찬가지로 누구나 구매할 수 있습니다."
    },
    "social": {
  ...
  "itemUi": {
    ...
    "market": {
      ...
      "jackpotNote": "상인이 다음 재입고를 위해 수수료 {pool}을(를) 모으고 있습니다.",
