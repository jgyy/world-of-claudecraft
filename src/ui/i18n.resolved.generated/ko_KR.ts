...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "account": {
      ...
      "charactersLabel": "캐릭터",
      "emailHeading": "연락 이메일",
      "emailNote": "선택 사항. 향후 계정 복구를 위해 저장됩니다——아직 이메일은 발송하지 않습니다.",
      "emailLabel": "이메일 주소",
      "saveEmailBtn": "이메일 저장",
      "emailSaved": "이메일이 저장되었습니다.",
      "emailCleared": "이메일이 삭제되었습니다.",
      ...
      "dangerHeading": "계정 비활성화",
      "dangerWarning": "계정을 비활성화하고 모든 기기에서 로그아웃합니다. 캐릭터는 유지되지만 다시 로그인할 수 없습니다——재활성화하려면 고객지원에 문의하세요.",
      "deletePasswordLabel": "비밀번호",
      "deleteConfirmLabel": "확인을 위해 사용자 이름을 입력하세요",
      "deleteBtn": "계정 비활성화",
      "deleted": "계정이 비활성화되었습니다.",
      "errIncorrectPassword": "비밀번호가 올바르지 않습니다.",
      "errSamePassword": "새 비밀번호는 현재 비밀번호와 달라야 합니다.",
      "errInvalidEmail": "유효한 이메일 주소를 입력하세요.",
      "errDeleteConfirm": "비활성화를 확인하려면 사용자 이름을 정확히 입력하세요.",
      "errDeleteOnline": "계정을 비활성화하기 전에 모든 캐릭터에서 로그아웃하세요.",
      "errDeactivated": "이 계정은 비활성화되었습니다. 재활성화하려면 고객지원에 문의하세요.",
