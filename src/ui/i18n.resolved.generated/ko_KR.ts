...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bank": {
      ...
      "personalTab": "개인",
      "accountTab": "계정",
      "accountEmpty": "계정 은행이 비어 있습니다.",
      "accountBuyConfirm": "{price}에 계정 은행 칸 {count}개를 추가로 구매하시겠습니까?",
      "accountDepositHint": "클릭하여 계정 은행에 넣기",
      "accountCannotDeposit": "계정 은행에 넣을 수 없음",
      "guildTab": "길드",
