  ...
  "entities": {
    ...
    "npcs": {
      ...
      "paymaster_edda_thorne": {
        "name": "경리관 에다 손",
        "title": "금고실의 수호자",
        "greeting": "수비대의 급료 궤짝은 용들을 견뎌 냈고, 당신의 돈도 그럴 것이오. 맡기든, 찾든, 선반을 하나 더 사든; 금고실은 열려 있소."
      },
      "auctioneer_bram_kestrel": {
        "name": "경매인 브람 케스트렐",
        "title": "세계 시장의 목소리",
        "greeting": "세계 시장은 이 먼 곳까지 닿는다오, {className}. 온 왕국이 파는 물건에 입찰하거나, 사구에서 얻은 전리품을 직접 내놓으시오."
      },
      "armorer_tam_rusk": {
        "name": "무기공 탐 러스크",
        "title": "요새 무기공",
        "greeting": "용은 방패를 쪼개고 트롤은 칼날을 무디게 하지. 사구가 무엇을 앗아갔든, 대장간에 대신할 것이 있소."
      },
      "reeve_ottoline": {
        "name": "촌장 오톨린",
        "title": "랜턴미어의 촌장",
