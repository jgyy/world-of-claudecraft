...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "waystone": {
      "title": "웨이스톤",
      "gossipOption": "웨이스톤 이용하기",
      "gossipOptionAria": "{name}의 웨이스톤 이용하기",
      "rowAria": "{town}(으)로 순간이동, {distance}야드, {price}",
      "distance": "{distance}야드",
      "fee": "요금: {fee}",
      "ticketPrice": "티켓 1장",
      "tickets": "웨이스톤 티켓: {count}",
      "guildDiscount": "길드 할인: {pct}%",
      "empty": "아직 다른 웨이스톤에 조율되어 있지 않습니다. 다른 마을의 돌을 만져 조율하세요.",
      "close": "웨이스톤 닫기"
    },
    "itemProc": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "세계",
      "intro": "World of ClaudeCraft는 당신이 두 발로 가로지르는 하나로 이어진 땅입니다. 옛 길은 남쪽에서 북쪽으로 시작의 골짜기와 늪지와 봉우리를 꿰뚫고, 그것들을 지나 그 너머의 분지와 지도 꼭대기의 눈의 땅까지 계속 올라갑니다. 그 길에서 서쪽으로 더 높은 왕국들이 한 줄, 동쪽으로 또 한 줄 열리고, 밸리의 동쪽 해안 앞바다에는 섬이 하나 놓여 있습니다. 다다르는 일 자체가 모험의 일부입니다. 모든 여정은 걷거나 타고 가며, 각 중심 마을의 웨이스톤은 당신이 이미 만진 적 있는 다른 어떤 돌로든 순식간에 당신을 데려다줍니다.\n\n이 땅은 시간도 셉니다. 낮과 밤의 순환은 당신의 세계에 있는 모두가 함께 쓰는 실제 시계로 돌아가므로, 하늘은 여러분 모두에게 동시에 새벽에서 한낮을 지나 황혼과 어둠으로 옮겨가고, 달은 차고 기울며 오가고, 땅 위의 빛도 그에 따라 바뀝니다. 미니맵을 두른 눈금판이 시각을 읽는 곳입니다.",
      "hub": "본거지",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "waystone_keeper_eastbrook": {
        "name": "렌 홀리스",
        "title": "웨이스톤지기",
        "greeting": "돌이 당신을 위해 웅웅거립니다, {className}님. 한 번 만지면 돌은 당신의 이름을 영영 잊지 않습니다."
      },
      "waystone_keeper_fenbridge": {
        "name": "오도 마시윅",
        "title": "웨이스톤지기",
        "greeting": "돌에 낀 이끼를 조심하세요. 마을 이름만 대면 거기 서 있게 됩니다."
      },
      "waystone_keeper_highwatch": {
        "name": "브람 시슬크래그",
        "title": "웨이스톤지기",
        "greeting": "공기는 희박하고 길은 빠르지요. 이 돌은 당신이 밟았던 봉우리를 하나도 잊지 않습니다."
      },
      "waystone_keeper_eldergleam": {
        "name": "실베인 더스크워든",
        "title": "웨이스톤지기",
        "greeting": "골짜기는 이 돌을 나뭇가지 아래에 지켜 둡니다. 가고 싶은 곳을 고르세요."
      },
      "waystone_keeper_wyrmwatch": {
        "name": "카르스크 엠버하이드",
        "title": "웨이스톤지기",
        "greeting": "와이름조차 이 돌은 건드리지 않습니다. 요새가 당신을 어디로 보내던가요?"
      },
      "waystone_keeper_icemantle": {
        "name": "힐데 프로스트맨틀",
        "title": "웨이스톤지기",
        "greeting": "이 돌은 만지면 따뜻합니다, 빙하 위에서 유일하게 따뜻한 것이지요. 어디로 가시겠습니까?"
      },
      "waystone_keeper_lanternmere": {
        "name": "페닉 앰버게일",
        "title": "웨이스톤지기",
        "greeting": "오늘 밤은 돌 주위에 등불이 밝혀져 있습니다. 목적지를 고르세요."
      },
      "waystone_keeper_bridgemere": {
        "name": "탐신 리드라이트",
        "title": "웨이스톤지기",
        "greeting": "다리의 돌에서 당신이 아는 어느 돌로든. 어디로 가시겠습니까, {className}님?"
      },
      "waystone_keeper_moonrest": {
        "name": "엘로웬 나이트송",
        "title": "웨이스톤지기",
        "greeting": "나방이 황혼녘에 돌 주위를 맴돕니다. 어디인지 말하면 그곳에 있게 됩니다."
      },
      "waystone_keeper_gallowmere": {
        "name": "코빈 그레이브젠드",
        "title": "웨이스톤지기",
        "greeting": "이 돌에는 아직 아무것도 씌지 않았습니다. 마을 이름을 대세요."
      },
      "waystone_keeper_drifthaven": {
        "name": "니아 솔트윈드",
        "title": "웨이스톤지기",
        "greeting": "소금기도 이 돌을 조금도 무디게 하지 못했습니다. 어디로 가시나요?"
      },
      "waystone_keeper_hedgewick": {
        "name": "핍 그린바우어",
        "title": "웨이스톤지기",
        "greeting": "이 돌은 울타리와 과수원 사이에 놓여 있습니다. 어디로 할까요?"
      },
      "waystone_keeper_wickharbor": {
        "name": "말로 게일슨",
        "title": "웨이스톤지기",
        "greeting": "항구의 돌은 바람이 어떻든 흔들리지 않습니다. 착륙지를 고르세요."
      },
      "waystone_keeper_gullhaven": {
        "name": "사빈 걸윙",
        "title": "웨이스톤지기",
        "greeting": "갈매기들이 이 돌에 앉습니다. 돌은 개의치 않지요. 어디로 가시겠습니까?"
      },
      "tidewatcher_ondrel": {
        "name": "온드렐 베인",
        "title": "조수지기",
