...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "unstuck": {
      ...
      "helpUnstuckNoSickness": "탈출: /unstuck은 제자리에서 카운트다운을 시작하고, 완료되면 가장 가까운 묘지로 이동시키며 쓰러져 있었다면 부활시킵니다. 대가는 없으며, 다시 사용하기까지 짧은 재사용 대기시간만 있습니다.",
      ...
      "movedToGraveyardNoSickness": "가장 가까운 묘지로 이동했습니다.",
      "revivedAtGraveyardNoSickness": "가장 가까운 묘지로 이동해 부활했습니다.",
  ...
  "guide": {
    ...
    "combat": {
      ...
      "unstuckBodyNoSickness": "세계가 빠져나올 수 없는 곳에 당신을 가둬 버렸다면 /unstuck을 입력하세요. 전투 중이 아니어야 하고, 제자리에 서 있어야 하며, 기절이나 속박에 걸려 있지 않고, 결투나 투기장 시합 중이 아니어야 합니다. 짧은 카운트다운이 흐르고, 움직이거나 피해를 받으면 취소됩니다. 카운트다운이 끝나면 가장 가까운 묘지에 내려놓습니다. 이 명령은 결코 당신을 죽이지 않고 시신도 남기지 않으며, 이미 쓰러져 있었다면 그 자리에서 일으켜 줍니다. 대가는 없으며, 다시 사용하기까지 짧은 재사용 대기시간만 있습니다. 갇힌 것은 결코 당신의 잘못이 아니므로, 견뎌야 할 약화 효과도 없습니다.",
    ...
    "commandsPage": {
      ...
      "unstuckNoSickness": "세계에 갇혔을 때 빠져나오는 길입니다. 짧은 카운트다운 동안 가만히 서 있으면 가장 가까운 묘지로 옮겨지고, 이미 쓰러져 있었다면 그곳에서 부활합니다. 대가는 없으며, 다시 사용하기까지 짧은 재사용 대기시간만 있습니다.",
    ...
    "glossary": {
      ...
      "unstuckCommandTerm": "갇힘 탈출",
      "unstuckCommandDef": "세계에 갇혔을 때 게임 메뉴에서 빠져나오는 길입니다. 카운트다운 동안 가만히 서 있으면 가장 가까운 묘지에 내려놓아 주며, 쓰러져 있었다면 그곳에서 일으켜 줍니다. 대가는 없으며, 다시 사용하기까지 짧은 재사용 대기시간만 있습니다.",
