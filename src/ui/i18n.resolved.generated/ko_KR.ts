...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "economy": {
      ...
      "marketGiveawayBody": "그 작은 수수료는 단순한 비용이 아닙니다. 차곡차곡 쌓여 공동 기금이 되고, 이 기금은 주기적으로 고급 장비를 나누어 주는 경품 추첨의 재원이 됩니다. 당첨자는 지난 추첨 이후 마켓에서 실제로 거래한 사람들 중에서 뽑힙니다. 따로 참가 신청이나 수령 신청을 할 필요는 없으며, 마켓에서 사고파는 것 자체가 참가 자격입니다. 당첨 결과는 전 세계에 발표되며, 상품은 다른 마켓 정산금과 마찬가지로 상인에게서 당신을 기다립니다."
    },
    "social": {
