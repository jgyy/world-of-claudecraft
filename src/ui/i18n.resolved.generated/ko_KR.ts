...
export const ko_KR: EnTranslations = {
  ...
  "guide": {
    ...
    "riftsPage": {
      ...
      "forgeHeading": "균열의 화로",
      "forgeBody": "등급 균열의 첫 완파가 만들어 내는 반지는 받은 순간에 완성된 것이 아닙니다. 갈매기항 감시 초원, 파열 학자 곁에서 화로를 지키는 균열장인 마엘리스가 반지를 한 단계씩 강화하고, 마법부여를 하나 얹고, 균열이 떨어뜨리는 색색의 보석을 홈에 박아 줍니다. 그 대가는 모두 균열의 정수와 균열 보석입니다. 균열 우두머리에게서 떨어지고 자유롭게 거래되는 화로 통화이니, 모자란 정수는 친구가 건네줄 수 있습니다. 가져가기 전에 반지를 벗으세요. 그녀는 가방 안에 있는 것만 다루며, 당신이 화로 곁에 서 있지 않으면 아무것도 하지 않습니다.",
