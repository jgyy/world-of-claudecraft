...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "voiceChatConsentNote": "이 기능을 켠 근처의 다른 플레이어와 자동으로 연결됩니다. 직접 연결(중계 서버 없음)이므로 연결된 플레이어가 회원님의 공인 IP 주소를 볼 수 있습니다. 언제든지 끌 수 있습니다.",
      "voiceChatMicDenied": "마이크 접근이 거부되었습니다. 음성 채팅에는 마이크가 필요합니다.",
      "voiceChatMuted": "마이크 음소거",
      "voiceChatVolume": "음성 채팅 음량",
      "footstepSounds": "발소리",
      "clickFeedback": "클릭 표시",
