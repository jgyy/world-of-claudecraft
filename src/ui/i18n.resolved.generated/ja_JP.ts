...
export const ja_JP: EnTranslations = {
  ...
  "guide": {
    ...
    "economy": {
      ...
      "marketGiveawayBody": "その少しの手数料はただの手数料ではありません。積み重なって共通の基金となり、定期的に上質な装備の抽選会の元手になります。当選者は前回の抽選以降にマーケットで実際に取引した人々の中から選ばれます。参加登録や受け取り申請は不要で、マーケットで売買していること自体が参加資格です。当選は世界に告知され、賞品は他のマーケットの代金と同じく商人のもとで待っています。"
    },
    "social": {
