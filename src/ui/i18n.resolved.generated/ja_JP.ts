...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "waystone": {
      "title": "ウェイストーン",
      "gossipOption": "ウェイストーンを利用する",
      "gossipOptionAria": "{name}のウェイストーンを利用する",
      "rowAria": "{town}へテレポート、{distance}ヤード、{price}",
      "distance": "{distance}ヤード",
      "fee": "料金：{fee}",
      "ticketPrice": "チケット1枚",
      "tickets": "ウェイストーンチケット：{count}",
      "guildDiscount": "ギルド割引：{pct}%",
      "empty": "まだ他のウェイストーンに調律されていません。別の町の石に触れて調律しましょう。",
      "close": "ウェイストーンを閉じる"
    },
    "itemProc": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "World of ClaudeCraftは、徒歩で渡っていく、ひと続きの大地です。古い街道は南から北へ、始まりの谷、湿地、山嶺を貫き、その先の窪地と地図の北端の雪国へと登り続けます。その街道からは西へ高位の領邦がひと連なり、東にもうひと連なり開けており、ヴェイルの東岸沖には島が浮かんでいます。たどり着くことそのものが冒険の一部です。どの道のりも歩くか騎乗するかで進み、拠点の町にあるウェイストーンは、あなたがすでに触れたことのある他のどの石へも一瞬で運んでくれます。\n\n大地は時も刻みます。昼夜の周期は、あなたのワールドにいる全員が共有する実際の時計で進むので、空は皆にとって同時に夜明けから正午、そして黄昏と闇へと移り変わり、月は満ち欠けを巡り、地上の光もそれにつれて変わります。ミニマップを囲む文字盤が、時刻を読み取る場所です。",
      "hub": "拠点",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "waystone_keeper_eastbrook": {
        "name": "レン・ホリス",
        "title": "ウェイストーンの番人",
        "greeting": "石があなたのために唸っています、{className}殿。一度触れれば、二度とあなたの名を忘れません。"
      },
      "waystone_keeper_fenbridge": {
        "name": "オド・マーシュウィック",
        "title": "ウェイストーンの番人",
        "greeting": "石の苔に気をつけて。町の名を言えば、そこに立っていますよ。"
      },
      "waystone_keeper_highwatch": {
        "name": "ブラム・シスルクラッグ",
        "title": "ウェイストーンの番人",
        "greeting": "薄い空気、速い道。石はあなたが触れたすべての峰を覚えています。"
      },
      "waystone_keeper_eldergleam": {
        "name": "シルヴェイン・ダスクウォーデン",
        "title": "ウェイストーンの番人",
        "greeting": "ホロウは枝の下に石を守っています。行きたい場所をお選びください。"
      },
      "waystone_keeper_wyrmwatch": {
        "name": "カースク・エンバーハイド",
        "title": "ウェイストーンの番人",
        "greeting": "ワームでさえこの石には手を出しません。砦はあなたをどこへ送りましょう？"
      },
      "waystone_keeper_icemantle": {
        "name": "ヒルデ・フロストマントル",
        "title": "ウェイストーンの番人",
        "greeting": "この石は触れると温かい、氷河の上で唯一温かいものです。どちらへ？"
      },
      "waystone_keeper_lanternmere": {
        "name": "フェニック・アンバーゲイル",
        "title": "ウェイストーンの番人",
        "greeting": "今夜は石の周りにランタンが灯っています。行き先をお選びください。"
      },
      "waystone_keeper_bridgemere": {
        "name": "タムシン・リードライト",
        "title": "ウェイストーンの番人",
        "greeting": "橋の石から、あなたが知るどの石へでも。どちらへ、{className}殿？"
      },
      "waystone_keeper_moonrest": {
        "name": "エロウェン・ナイトソング",
        "title": "ウェイストーンの番人",
        "greeting": "蛾が夕暮れに石の周りを舞います。行き先を言えば、そこにいますよ。"
      },
      "waystone_keeper_gallowmere": {
        "name": "コーヴィン・グレイヴズエンド",
        "title": "ウェイストーンの番人",
        "greeting": "この石にはまだ何も取り憑いていません。町の名をどうぞ。"
      },
      "waystone_keeper_drifthaven": {
        "name": "ニア・ソルトウィンド",
        "title": "ウェイストーンの番人",
        "greeting": "塩気はこの石を少しも曇らせていません。どちらへ向かいますか？"
      },
      "waystone_keeper_hedgewick": {
        "name": "ピップ・グリーンバウアー",
        "title": "ウェイストーンの番人",
        "greeting": "石は生け垣と果樹園の間に置かれています。どちらにしましょう？"
      },
      "waystone_keeper_wickharbor": {
        "name": "マーロ・ゲイルソン",
        "title": "ウェイストーンの番人",
        "greeting": "港の石は風がどうあろうと揺るぎません。行き先をお選びください。"
      },
      "waystone_keeper_gullhaven": {
        "name": "サビーヌ・ガルウィング",
        "title": "ウェイストーンの番人",
        "greeting": "カモメがこの石にとまります。石は気にしません。どちらへ？"
      },
      "tidewatcher_ondrel": {
        "name": "オンドレル・ヴェイン",
        "title": "潮見の番人",
