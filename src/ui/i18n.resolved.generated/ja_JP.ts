...
export const ja_JP: EnTranslations = {
  ...
  "guide": {
    ...
    "riftsPage": {
      ...
      "forgeHeading": "リフトの炉",
      "forgeBody": "ランク付きリフトの初回踏破で鋳造されるリングは、受け取った時点では完成していません。カモメ港のウォッチメドウ、破れの学者の隣で炉を守るリフトライトのマエリスが、一段ずつ強化し、エンチャントをひとつ施し、リフトが落とす色とりどりの宝石をソケットにはめ込んでくれます。その代価はすべてリフトのエッセンスとリフトの宝石。リフトのボスから落ち、自由に取引できる炉の通貨なので、足りないぶんは仲間から分けてもらえます。持ち込む前にリングは外しておきましょう。彼女が扱うのはカバンの中のものだけで、しかも彼女の炉のそばに立っていなければ何もしてくれません。",
