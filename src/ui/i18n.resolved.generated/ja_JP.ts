...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "voiceChatConsentNote": "この機能をオンにしている近くのプレイヤーと自動的に接続されます。直接接続（中継サーバーなし）のため、ペアになったプレイヤーにはあなたのグローバル IP アドレスが見える可能性があります。いつでもオフにできます。",
      "voiceChatMicDenied": "マイクへのアクセスが拒否されました。ボイスチャットにはマイクが必要です。",
      "voiceChatMuted": "マイクをミュート",
      "voiceChatVolume": "ボイスチャット音量",
      "footstepSounds": "足音",
