...
export const ja_JP: EnTranslations = {
  ...
  "guide": {
    ...
    "economy": {
      ...
      "marketGiveawayBody": "その小さな手数料はただの手数料ではありません。共有プールに積み立てられ、定期的に商人の棚に新しい装備を補充します。すべて取引手数料で賄われます。参加や受け取りは不要で、新しい在庫はただ商人の常備品の中に現れ、他のハウス出品と同様に誰でも購入できます。"
    },
    "social": {
  ...
  "itemUi": {
    ...
    "market": {
      ...
      "jackpotNote": "商人は次の在庫補充に向けて{pool}の手数料を貯めています。",
