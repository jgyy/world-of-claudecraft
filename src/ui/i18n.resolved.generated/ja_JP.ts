...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "bank": {
      ...
      "personalTab": "個人",
      "accountTab": "アカウント",
      "accountEmpty": "アカウント銀行は空です。",
      "accountBuyConfirm": "{price}でアカウント銀行スロットを追加で{count}個購入しますか？",
      "accountDepositHint": "クリックでアカウント銀行に預ける",
      "accountCannotDeposit": "アカウント銀行には入れられません",
      "guildTab": "ギルド",
