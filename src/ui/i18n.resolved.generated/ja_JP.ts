...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "soulKey": {
      "unboundLine": "ソウルキーで束縛が解かれた",
      "menuAction": "ソウルキーで束縛を解く",
      "confirmTitle": "魂の束縛を解く",
      "confirmBody": "{name}にソウルキーを使いますか？束縛は永久に解かれます。各キャラクターは週次リセットごとに{cap}回まで束縛を解けます。",
      "confirmOk": "束縛を解く",
      "confirmCancel": "キャンセル",
      "keyUse": "バッグの中の魂に縛られた装備を右クリックすると、その束縛を永久に解きます。各キャラクターは週次リセットごとに{cap}回まで。",
      "released": "{name}の束縛が解かれました。今週はあとソウルキーによる解除が{left}回できます。",
      "notEligible": "ソウルキーではそのアイテムの束縛を解けません。",
      "notBound": "そのアイテムは魂に縛られていません。",
      "noneHeld": "ソウルキーを持っていません。",
      "weeklyCap": "このキャラクターは今週のソウルキーによる解除をすべて使い切りました。"
    },
    "commissionBoard": {
      "title": "依頼ボード",
      "close": "依頼ボードを閉じる",
  ...
  "guide": {
    ...
    "gear": {
      ...
      "soulKeyBody": "魂に縛られた装備が永遠に縛られたままとは限りません。ハイウォッチの需品係ブリーはソウルキーをゴールドで売っており、バッグの中の縛られた装備にひとつ使えば、その束縛は永久に解かれます。それ以降は誰の手にあっても、他のアイテムと同じように取引、郵送、売却、出品ができます。各キャラクターが解ける束縛は週次リセットごとに二つまでなので、鍵は間違った特化に落ちたドロップや、ギルド仲間が必要とする予備のためのものであり、自分の全キャラクターに装備を回すための手段ではありません。",
      "heroicUpgradeBody": "英雄需品係のヴェックスは、ヒロイックの証二十個でクルーシブルのティア装備をヒロイック形態に鍛え直してくれます。ヒロイック装備はセットボーナスとクラス制限をそのまま保ち、アイテムレベルと主能力値が上がり、そして縛られなくなるため、他の戦利品と同じように持ち主を変えられます。",
  ...
  "heroicShop": {
    ...
    "upgradeTitle": "ヒロイック強化",
    "upgradeIntro": "ヒロイックの証{marks}個でクルーシブルのティア装備をヒロイック形態に鍛え直します。力が一段上がり、縛られなくなります。",
    "upgradeEmpty": "強化できるクルーシブルのティア装備を持っていません。",
    "upgradeAria": "ヒロイックの証{marks}個で{item}をヒロイックに強化",
    "upgradeConfirmTitle": "ヒロイック強化の確認",
    "upgradeConfirmBody": "ヒロイックの証{marks}個で{item}をヒロイック形態に強化しますか？強化に使った証は返金できません。",
    "upgradeConfirmAccept": "強化",
    "upgraded": "{item}がヒロイック形態に鍛え直されました。",
    "upgradeNotEligible": "そのアイテムは強化できません。",
    "upgradeOutOfRange": "強化するには英雄需品係のもとにいる必要があります。",
    "upgradeNotEnoughMarks": "強化にはヒロイックの証が{marks}個必要です。"
  },
  "crucibleShop": {
    "browse": "印章を交換する",
