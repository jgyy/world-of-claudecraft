...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "unstuck": {
      ...
      "helpUnstuckNoSickness": "復帰：/unstuck はその場でカウントダウンを開始し、完了すると最寄りの墓地へ移動します。倒れていた場合は蘇生します。代償はなく、再使用までの短いクールダウンだけです。",
      ...
      "movedToGraveyardNoSickness": "最寄りの墓地へ移動しました。",
      "revivedAtGraveyardNoSickness": "最寄りの墓地へ移動し、蘇生しました。",
  ...
  "guide": {
    ...
    "combat": {
      ...
      "unstuckBodyNoSickness": "世界に閉じ込められて抜け出せなくなったら、/unstuck と入力しましょう。戦闘外で静止していること、スタンや根縛りで拘束されていないこと、決闘中でもアリーナ試合中でもないことが条件です。短いカウントダウンが走り、移動するかダメージを受けると中断されます。終われば最寄りの墓地に下ろされます。これで死ぬことはなく、亡骸も残りません。すでに倒れていた場合は、そこで蘇生されます。代償はなく、再使用までの短いクールダウンだけです。閉じ込められたのはあなたのせいではないので、耐えるべき弱体効果はありません。",
    ...
    "commandsPage": {
      ...
      "unstuckNoSickness": "世界に閉じ込められたときの出口です。短いカウントダウンのあいだ静止していれば最寄りの墓地へ移され、すでに倒れていた場合はそこで蘇生されます。代償はなく、再使用までの短いクールダウンだけです。",
    ...
    "glossary": {
      ...
      "unstuckCommandTerm": "スタック解除",
      "unstuckCommandDef": "世界に閉じ込められたときの、ゲームメニューにある出口です。カウントダウンのあいだ動かずにいると最寄りの墓地へ降ろされ、倒れていた場合はそこで蘇生されます。代償はなく、再使用までの短いクールダウンだけです。",
