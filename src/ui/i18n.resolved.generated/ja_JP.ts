  ...
  "entities": {
    ...
    "npcs": {
      ...
      "paymaster_edda_thorne": {
        "name": "主計官エッダ・ソーン",
        "title": "金庫室の番人",
        "greeting": "守備隊の給金箱は竜を生き延びた。お前の金も同じだ。預けるも引き出すも、棚をもう一段買うも自由。金庫室は開いている。"
      },
      "auctioneer_bram_kestrel": {
        "name": "競売人ブラム・ケストレル",
        "title": "世界市場の声",
        "greeting": "世界市場はこんな遠くまで届いているぞ、{className}。王国中の品に入札するか、砂丘で得た戦利品を出品するがいい。"
      },
      "armorer_tam_rusk": {
        "name": "武具師タム・ラスク",
        "title": "砦の武具師",
        "greeting": "竜は盾を割り、トロルは刃を鈍らせる。砂丘に何を奪われようと、鍛冶場に代わりがある。"
      },
      "reeve_ottoline": {
        "name": "代官オトリーヌ",
        "title": "ランタンミアの代官",
