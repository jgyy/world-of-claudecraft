...
export const en: EnTranslations = {
  ...
  "guide": {
    ...
    "social": {
      ...
      "partyBody": "Invite another player by right-clicking their name (or long-pressing it on a touch screen) and choosing to invite, or with a chat command. A party holds up to five players, and one of you is the leader.",
