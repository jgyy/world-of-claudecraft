...
export const tr_TR: EnTranslations = {
  ...
  "guide": {
    ...
    "professions": {
      ...
      "craftComboBody": "Beyond a single crafts own recipe list, the wheel also supports combination recipes that call on two neighboring crafts at once, rewarding a character (or a pair of trading partners) who has invested in adjacent trades on the ring rather than one in isolation.",
