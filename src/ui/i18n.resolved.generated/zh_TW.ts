...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "waystone": {
      "title": "路石",
      "gossipOption": "使用路石",
      "gossipOptionAria": "與{name}一起使用路石",
      "rowAria": "傳送至{town}，{distance}碼，{price}",
      "distance": "{distance}碼",
      "fee": "費用：{fee}",
      "ticketPrice": "1張憑證",
      "tickets": "路石憑證：{count}",
      "guildDiscount": "公會折扣：{pct}%",
      "empty": "你還未與其他路石調諧。觸碰另一座城鎮的路石即可調諧。",
      "close": "關閉路石"
    },
    "itemProc": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "World of ClaudeCraft 是一片你要靠雙腳走遍的連續大陸。古道自南向北穿過起始山谷、沼澤和山峰，並越過它們繼續攀升，通向其後的窪地以及地圖頂端的雪境。自那條路向西展開一列更高等級的國度，向東另有一列，谷地東岸外還有一座島嶼。抵達本身就是冒險的一部分：每一段路程都靠步行或騎乘完成，每座中心城鎮的路石都能瞬間把你送到你已經觸碰過的任何其他路石那裡。\n\n這片大地也記錄著時間。晝夜循環依照一只你所在世界人人共享的真實時鐘運轉，因此天空會為你們所有人同時從黎明經正午走向黃昏與夜色，月亮循著盈虧來去，地面上的光影也隨之變化。小地圖周圍的錶盤，就是你讀取時辰的地方。",
      "hub": "主據點",
  ...
  "entities": {
    "abilities": {
      ...
      "grand_teleport_eastbrook": {
        "name": "宏大傳送：東溪",
        "description": "開啟一道通往東溪的宏大傳送門，持續5分鐘。只有施法瞬間處於你隊伍中的成員才能穿過。消耗一枚通行符文。施法時間10秒。與其他所有宏大傳送共享20分鐘冷卻時間。"
      },
      "grand_teleport_fenbridge": {
        "name": "宏大傳送：芬橋",
        "description": "開啟一道通往芬橋的宏大傳送門，持續5分鐘。只有施法瞬間處於你隊伍中的成員才能穿過。消耗一枚通行符文。施法時間10秒。與其他所有宏大傳送共享20分鐘冷卻時間。"
      },
      "grand_teleport_highwatch": {
        "name": "宏大傳送：高望",
        "description": "開啟一道通往高望的宏大傳送門，持續5分鐘。只有施法瞬間處於你隊伍中的成員才能穿過。消耗一枚通行符文。施法時間10秒。與其他所有宏大傳送共享20分鐘冷卻時間。"
      },
      "grand_teleport_eldergleam": {
        "name": "宏大傳送：古輝鎮",
        "description": "開啟一道通往古輝鎮的宏大傳送門，持續5分鐘。只有施法瞬間處於你隊伍中的成員才能穿過。消耗一枚通行符文。施法時間10秒。與其他所有宏大傳送共享20分鐘冷卻時間。"
      },
      "hellgate": {
        "name": "地獄之門",
    ...
    "npcs": {
      ...
      "waystone_keeper_eastbrook": {
        "name": "雯·霍利斯",
        "title": "路石守護者",
        "greeting": "石頭正為你嗡鳴，{className}。觸碰一次，它就永遠記得你的名字。"
      },
      "waystone_keeper_fenbridge": {
        "name": "奧多·沼威克",
        "title": "路石守護者",
        "greeting": "當心石頭上的苔蘚。說個鎮名，你就已經站在那兒了。"
      },
      "waystone_keeper_highwatch": {
        "name": "布拉姆·荊崖",
        "title": "路石守護者",
        "greeting": "空氣稀薄，道路卻快。石頭記得你踏過的每一座山峰。"
      },
      "waystone_keeper_eldergleam": {
        "name": "席爾凡·暮守",
        "title": "路石守護者",
        "greeting": "幽谷把石頭藏在枝葉之下。選個你更想去的地方吧。"
      },
      "waystone_keeper_wyrmwatch": {
        "name": "卡斯克·餘燼皮",
        "title": "路石守護者",
        "greeting": "連巨龍都不碰這塊石頭。要塞派你去哪兒？"
      },
      "waystone_keeper_icemantle": {
        "name": "希爾德·霜幔",
        "title": "路石守護者",
        "greeting": "這塊石頭摸起來是暖的，是冰川上唯一暖和的東西。去哪兒？"
      },
      "waystone_keeper_lanternmere": {
        "name": "芬尼克·琥珀風",
        "title": "路石守護者",
        "greeting": "今晚石頭周圍的燈籠已經點亮。選個目的地吧。"
      },
      "waystone_keeper_bridgemere": {
        "name": "塔姆辛·葦匠",
        "title": "路石守護者",
        "greeting": "從橋頭的石頭到你知道的任何一塊石頭。去哪兒，{className}？"
      },
      "waystone_keeper_moonrest": {
        "name": "埃洛溫·夜歌",
        "title": "路石守護者",
        "greeting": "飛蛾在黃昏時繞著石頭飛舞。說個地方，你就到了那兒。"
      },
      "waystone_keeper_gallowmere": {
        "name": "科爾文·墓盡",
        "title": "路石守護者",
        "greeting": "這塊石頭還沒有什麼在作祟。暫時沒有。說出你的鎮子。"
      },
      "waystone_keeper_drifthaven": {
        "name": "妮婭·鹽風",
        "title": "路石守護者",
        "greeting": "鹽分絲毫沒有磨鈍這塊石頭。你要去哪兒？"
      },
      "waystone_keeper_hedgewick": {
        "name": "皮普·綠蔭",
        "title": "路石守護者",
        "greeting": "石頭就立在樹籬與果園之間。去哪兒好呢？"
      },
      "waystone_keeper_wickharbor": {
        "name": "馬洛·風之子",
        "title": "路石守護者",
        "greeting": "不管風怎麼吹，港口的石頭都很穩。選個落腳點。"
      },
      "waystone_keeper_gullhaven": {
        "name": "薩賓·鷗翼",
        "title": "路石守護者",
        "greeting": "海鷗棲在這塊石頭上。石頭毫不在意。去哪兒？"
      },
      "tidewatcher_ondrel": {
        "name": "翁德瑞爾·韋恩",
        "title": "守潮者",
