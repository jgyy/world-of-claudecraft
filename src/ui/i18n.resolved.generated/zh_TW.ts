...
export const zh_TW: EnTranslations = {
  ...
  "guide": {
    ...
    "riftsPage": {
      ...
      "forgeHeading": "裂隙熔爐",
      "forgeBody": "首次通關排位裂隙鑄造的戒指，在你拿到手時還沒有完工。裂隙鍛匠梅莉絲在鷗港守望草甸、破裂學者身旁守著一座熔爐，她會一步步強化戒指、為它附上一道附魔，並把裂隙掉落的彩色寶石鑲進插槽。這一切都以裂隙精華和裂隙寶石支付，它們是裂隙首領掉落、可自由交易的熔爐貨幣，所以缺的精華可以請朋友遞給你。帶去之前先把戒指卸下：她只處理背包裡的東西，而且除非你站在她的熔爐旁，否則她什麼都不會做。",
