...
export const zh_TW: EnTranslations = {
  ...
  "guide": {
    ...
    "economy": {
      ...
      "marketGiveawayBody": "那一小筆費用不只是手續費：它會不斷累積成一筆共同基金，定期用來舉辦一場精良裝備的抽獎。中獎者是從自上一次抽獎以來，真正在市場上交易過的人當中抽出。你不需要報名或申領，只要在市場上買賣過，就已經算是參與其中。中獎結果會向全世界公布，獎品會像其他市場收益一樣在商人處等你領取。"
    },
    "social": {
