...
export const zh_TW: EnTranslations = {
  ...
  "guide": {
    ...
    "economy": {
      ...
      "marketGiveawayBody": "這筆小小的抽成不只是手續費：它匯入一個共享資金池，定期為商人的貨架補充新裝備，全部由交易手續費出資。無需報名或領取任何東西；新貨品會直接出現在商人的常備商品中，任何人都可以購買，就像其他常駐掛單一樣。"
    },
    "social": {
  ...
  "itemUi": {
    ...
    "market": {
      ...
      "jackpotNote": "商人持有 {pool} 的手續費，將用於下一次補貨。",
