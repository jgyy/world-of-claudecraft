...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "unstuck": {
      ...
      "helpUnstuckNoSickness": "脫困：/unstuck 會啟動原地倒數，結束後將你移動到最近的墓地，若你已倒下則會復活你。它沒有任何代價，只需等待一段短短的冷卻才能再次使用。",
      ...
      "movedToGraveyardNoSickness": "你已被移動到最近的墓地。",
      "revivedAtGraveyardNoSickness": "你已被移動到最近的墓地並復活。",
  ...
  "guide": {
    ...
    "combat": {
      ...
      "unstuckBodyNoSickness": "若這個世界把你困在某個出不去的地方，請輸入 /unstuck。你必須脫離戰鬥並原地站定，不能被昏迷或定身控制，也不能身處決鬥或競技場對戰中：接著會跑一段短短的倒數，移動或受到傷害都會中斷它。倒數結束後，你會被放置在最近的墓地。它從不會殺死你，也不會留下屍體，而若你當時已經倒下，它會就地將你扶起。它沒有任何代價，只需等待一段短短的冷卻才能再次使用：卡住從來不是你的錯，所以沒有任何減益需要熬過。",
      "climbTitle": "翻上一道岩架",
    ...
    "commandsPage": {
      ...
      "unstuckNoSickness": "當這個世界把你困住時的出路。原地站定撐過一段短短的倒數，你就會被移動到最近的墓地，若你已經倒下，還會在那裡被扶起。它沒有任何代價，只需等待一段短短的冷卻才能再次使用。",
    ...
    "glossary": {
      ...
      "unstuckCommandTerm": "脫困",
      "unstuckCommandDef": "當這個世界把你困住時，遊戲選單裡的那條出路。在倒數期間站著不動，它就會把你放到最近的墓地，若你已經倒下，還會在那裡將你扶起。它沒有任何代價，只需等待一段短短的冷卻才能再次使用。",
      "itemLevelTerm": "物品等級",
