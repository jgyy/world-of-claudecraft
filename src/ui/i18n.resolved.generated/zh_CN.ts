...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "gear": {
      ...
      "bindOnEquipBody": "大多数装备介于这两条规则之间：装备后绑定。任何你能穿戴的绿色、蓝色、紫色或橙色物品，只要从未被穿戴过，就可以自由交易、邮寄或在市场上架；在此期间，提示信息会显示“装备后绑定”。你第一次穿上它，它就永久灵魂绑定到该角色，再脱下来也不会解除：穿过的装备仍可卖给商人，但再也不能交易、邮寄或上架。只有在真正打算留下它时才试穿。",
