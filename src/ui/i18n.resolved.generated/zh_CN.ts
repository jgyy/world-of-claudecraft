...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "glossary": {
      ...
      "fiveSecondTerm": "五秒规则",
      "fiveSecondDef": "自你上一次消耗法力算起满五秒，法力才会开始自行回复。正因如此，施法者会控制自己的节奏，而不是一味地全力倾泻。",
      "talentRowTerm": "天赋行",
    ...
    "talentsPage": {
      ...
      "loadoutNote": "你不必只认准一套配点。在面板里保存一套具名的配置，它会连同天赋选择和你的动作条一起记住，因此切换到另一套只需点一下，遵循的规则与重置相同：脱离战斗，且不在竞技场比赛或战场之中。"
    },
    "arenaPage": {
      "heading": "竞技场与 PvP",
