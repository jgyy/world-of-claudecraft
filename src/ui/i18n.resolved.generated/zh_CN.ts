...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "voiceChatEnabled": "语音聊天（附近）",
      "voiceChatConsentNote": "你将自动与附近同样开启此功能的玩家连接。由于连接是直连（没有中转服务器），配对的玩家可以看到你的公网 IP 地址。你可以随时关闭此功能。",
      "voiceChatMicDenied": "麦克风权限被拒绝。语音聊天需要它才能工作。",
      "voiceChatMuted": "静音我的麦克风",
      "voiceChatVolume": "语音聊天音量",
      "footstepSounds": "脚步声",
      "clickFeedback": "点击标记",
