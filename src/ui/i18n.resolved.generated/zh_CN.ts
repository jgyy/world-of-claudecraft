...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "economy": {
      ...
      "marketGiveawayBody": "这笔小小的抽成不只是手续费：它汇入一个共享资金池，定期为商人的货架补充新装备，全部由交易手续费出资。无需报名或领取任何东西；新货品会直接出现在商人的常备商品中，任何人都可以购买，就像其他常驻挂单一样。"
    },
    "social": {
  ...
  "itemUi": {
    ...
    "market": {
      ...
      "jackpotNote": "商人持有 {pool} 的手续费，将用于下一次补货。",
