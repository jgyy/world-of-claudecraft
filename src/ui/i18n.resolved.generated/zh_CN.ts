...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "riftsPage": {
      ...
      "forgeHeading": "裂隙熔炉",
      "forgeBody": "首次通关排位裂隙铸造的戒指，在你拿到手时还没有完工。裂隙锻匠梅莉丝在远滩的守望草甸、沿岸上行离开鸥港后的破裂学者身旁守着一座熔炉，她会一步步强化戒指、为它附上一道附魔，并把裂隙掉落的彩色宝石镶进插槽。这一切都以裂隙精华和裂隙宝石支付，它们是裂隙首领掉落、可自由交易的熔炉货币，所以缺的精华可以请朋友递给你。带去之前先把戒指卸下：她只处理背包里的东西，而且除非你站在她的熔炉旁，否则她什么都不会做。",
