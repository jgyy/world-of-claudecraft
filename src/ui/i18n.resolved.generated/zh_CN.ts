...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "waystone": {
      "title": "路石",
      "gossipOption": "使用路石",
      "gossipOptionAria": "与{name}一起使用路石",
      "rowAria": "传送至{town}，{distance}码，{price}",
      "distance": "{distance}码",
      "fee": "费用：{fee}",
      "ticketPrice": "1张凭证",
      "tickets": "路石凭证：{count}",
      "guildDiscount": "公会折扣：{pct}%",
      "empty": "你还未与其他路石调谐。触碰另一座城镇的路石即可调谐。",
      "close": "关闭路石"
    },
    "itemProc": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "World of ClaudeCraft 是一片你要靠双脚走遍的连续大陆。古道自南向北穿过起始山谷、沼泽和山峰，并越过它们继续攀升，通向其后的洼地以及地图顶端的雪境。自那条路向西展开一列更高等级的国度，向东另有一列，谷地东岸外还有一座岛屿。抵达本身就是冒险的一部分：每一段路程都靠步行或骑乘完成，每座中心城镇的路石都能瞬间把你送到你已经触碰过的任何其他路石那里。\n\n这片大地也记录着时间。昼夜循环依照一只你所在世界人人共享的真实时钟运转，因此天空会为你们所有人同时从黎明经正午走向黄昏与夜色，月亮循着盈亏来去，地面上的光影也随之变化。小地图周围的表盘，就是你读取时辰的地方。",
      "hub": "大本营",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "waystone_keeper_eastbrook": {
        "name": "雯·霍利斯",
        "title": "路石守护者",
        "greeting": "石头正为你嗡鸣，{className}。触碰一次，它就永远记得你的名字。"
      },
      "waystone_keeper_fenbridge": {
        "name": "奥多·沼威克",
        "title": "路石守护者",
        "greeting": "当心石头上的苔藓。说个镇名，你就已经站在那儿了。"
      },
      "waystone_keeper_highwatch": {
        "name": "布拉姆·荆崖",
        "title": "路石守护者",
        "greeting": "空气稀薄，道路却快。石头记得你踏过的每一座山峰。"
      },
      "waystone_keeper_eldergleam": {
        "name": "席尔凡·暮守",
        "title": "路石守护者",
        "greeting": "幽谷把石头藏在枝叶之下。选个你更想去的地方吧。"
      },
      "waystone_keeper_wyrmwatch": {
        "name": "卡斯克·余烬皮",
        "title": "路石守护者",
        "greeting": "连巨龙都不碰这块石头。要塞派你去哪儿？"
      },
      "waystone_keeper_icemantle": {
        "name": "希尔德·霜幔",
        "title": "路石守护者",
        "greeting": "这块石头摸起来是暖的，是冰川上唯一暖和的东西。去哪儿？"
      },
      "waystone_keeper_lanternmere": {
        "name": "芬尼克·琥珀风",
        "title": "路石守护者",
        "greeting": "今晚石头周围的灯笼已经点亮。选个目的地吧。"
      },
      "waystone_keeper_bridgemere": {
        "name": "塔姆辛·苇匠",
        "title": "路石守护者",
        "greeting": "从桥头的石头到你知道的任何一块石头。去哪儿，{className}？"
      },
      "waystone_keeper_moonrest": {
        "name": "埃洛温·夜歌",
        "title": "路石守护者",
        "greeting": "飞蛾在黄昏时绕着石头飞舞。说个地方，你就到了那儿。"
      },
      "waystone_keeper_gallowmere": {
        "name": "科尔文·墓尽",
        "title": "路石守护者",
        "greeting": "这块石头还没有什么在作祟。暂时没有。说出你的镇子。"
      },
      "waystone_keeper_drifthaven": {
        "name": "妮娅·盐风",
        "title": "路石守护者",
        "greeting": "盐分丝毫没有磨钝这块石头。你要去哪儿？"
      },
      "waystone_keeper_hedgewick": {
        "name": "皮普·绿荫",
        "title": "路石守护者",
        "greeting": "石头就立在树篱与果园之间。去哪儿好呢？"
      },
      "waystone_keeper_wickharbor": {
        "name": "马洛·风之子",
        "title": "路石守护者",
        "greeting": "不管风怎么吹，港口的石头都很稳。选个落脚点。"
      },
      "waystone_keeper_gullhaven": {
        "name": "萨宾·鸥翼",
        "title": "路石守护者",
        "greeting": "海鸥栖在这块石头上。石头毫不在意。去哪儿？"
      },
      "tidewatcher_ondrel": {
        "name": "翁德雷尔·凡恩",
        "title": "守潮者",
