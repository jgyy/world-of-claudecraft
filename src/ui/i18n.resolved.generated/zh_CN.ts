...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "economy": {
      ...
      "marketGiveawayBody": "那一小笔佣金不只是费用：它会不断累积，汇成一个共同的奖金池，定期用来举办一场精良装备的抽奖。中奖者从自上一次抽奖以来在市场上真正交易过的人当中抽出。你不需要报名或申领，只要在市场上买卖过，就已经算是参与其中。中奖结果会向全世界公布，奖品会像其他市场收益一样在商人处等你领取。"
    },
    "social": {
  ...
  "itemUi": {
    ...
    "market": {
      ...
      "jackpotNote": "商人持有 {pool} 的手续费，将用于下一次抽奖。",
