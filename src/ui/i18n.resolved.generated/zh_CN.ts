...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "account": {
      ...
      "charactersLabel": "角色",
      "emailHeading": "联系邮箱",
      "emailNote": "可选。用于日后找回账户——我们暂时不会发送邮件。",
      "emailLabel": "邮箱地址",
      "saveEmailBtn": "保存邮箱",
      "emailSaved": "邮箱已保存。",
      "emailCleared": "邮箱已清除。",
      ...
      "dangerHeading": "停用账户",
      "dangerWarning": "这将停用你的账户并在所有设备上登出。你的角色会被保留，但你将无法再次登录——如需重新启用请联系客服。",
      "deletePasswordLabel": "密码",
      "deleteConfirmLabel": "输入你的用户名以确认",
      "deleteBtn": "停用账户",
      "deleted": "账户已停用。",
      "errIncorrectPassword": "密码错误。",
      "errSamePassword": "新密码必须与当前密码不同。",
      "errInvalidEmail": "请输入有效的邮箱地址。",
      "errDeleteConfirm": "请准确输入你的用户名以确认停用。",
      "errDeleteOnline": "停用账户前请先登出所有角色。",
      "errDeactivated": "此账户已被停用。如需重新启用请联系客服。",
      "errAccountNotFound": "未找到账户。",
