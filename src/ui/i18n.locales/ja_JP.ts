...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.worldPage.intro': 'World of ClaudeCraftは、徒歩で渡っていく、ひと続きの大地です。古い街道は南から北へ、始まりの谷、湿地、山嶺を貫き、その先の窪地と地図の北端の雪国へと登り続けます。その街道からは西へ高位の領邦がひと連なり、東にもうひと連なり開けており、ヴェイルの東岸沖には島が浮かんでいます。たどり着くことそのものが冒険の一部です。どの道のりも歩くか騎乗するかで進み、拠点の町にあるウェイストーンは、あなたがすでに触れたことのある他のどの石へも一瞬で運んでくれます。\n\n大地は時も刻みます。昼夜の周期は、あなたのワールドにいる全員が共有する実際の時計で進むので、空は皆にとって同時に夜明けから正午、そして黄昏と闇へと移り変わり、月は満ち欠けを巡り、地上の光もそれにつれて変わります。ミニマップを囲む文字盤が、時刻を読み取る場所です。',
  ...
  'guide.worldPage.travelBody': 'レルムのどの道も、歩くか馬で行くもので、地図は一続きの陸地です。どのつながりも自分の足で立てる場所です。ウェイストーンはあなたが道を思い出す助けになります。拠点となる町にはそれぞれ一つのウェイストーンがあり、そばには番人がいます。一度その町の石に歩いて触れれば、あなたが知る他のどの石からでも、料金を払って一瞬でそこへ移動できます。料金は距離に応じて上がり、日替わりダンジョンキューから得られるウェイストーンチケットは金貨の代わりに一回の移動に使え、ギルドの格が価格の一部を割り引きます。グランドテレポートを習得した魔法使いは、パーティを古街道の四都市のいずれかへ運ぶポータルを開くことができ、地獄門の契約を歩んだウォーロックは、パーティメンバーを引き寄せる門を切り裂くことができます。尾根が一つのレルムを次のレルムから隔てており、二つのレルムが尾根を分け合うところでは、道が峠を越えて登っていきます。とはいえ、すべての境がそうなっているわけではありません。北では長い土手道が、ヴェールの幽谷から水の上を渡ってその先の雪国へ道を運びます。南へ戻れば、Ferrywalkと呼ばれる細い自然の砂州が渓谷の海岸から東へ延び、陸の境をまったく持たない遠つ岸の島の船着き場へつながっています。そして地上世界には、ただ一つだけ本物の扉があります。ソーンピークの高みに掛かる黄昏の帳で、その先はヴェールの幽谷です。幽谷の南の尾根は封じられ、越える峠がないので、あの帳こそが最初に中へ入る道であり、帰りにはあなたの背後で閉じます。\n\nどこで倒れても、戻り道は短いものです。どのゾーンにも墓地が少なくとも一つあり、墓石の上には霊魂の癒し手が漂っています。解き放たれた魂は、最も近い墓地で起き上がります。\n\n地図は見えない壁で終わったりはしません。陸は浜辺と岬になり、やがて外海へと溶けていきます。世界があなたに泳いで渡らせるつもりの水路、つまりレルムとレルムのあいだの海峡や湖沼は穏やかで、安全に渡れます。しかし外海へ乗り出せば、距離そのものがあなたを押し返します。警告が出て、もう一度警告が出て、それでも泳ぎ続ければ、海はあなたを削り、ついには命を奪います。潜ることにも独自の限りがあり、水面の下では息が続きません。水がそう告げてきたら、息継ぎに浮上して引き返しましょう。',
  ...
  'entities.npcs.waystone_keeper_eastbrook.name': 'レン・ホリス',
  'entities.npcs.waystone_keeper_eastbrook.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_eastbrook.greeting':
    '石があなたのために唸っています、{className}殿。一度触れれば、二度とあなたの名を忘れません。',
  'entities.npcs.waystone_keeper_fenbridge.name': 'オド・マーシュウィック',
  'entities.npcs.waystone_keeper_fenbridge.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_fenbridge.greeting': '石の苔に気をつけて。町の名を言えば、そこに立っていますよ。',
  'entities.npcs.waystone_keeper_highwatch.name': 'ブラム・シスルクラッグ',
  'entities.npcs.waystone_keeper_highwatch.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_highwatch.greeting':
    '薄い空気、速い道。石はあなたが触れたすべての峰を覚えています。',
  'entities.npcs.waystone_keeper_eldergleam.name': 'シルヴェイン・ダスクウォーデン',
  'entities.npcs.waystone_keeper_eldergleam.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_eldergleam.greeting':
    'ホロウは枝の下に石を守っています。行きたい場所をお選びください。',
  'entities.npcs.waystone_keeper_wyrmwatch.name': 'カースク・エンバーハイド',
  'entities.npcs.waystone_keeper_wyrmwatch.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_wyrmwatch.greeting':
    'ワームでさえこの石には手を出しません。砦はあなたをどこへ送りましょう？',
  'entities.npcs.waystone_keeper_icemantle.name': 'ヒルデ・フロストマントル',
  'entities.npcs.waystone_keeper_icemantle.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_icemantle.greeting':
    'この石は触れると温かい、氷河の上で唯一温かいものです。どちらへ？',
  'entities.npcs.waystone_keeper_lanternmere.name': 'フェニック・アンバーゲイル',
  'entities.npcs.waystone_keeper_lanternmere.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_lanternmere.greeting': '今夜は石の周りにランタンが灯っています。行き先をお選びください。',
  'entities.npcs.waystone_keeper_bridgemere.name': 'タムシン・リードライト',
  'entities.npcs.waystone_keeper_bridgemere.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_bridgemere.greeting':
    '橋の石から、あなたが知るどの石へでも。どちらへ、{className}殿？',
  'entities.npcs.waystone_keeper_moonrest.name': 'エロウェン・ナイトソング',
  'entities.npcs.waystone_keeper_moonrest.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_moonrest.greeting': '蛾が夕暮れに石の周りを舞います。行き先を言えば、そこにいますよ。',
  'entities.npcs.waystone_keeper_gallowmere.name': 'コーヴィン・グレイヴズエンド',
  'entities.npcs.waystone_keeper_gallowmere.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_gallowmere.greeting': 'この石にはまだ何も取り憑いていません。町の名をどうぞ。',
  'entities.npcs.waystone_keeper_drifthaven.name': 'ニア・ソルトウィンド',
  'entities.npcs.waystone_keeper_drifthaven.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_drifthaven.greeting': '塩気はこの石を少しも曇らせていません。どちらへ向かいますか？',
  'entities.npcs.waystone_keeper_hedgewick.name': 'ピップ・グリーンバウアー',
  'entities.npcs.waystone_keeper_hedgewick.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_hedgewick.greeting': '石は生け垣と果樹園の間に置かれています。どちらにしましょう？',
  'entities.npcs.waystone_keeper_wickharbor.name': 'マーロ・ゲイルソン',
  'entities.npcs.waystone_keeper_wickharbor.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_wickharbor.greeting': '港の石は風がどうあろうと揺るぎません。行き先をお選びください。',
  'entities.npcs.waystone_keeper_gullhaven.name': 'サビーヌ・ガルウィング',
  'entities.npcs.waystone_keeper_gullhaven.title': 'ウェイストーンの番人',
  'entities.npcs.waystone_keeper_gullhaven.greeting': 'カモメがこの石にとまります。石は気にしません。どちらへ？',
  ...
  'entities.items.tome_grand_teleport_eastbrook.name': '通行の書：イーストブルック',
  'entities.items.tome_grand_teleport_fenbridge.name': '通行の書：フェンブリッジ',
  'entities.items.tome_grand_teleport_highwatch.name': '通行の書：ハイウォッチ',
  'entities.items.tome_grand_teleport_eldergleam.name': '通行の書：エルダーグリーム',
  'entities.abilities.grand_teleport_eastbrook.name': 'グランドテレポート：イーストブルック',
  'entities.abilities.grand_teleport_eastbrook.description':
    'イーストブルックへのグランドポータルを5分間開きます。詠唱した瞬間にあなたのグループにいたメンバーだけが通れます。通行のルーンを1つ消費します。詠唱10秒。他のすべてのグランドテレポートと20分のクールダウンを共有します。',
  'entities.abilities.grand_teleport_fenbridge.name': 'グランドテレポート：フェンブリッジ',
  'entities.abilities.grand_teleport_fenbridge.description':
    'フェンブリッジへのグランドポータルを5分間開きます。詠唱した瞬間にあなたのグループにいたメンバーだけが通れます。通行のルーンを1つ消費します。詠唱10秒。他のすべてのグランドテレポートと20分のクールダウンを共有します。',
  'entities.abilities.grand_teleport_highwatch.name': 'グランドテレポート：ハイウォッチ',
  'entities.abilities.grand_teleport_highwatch.description':
    'ハイウォッチへのグランドポータルを5分間開きます。詠唱した瞬間にあなたのグループにいたメンバーだけが通れます。通行のルーンを1つ消費します。詠唱10秒。他のすべてのグランドテレポートと20分のクールダウンを共有します。',
  'entities.abilities.grand_teleport_eldergleam.name': 'グランドテレポート：エルダーグリーム',
  'entities.abilities.grand_teleport_eldergleam.description':
    'エルダーグリームへのグランドポータルを5分間開きます。詠唱した瞬間にあなたのグループにいたメンバーだけが通れます。通行のルーンを1つ消費します。詠唱10秒。他のすべてのグランドテレポートと20分のクールダウンを共有します。',
  ...
  'hudChrome.waystone.title': 'ウェイストーン',
  'hudChrome.waystone.gossipOption': 'ウェイストーンを利用する',
  'hudChrome.waystone.gossipOptionAria': '{name}のウェイストーンを利用する',
  'hudChrome.waystone.rowAria': '{town}へテレポート、{distance}ヤード、{price}',
  'hudChrome.waystone.distance': '{distance}ヤード',
  'hudChrome.waystone.fee': '料金：{fee}',
  'hudChrome.waystone.ticketPrice': 'チケット1枚',
  'hudChrome.waystone.tickets': 'ウェイストーンチケット：{count}',
  'hudChrome.waystone.guildDiscount': 'ギルド割引：{pct}%',
  'hudChrome.waystone.empty': 'まだ他のウェイストーンに調律されていません。別の町の石に触れて調律しましょう。',
  'hudChrome.waystone.close': 'ウェイストーンを閉じる',
};
