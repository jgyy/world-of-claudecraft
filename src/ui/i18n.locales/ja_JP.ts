...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.riftForge.upgradeBtn': '強化（エッセンス {cost}）',
  'hudChrome.riftForge.upgradeMax': '強化完了',
  'hudChrome.riftForge.enchantCurrent': 'エンチャント: +{value} {stat}',
  'hudChrome.riftForge.enchantNone': 'エンチャント: なし',
  'hudChrome.riftForge.enchantBtn': 'エンチャント（エッセンス {cost}）',
  'hudChrome.riftForge.statPickAria': 'エンチャントする能力値',
  'hudChrome.riftForge.gemPickAria': 'はめ込む宝石',
  'hudChrome.riftForge.socketBtn': 'はめ込む',
  'hudChrome.riftForge.socketsNone': '宝石なし',
  'hudChrome.riftForge.socketsFull': 'すべてのソケットが埋まっています',
  ...
  'hudChrome.riftForge.reason.invalidStat': 'その能力値はここではエンチャントできません。',
  'hudChrome.riftForge.reason.invalidGem': 'そのリフトの宝石を持っていません。',
  'hudChrome.riftForge.reason.socketsFull': 'そのリングのソケットはすべて埋まっています。',
  ...
  'hudChrome.riftForge.done.enchant': '{name}にエンチャントしました。',
  ...
  'guide.riftsPage.forgeBody':
    'ランク付きリフトの初回踏破で鋳造されるリングは、受け取った時点では完成していません。ファーショアのウォッチメドウ、カモメ港から岸を上った破れの学者の隣で炉を守るリフトライトのマエリスが、一段ずつ強化し、エンチャントをひとつ施し、リフトが落とす色とりどりの宝石をソケットにはめ込んでくれます。その代価はすべてリフトのエッセンスとリフトの宝石。リフトのボスから落ち、自由に取引できる炉の通貨なので、足りないぶんは仲間から分けてもらえます。持ち込む前にリングは外しておきましょう。彼女が扱うのはカバンの中のものだけで、しかも彼女の炉のそばに立っていなければ何もしてくれません。',
