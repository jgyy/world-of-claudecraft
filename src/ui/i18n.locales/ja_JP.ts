...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.arcane_bound_cloth.name': '秘術縛りの布',
  'entities.items.arcane_bound_hide.name': '秘術縛りの毛皮',
  'entities.items.arcane_bound_chain.name': '秘術縛りの鎖帷子',
  'entities.items.arcane_bound_edge.name': '秘術縛りの刃',
  'entities.items.arcane_bound_focus.name': '秘術縛りの秘具',
  'entities.items.arcanists_mantle.name': '秘術師のマント',
  'entities.items.wyrmstalkers_hide.name': '竜潜みの毛皮',
  'entities.items.ironbound_hauberk.name': '鉄縛りのホーバーク',
  'entities.items.edgebound_greatblade.name': '刃縛りの大剣',
  'entities.items.focusbound_channeler.name': '秘具縛りのチャネラー',
