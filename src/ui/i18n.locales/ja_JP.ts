...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.professions.enchantingProgress': '付与術中：残り{remaining}秒（全{total}秒）。',
  'hudChrome.professions.salvagingProgress': '資材回収中：残り{remaining}秒（全{total}秒）。',
  'hudChrome.professions.rechargingToolEffectProgress':
    '道具効果を再充填中：残り{remaining}秒（全{total}秒）。',
