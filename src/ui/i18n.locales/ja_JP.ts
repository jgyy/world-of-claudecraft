...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.crystal_shard.name': '輝く水晶の欠片',
  ...
  'entities.mobs.glimmervein_spider.name': 'グリマーヴェインの水晶グモ',
  'entities.mobs.glimmervein_bat.name': 'グリマーヴェインの洞窟コウモリ',
  ...
  'entities.mobs.glimmervein_broodling.name': 'グリマーヴェインの幼体グモ',
  ...
  'entities.zones.mirefen_marsh.pois.8.label': 'グリマーヴェイン洞窟',
  ...
  'entities.zones.eastbrook_vale.pois.10.label': 'グリマーヴェイン洞窟',
