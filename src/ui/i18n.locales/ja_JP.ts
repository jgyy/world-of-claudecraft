...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.flightmaster_eastbrook.name': 'レン・ホリス',
  'entities.npcs.flightmaster_eastbrook.title': '飛行管理人',
  'entities.npcs.flightmaster_eastbrook.greeting': 'グリフォンは休養十分、空も晴れています、{className}殿。どちらへ？',
  'entities.npcs.flightmaster_fenbridge.name': 'オド・マーシュウィック',
  'entities.npcs.flightmaster_fenbridge.title': '飛行管理人',
  'entities.npcs.flightmaster_fenbridge.greeting': '上がるときは葦に気をつけて。町の名を言えば、お連れしますよ。',
  'entities.npcs.flightmaster_highwatch.name': 'ブラム・シスルクラッグ',
  'entities.npcs.flightmaster_highwatch.title': '飛行管理人',
  'entities.npcs.flightmaster_highwatch.greeting': '薄い空気に、遠くまで見渡せる景色。この鳥たちは峰々の峠を残らず知っています。',
  'entities.npcs.flightmaster_eldergleam.name': 'シルヴェイン・ダスクウォーデン',
  'entities.npcs.flightmaster_eldergleam.title': '飛行管理人',
  'entities.npcs.flightmaster_eldergleam.greeting': 'ホロウは上から見るほうが優しい。着地先をお選びください。',
  'entities.npcs.flightmaster_wyrmwatch.name': 'カースク・エンバーハイド',
  'entities.npcs.flightmaster_wyrmwatch.title': '飛行管理人',
  'entities.npcs.flightmaster_wyrmwatch.greeting': 'ワームでさえ私の鳥を避けて通る。砦はあなたをどこへ送るのです？',
  'entities.npcs.flightmaster_icemantle.name': 'ヒルデ・フロストマントル',
  'entities.npcs.flightmaster_icemantle.title': '飛行管理人',
  'entities.npcs.flightmaster_icemantle.greeting': '厚着をなさい。氷河の上の風は刺すように冷たいが、飛行はすぐ終わります。',
  'entities.npcs.flightmaster_lanternmere.name': 'フェニック・アンバーゲイル',
  'entities.npcs.flightmaster_lanternmere.title': '飛行管理人',
  'entities.npcs.flightmaster_lanternmere.greeting': '夜間飛行のためにランタンを灯しました。行き先をお選びください。',
  'entities.npcs.flightmaster_bridgemere.name': 'タムシン・リードライト',
  'entities.npcs.flightmaster_bridgemere.title': '飛行管理人',
  'entities.npcs.flightmaster_bridgemere.greeting': '橋から、沼地が許すどこへでも。どちらへ、{className}殿？',
  'entities.npcs.flightmaster_moonrest.name': 'エロウェン・ナイトソング',
  'entities.npcs.flightmaster_moonrest.title': '飛行管理人',
  'entities.npcs.flightmaster_moonrest.greeting': '蛾が夜の鳥を家へ導きます。行き先を言えば飛びましょう。',
  'entities.npcs.flightmaster_gallowmere.name': 'コーヴィン・グレイヴズエンド',
  'entities.npcs.flightmaster_gallowmere.title': '飛行管理人',
  'entities.npcs.flightmaster_gallowmere.greeting': 'ここの空に化けて出るものはいない。今のところは。町の名をどうぞ。',
  'entities.npcs.flightmaster_drifthaven.name': 'ニア・ソルトウィンド',
  'entities.npcs.flightmaster_drifthaven.title': '飛行管理人',
  'entities.npcs.flightmaster_drifthaven.greeting': '浅瀬から吹く暖かい風が鳥をよく持ち上げる。どちらへ向かいます？',
  'entities.npcs.flightmaster_hedgewick.name': 'ピップ・グリーンバウアー',
  'entities.npcs.flightmaster_hedgewick.title': '飛行管理人',
  'entities.npcs.flightmaster_hedgewick.greeting': '生け垣を越え、果樹園を過ぎて。どちらにしましょう？',
  'entities.npcs.flightmaster_wickharbor.name': 'マーロ・ゲイルソン',
  'entities.npcs.flightmaster_wickharbor.title': '飛行管理人',
  'entities.npcs.flightmaster_wickharbor.greeting': '今日は港の風が安定しています。着地先をお選びください。',
  'entities.npcs.flightmaster_gullhaven.name': 'サビーヌ・ガルウィング',
  'entities.npcs.flightmaster_gullhaven.title': '飛行管理人',
  'entities.npcs.flightmaster_gullhaven.greeting': 'カモメは私の鳥を嫌う。鳥は気にもしない。どちらへ？',
  ...
  'hudChrome.flight.title': '飛行経路',
  'hudChrome.flight.gossipOption': '飛行を利用する',
  'hudChrome.flight.gossipOptionAria': '{name}の飛行を利用する',
  'hudChrome.flight.rowAria': '{town}へ飛ぶ、{hops}区間、{fare}',
  'hudChrome.flight.hops': '{count}区間',
  'hudChrome.flight.fare': '運賃：{fare}',
  'hudChrome.flight.empty': '他の飛行経路をまだ知りません。別の町の飛行管理人に話しかけて、その経路を覚えましょう。',
  'hudChrome.flight.close': '飛行経路を閉じる',
};
