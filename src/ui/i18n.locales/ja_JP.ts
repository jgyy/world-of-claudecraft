...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.soulKey.unboundLine': 'ソウルキーで束縛が解かれた',
  'hudChrome.soulKey.menuAction': 'ソウルキーで束縛を解く',
  'hudChrome.soulKey.confirmTitle': '魂の束縛を解く',
  ...
  'hudChrome.soulKey.noneHeld': 'ソウルキーを持っていません。',
  'hudChrome.soulKey.weeklyCap': 'このキャラクターは今週のソウルキーによる解除をすべて使い切りました。',
  'guide.gear.soulKeyBody': '魂に縛られた装備が永遠に縛られたままとは限りません。ハイウォッチの需品係ブリーはソウルキーをゴールドで売っており、バッグの中の縛られた装備にひとつ使えば、その束縛は永久に解かれます。それ以降は誰の手にあっても、他のアイテムと同じように取引、郵送、売却、出品ができます。各キャラクターが解ける束縛は週次リセットごとに二つまでなので、鍵は間違った特化に落ちたドロップや、ギルド仲間が必要とする予備のためのものであり、自分の全キャラクターに装備を回すための手段ではありません。',
  'guide.gear.heroicUpgradeBody': '英雄需品係のヴェックスは、ヒロイックの証二十個でクルーシブルのティア装備をヒロイック形態に鍛え直してくれます。ヒロイック装備はセットボーナスとクラス制限をそのまま保ち、アイテムレベルと主能力値が上がり、そして縛られなくなるため、他の戦利品と同じように持ち主を変えられます。',
  'heroicShop.upgradeTitle': 'ヒロイック強化',
  'heroicShop.upgradeIntro': 'ヒロイックの証{marks}個でクルーシブルのティア装備をヒロイック形態に鍛え直します。力が一段上がり、縛られなくなります。',
  'heroicShop.upgradeEmpty': '強化できるクルーシブルのティア装備を持っていません。',
  'heroicShop.upgradeAria': 'ヒロイックの証{marks}個で{item}をヒロイックに強化',
  'heroicShop.upgradeConfirmTitle': 'ヒロイック強化の確認',
  'heroicShop.upgradeConfirmBody': 'ヒロイックの証{marks}個で{item}をヒロイック形態に強化しますか？強化に使った証は返金できません。',
  'heroicShop.upgradeConfirmAccept': '強化',
  'heroicShop.upgraded': '{item}がヒロイック形態に鍛え直されました。',
  'heroicShop.upgradeNotEligible': 'そのアイテムは強化できません。',
  'heroicShop.upgradeOutOfRange': '強化するには英雄需品係のもとにいる必要があります。',
  'heroicShop.upgradeNotEnoughMarks': '強化にはヒロイックの証が{marks}個必要です。',
};
