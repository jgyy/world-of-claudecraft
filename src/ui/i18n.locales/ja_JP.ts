...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.waystone_warden_ilse.greeting': '銀貨五十枚で、ワームゲートがハイウォッチまで運んでくれる。竜より安く、自分の足より高い。',
  'entities.npcs.waystone_warden_ilse.name': '道標石の番人イルゼ',
  'entities.npcs.waystone_warden_ilse.title': 'ワームゲートの守り手',
  'entities.npcs.provisioner_dunmore.greeting': '山羊は焼けた、水は冷えている、トロルは今週まだ倉庫を燃やしていない。買えるうちに買いな。',
  'entities.npcs.provisioner_dunmore.name': '糧食係ダンモア',
  'entities.npcs.provisioner_dunmore.title': '最後の砦の従軍商人',
  'entities.npcs.sergeant_varga.greeting': 'この砦を守った守備隊は帰ってこなかった。今は我々が彼らの代わりに守っている。東の城壁の裂け目に気をつけろ。',
  'entities.npcs.sergeant_varga.name': '軍曹ヴァルガ',
  'entities.npcs.sergeant_varga.title': '外郭の番人',
  'entities.npcs.chaplain_ondrey.greeting': '鍛冶父が何を盗もうと、最後の泉は今もこの壁のそばを流れている。しばらく座っていくといい。広間は静かだが、空ではない。',
  'entities.npcs.chaplain_ondrey.name': '司祭オンドレイ',
  'entities.npcs.chaplain_ondrey.title': '静かなる広間の声',
  'entities.npcs.paymaster_edda_thorne.greeting': '守備隊の給金箱は竜を生き延びた。お前の金も同じだ。預けるも引き出すも、棚をもう一段買うも自由。金庫室は開いている。',
  'entities.npcs.paymaster_edda_thorne.name': '主計官エッダ・ソーン',
  'entities.npcs.paymaster_edda_thorne.title': '金庫室の番人',
  'entities.npcs.auctioneer_bram_kestrel.greeting': '世界市場はこんな遠くまで届いているぞ、{className}。王国中の品に入札するか、砂丘で得た戦利品を出品するがいい。',
  'entities.npcs.auctioneer_bram_kestrel.name': '競売人ブラム・ケストレル',
  'entities.npcs.auctioneer_bram_kestrel.title': '世界市場の声',
  'entities.npcs.armorer_tam_rusk.greeting': '竜は盾を割り、トロルは刃を鈍らせる。砂丘に何を奪われようと、鍛冶場に代わりがある。',
  'entities.npcs.armorer_tam_rusk.name': '武具師タム・ラスク',
  'entities.npcs.armorer_tam_rusk.title': '砦の武具師',
