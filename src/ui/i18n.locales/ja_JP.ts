...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.cardHand.label': '手札',
  'hud.cardHand.discardTitle': '捨て札の山',
  'hud.cardDuel.close': 'カードデュエルを閉じる',
  'hud.cardDuel.notEligible': 'カードアデプトのみがカードデュエルに参加できます。',
  'hud.cardDuel.enterQueue': 'キューに入る',
  'hud.cardDuel.leaveQueue': 'キューを離れる',
  'hud.cardDuel.searching': '対戦相手を探しています...（キュー内 {count} 人）',
  'hud.cardDuel.queueNote': '1対1のカードアデプト決闘です。次の待機中の相手とマッチングされます。',
  ...
  'guide.abilityHook.ca_mending_card': '回復の札を出し、自分か味方を癒やす。',
  'guide.abilityHook.ca_warding_card': '素早い自己防御の札で、短時間だけ防御力を高める。',
  'guide.abilityHook.ca_hex_card': '呪いの札を投げ、対象を減速させて追撃を封じる。',
