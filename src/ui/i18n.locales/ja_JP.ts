...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.itemBindsOnEquip': '装備時にバインド',
  ...
  'guide.gear.bindOnEquipBody': 'ほとんどの装備はこの二つの規則の間にあり、装備した時点でバインドされます。身につけられる緑、青、紫、橙の品は、一度も装備されていない限り、自由に取引も郵送もマーケットへの出品もできます。その間、ツールチップには「装備時にバインド」と表示されます。初めて身につけた瞬間、その品はそのキャラクターに永久に魂縛され、外しても元には戻りません。着用済みの品は商人に売ることはできますが、二度と取引も郵送も出品もできません。試着は、本当に手元に残すつもりのときだけにしましょう。',
