...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wheel.title': '職業の輪',
  'hudChrome.wheel.close': '職業の輪を閉じる',
  'hudChrome.wheel.archetypeLabel': '生き方',
  'hudChrome.wheel.hobbyLabel': '趣味',
  'hudChrome.wheel.dormantLabel': '未着手',
  'hudChrome.wheel.amends': '償いの進捗：{progress}/{required}',
  'hudChrome.wheel.craftTier': '{craft}：{tier}',
  'hudChrome.wheel.armorcrafting': '防具製作',
  'hudChrome.wheel.weaponcrafting': '武器製作',
  'hudChrome.wheel.jewelcrafting': '宝石細工',
  'hudChrome.wheel.alchemy': '錬金術',
  'hudChrome.wheel.engineering': '工学',
  'hudChrome.wheel.cooking': '料理',
  'hudChrome.wheel.inscription': '銘文学',
  'hudChrome.wheel.enchanting': 'エンチャント',
  'hudChrome.wheel.tailoring': '裁縫',
  'hudChrome.wheel.leatherworking': '皮革加工',
