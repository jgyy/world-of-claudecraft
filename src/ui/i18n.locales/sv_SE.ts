...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'classDetails.lore.paladin':
    'Paladiner är heliga korsriddare som stödjer allierade med välsignelser, läker sår med Heligt ljus och skyddar de svaga i tung rustning.',
  'classDetails.lore.priest':
    'Präster åkallar Heligt ljus för att läka och skydda allierade, medan Skuggmagi låter dem dränera livet ur sina fiender.',
  ...
  'classDetails.lore.warlock':
    'Häxmästare frammanar demoner, lägger förbannelser och skada-över-tid-magi, och dränerar liv från fiender för att överleva.',
  ...
  'comingSoon.featureComingSoon': 'Den här funktionen kommer snart till riket.',
  ...
  'entities.abilities.aimed_shot.description':
    'Ett omsorgsfullt riktat skott som vållar {damage} skada.',
  'entities.abilities.aimed_shot.name': 'Riktat skott',
  ...
  'entities.abilities.ambush.name': 'Bakhåll',
  ...
  'entities.abilities.arcane_explosion.name': 'Arkanexplosion',
  ...
  'entities.abilities.arcane_shot.name': 'Arkant skott',
  'entities.abilities.aspect_of_the_cheetah.description':
    'Anta gepardens skepnad och öka förflyttningshastigheten med 30 % i 30 min.',
  'entities.abilities.aspect_of_the_cheetah.name': 'Gepardens skepnad',
  'entities.abilities.aspect_of_the_hawk.description':
    'Anta hökens skepnad och öka attackkraften med 20 i 30 min.',
  'entities.abilities.aspect_of_the_hawk.name': 'Hökens skepnad',
  'entities.abilities.aspect_of_the_monkey.description':
    'Anta apans skepnad och öka din chans att väja med 8 % i 30 min.',
  'entities.abilities.aspect_of_the_monkey.name': 'Apans skepnad',
  ...
  'entities.abilities.backstab.name': 'Ryggdolk',
  ...
  'entities.abilities.bash.description': 'Bedövar målet i 2 sek. Endast i björnform.',
  'entities.abilities.bash.name': 'Klubbslag',
  'entities.abilities.battle_shout.description': 'Ökar din attackkraft med 20 i 2 min.',
  'entities.abilities.battle_shout.name': 'Stridsrop',
  'entities.abilities.bear_charge.description':
    'Storma en fiende, generera 9 raseri och bedöva den i 1 sek. 8-25 m räckvidd. Endast i björnform.',
  'entities.abilities.bear_charge.name': 'Björnrusning',
  ...
  'entities.abilities.bear_form.name': 'Björnform',
  'entities.abilities.berserker_rage.description':
    'Gå in i ett bärsärkaraseri och generera 20 raseri. (Krigartalang)',
  'entities.abilities.berserker_rage.name': 'Bärsärkaraseri',
  ...
  'entities.abilities.blessing_of_might.name': 'Styrkans välsignelse',
  ...
  'entities.abilities.bloodthirst.name': 'Blodtörst',
  ...
  'entities.abilities.charge.name': 'Storma',
  'entities.abilities.cheap_shot.description':
    'Slå målet och bedöva det i 4 sek. Måste vara smygande. Ger 2 kombopoäng.',
  'entities.abilities.cheap_shot.name': 'Fult slag',
  ...
  'entities.abilities.conjure_food.name': 'Frammana mat',
  ...
  'entities.abilities.conjure_water.name': 'Frammana vatten',
  ...
  'entities.abilities.consecration.name': 'Invigning',
  'entities.abilities.corruption.description':
    'Fördärvar målet och vållar {damage} skuggskada under 18 sek.',
  'entities.abilities.corruption.name': 'Fördärv',
  'entities.abilities.crippling_poison.description':
    'Träffar målet med ett lamslående gift som vållar {damage} naturskada och saktar dess förflyttningshastighet med 50 % i 12 sek.',
  'entities.abilities.crippling_poison.name': 'Lamslående gift',
  'entities.abilities.curse_of_agony.description':
    'Förbannar målet med plåga: {damage} skuggskada över 24 sek.',
  'entities.abilities.curse_of_agony.name': 'Plågans förbannelse',
  ...
  'entities.abilities.deadly_poison.name': 'Dödligt gift',
  ...
  'entities.abilities.defensive_stance.name': 'Försvarsställning',
  'entities.abilities.demon_skin.description': 'Demonisk hud ökar din rustning med 30 i 30 min.',
  'entities.abilities.demon_skin.name': 'Demonhud',
  ...
  'entities.abilities.dismiss_pet.name': 'Avfärda djur',
  ...
  'entities.abilities.flametongue_weapon.name': 'Flamtungevapen',
  'entities.abilities.flash_heal.description':
    'En snabb bön som läker ett vänligt mål för {damage}.',
  'entities.abilities.flash_heal.name': 'Snabbläkning',
  'entities.abilities.flash_of_light.description':
    'En snabb, effektiv glimt av ljus som läker ett vänligt mål för {damage}.',
  'entities.abilities.flash_of_light.name': 'Ljusglimt',
  ...
  'entities.abilities.frost_shock.name': 'Frostchock',
  ...
  'entities.abilities.frostbolt.name': 'Frostpil',
  ...
  'entities.abilities.frostbrand_weapon.name': 'Frostbrandsvapen',
  ...
  'entities.abilities.garrote.name': 'Strypsnara',
  'entities.abilities.ghost_wolf.description':
    'Förvandlar dig till en spökvarg och ökar förflyttningshastigheten med 40 % i 10 min.',
  'entities.abilities.ghost_wolf.name': 'Spökvarg',
  ...
  'entities.abilities.gouge.name': 'Karva',
  'entities.abilities.growl.description':
    'Morrar åt målet: ditt hot stiger till nivån hos dess mest hatade fiende och den tvingas anfalla dig i 3 sek. Endast i björnform.',
  'entities.abilities.growl.name': 'Morra',
  'entities.abilities.hammer_of_justice.description': 'Bedövar målet i 3 sek.',
  'entities.abilities.hammer_of_justice.name': 'Rättvisans hammare',
  ...
  'entities.abilities.instant_poison.name': 'Snabbverkande gift',
  'entities.abilities.judgement.description':
    'Släpper lös ditt aktiva sigill mot fienden och förbrukar det för att vålla dess domsskada.',
  ...
  'entities.abilities.lightning_shield.name': 'Blixtsköld',
  'entities.abilities.mark_of_the_wild.description':
    'Placerar Vildmarkens tecken på ett vänligt mål och ökar rustningen med 25 i 30 min.',
  'entities.abilities.mark_of_the_wild.name': 'Vildmarkens tecken',
  'entities.abilities.maul.description':
    'Ett mörbultande anfall som ökar närstridsskadan med {damage} och vållar en stor mängd hot. Aktiveras vid ditt nästa hugg. Endast i björnform.',
  'entities.abilities.maul.name': 'Mörbulta',
  ...
  'entities.abilities.mongoose_bite.name': 'Mungobett',
  'entities.abilities.moonfire.description':
    'Bränner fienden med måneld för {damage} arkanskada plus skada över tid.',
  'entities.abilities.moonfire.name': 'Måneld',
  ...
  'entities.abilities.pyroblast.name': 'Pyrosalva',
  ...
  'entities.abilities.righteous_fury.name': 'Rättfärdig vrede',
  ...
  'entities.abilities.rockbiter_weapon.name': 'Stenbitarvapen',
  ...
  'entities.abilities.slice_and_dice.name': 'Hugg och skär',
  ...
  'entities.abilities.stormstrike.name': 'Stormhugg',
  'entities.abilities.summon_doomguard.description':
    'Binder en domsväktare till din vilja, en elitdemon som öser tung skuggskada från avstånd. En lång nedkylning hindrar dess förödande kraft. Att frammana en ny demon avfärdar din nuvarande. Du kan ha en demon åt gången.',
  'entities.abilities.summon_doomguard.name': 'Frammana domsväktare',
  'entities.abilities.summon_felguard.description':
    'Frammanar en felvakt under häxmästarens befäl. Felvakten är en tålig närstridsdemon som vadar in i striden och står på egna ben. Att frammana en ny demon avfärdar din nuvarande. Du kan ha en demon åt gången.',
  'entities.abilities.summon_felguard.name': 'Frammana felvakt',
  'entities.abilities.summon_felhunter.description':
    'Frammanar en feljägare under häxmästarens befäl. Feljägaren ansätter fiender från avstånd med skuggbett och utmärker sig på att jaga magiker. Att frammana en ny demon avfärdar din nuvarande. Du kan ha en demon åt gången.',
  'entities.abilities.summon_felhunter.name': 'Frammana feljägare',
  'entities.abilities.summon_imp.description':
    'Frammanar en imp under häxmästarens befäl. Impen slungar eldpilar mot dina fiender från avstånd. Att frammana en ny demon avfärdar din nuvarande. Du kan ha en demon åt gången.',
  'entities.abilities.summon_imp.name': 'Frammana imp',
  'entities.abilities.summon_infernal.description':
    'Binder ett inferno till din vilja, en väldig pansarvräng med krossande närstrid och de djupaste hälso- och rustningsvärdena av alla demoner. En lång nedkylning hindrar dess råa kraft. Att frammana en ny demon avfärdar din nuvarande. Du kan ha en demon åt gången.',
  'entities.abilities.summon_infernal.name': 'Frammana inferno',
  'entities.abilities.summon_succubus.description':
    'Frammanar en succubus under häxmästarens befäl. Succubusen är en bräcklig demon som hugger snabbt och slår hårt i närstrid. Att frammana en ny demon avfärdar din nuvarande. Du kan ha en demon åt gången.',
  'entities.abilities.summon_succubus.name': 'Frammana succubus',
  ...
  'entities.abilities.swipe.name': 'Svep',
  ...
  'entities.abilities.thunder_clap.name': 'Åskknall',
  'entities.abilities.tigers_fury.description':
    'Ökar attackstyrkan med 40 i 6 sek. Endast vargform.',
  'entities.abilities.tigers_fury.name': 'Tigerns raseri',
  ...
  'entities.items.apprentice_robe.name': 'Lärlingens dräkt',
  'entities.items.apprentice_staff.name': 'Dalens lärlingsstav',
  'entities.items.baked_bread.name': 'Nybakat bröd',
  ...
  'entities.items.bristleback_maul.name': 'Borstryggens klubba',
  ...
  'entities.items.conjured_bread3.name': 'Frammanad sötbulle',
  'entities.items.conjured_water.name': 'Frammanat källvatten',
  'entities.items.conjured_water2.name': 'Frammanat mineralvatten',
  'entities.items.conjured_water3.name': 'Frammanat kolsyrat vatten',
  ...
  'entities.items.crownforged_dreadhelm.name': 'Kronsmidd skräckhjälm',
  'entities.items.crownforged_warspaulders.name': 'Kronsmidda krigsskuldror',
  ...
  'entities.items.cryptstalker_jerkin.name': 'Kryptsmygarväst',
  ...
  'entities.items.deathlord_legguards.name': 'Dödsherrens benskydd',
  'entities.items.deathlord_sabatons.name': 'Dödsherrens sabatoner',
  'entities.items.deathlord_warplate.name': 'Dödsherrens krigsplåt',
  'entities.items.deathlords_dread_visage.name': 'Dödsherrens skräckanlete',
  ...
  'entities.items.gnarled_staff.name': 'Knotig stav',
  ...
  'entities.items.kingsbane_last_oath.name': 'Kungabane, Törntoppens sista ed',
  ...
  'entities.items.mistcallers_edge.name': 'Dimkallarens egg',
  ...
  'entities.items.moonshroud_breastplate.name': 'Månhöljes bröstharnesk',
  'entities.items.moonshroud_robe.name': 'Månhöljesrock',
  'entities.items.moonshroud_tunic.name': 'Månslöjetunika',
  'entities.items.morthen_grimoire.name': 'Morthens grimoar',
  'entities.items.mossy_handwraps.name': 'Mossbevuxna handlindor',
  'entities.items.mudfin_scale.name': 'Slemmigt murlocfjäll',
  'entities.items.necromancers_legwraps.name': 'Nekromantikerns benlindor',
  'entities.items.necromancers_soulspire_mantle.name': 'Nekromantikerns själsspiramantel',
  'entities.items.necromancers_soulsteps.name': 'Nekromantikerns själssteg',
  'entities.items.necromancers_starshroud.name': 'Nekromantikerns stjärnslöja',
  ...
  'entities.items.nighttalon_crown.name': 'Nattklokrona',
  'entities.items.nighttalon_shoulderguards.name': 'Nattkloaxelskydd',
  ...
  'entities.items.roasted_boar.name': 'Stekt vildsvinskött',
  ...
  'entities.items.shadowmeld_tunic.name': 'Skuggsmälttunika',
  ...
  'entities.items.soulflame_cowl.name': 'Själslågshuva',
  'entities.items.soulflame_mantle.name': 'Själslågsmantel',
  'entities.items.spider_leg.name': 'Ryckande spindelben',
  'entities.items.spring_water.name': 'Uppfriskande källvatten',
  ...
  'entities.items.tallow_candle.name': 'Talgljus',
  ...
  'entities.items.tough_jerky.name': 'Segt torkat kött',
  ...
  'entities.items.webwood_silk.name': 'Vävskogens silkeskörtel',
  ...
  'entities.items.worn_sword.name': 'Slitet kortsvärd',
  ...
  'entities.items.wyrmshadow_harness.name': 'Lindormsskuggans sele',
  'entities.items.wyrmshadow_legguards.name': 'Lindormsskuggans benskydd',
  'entities.items.wyrmshadow_talongrips.name': 'Lindormsskuggans klogrepp',
  'entities.items.wyrmshadow_treads.name': 'Lindormsskuggans stövlar',
  ...
  'entities.mobs.vael_the_mistcaller.name': 'Vael Dimkallaren',
  ...
  'entities.mobs.webwood_spider.name': 'Vävskogslurkare',
  ...
  'entities.npcs.fisherman_brandt.greeting':
    'Grlmurlgrl- ursäkta, har lyssnat på de där fiskmännen för länge.',
  ...
  'entities.npcs.foreman_odell.greeting':
    'Hela utgrävningen kryllar av de där ljushuvade skadedjuren!',
  ...
  'entities.quests.q_bastion_door.text':
    'Den sjunkna bastionen - en riddarborg som drunknade i kärret för ett sekel sedan - är dit Voss brev pekar, och där denna Dimkallare sjunger sina drunkningshymner. Kulten har skyddat dörren med gravstenar. Hämta mig en av skyddsstenarna, {playerName}, så ska jag lösa upp förseglingen.',
  ...
  'entities.quests.q_boars.title': 'Borstryggens skinn',
  ...
  'entities.quests.q_deepfen.objectives.0.label': 'Djupkärrsbitare dräpt',
  'entities.quests.q_deepfen.text':
    'Djupkärrets murlocer höll sig till sina grundvatten i tjugo år. Nu svärmar de över östra stranden som flugor på ett kadaver - och mina väktare säger att de drar upp saker från sjöbotten. Vad det än är som har stört dem, så vill jag att det stoppas. Gallra ut 12 av bitarna.',
  ...
  'entities.quests.q_deepfen_purge.objectives.0.label': 'Djupkärrsbitare dräpt',
  'entities.quests.q_deepfen_purge.text':
    'Aldric säger att de där avgudarna är kultmakade - vilket betyder att murlocerna hissar upp kärrets gamla ondska en famn i taget. Jag tänker inte ha det sköljande upp på min vägbank. Gå tillbaka till grundvattnen och bryt muddringen för gott: 14 bitare till.',
  ...
  'entities.quests.q_fenbridge_muster.text':
    "Morthens skrifter namngav en mästare i det norra kärret - en 'Dimkallare.' Nu har Väktaren Fenwick blåst i uppbådshornet vid Fenbridge, och jag tror inte på sammanträffanden, {playerName}. Ta vägbanken norrut, dra uppbådsordern från portstolpen, och överlämna den till Väktaren.",
  ...
  'entities.quests.q_glowing_wax.text':
    'Caddis visade mig ett ljus taget från en av de där tunnelgrävarna - vaxet glöder, {playerName}, och det är varmt som ett hjärtslag. Han vill ha mer för studier, och jag vill ha det av min rekvisitionslista. Hämta tillbaka sex klumpar av det glödande vaxet.',
  'entities.quests.q_glowing_wax.title': 'Sällsamt vax',
  'entities.quests.q_gravecallers_trail.completion':
    "Morthen skrev till en 'Dimkallare' i det norra kärret. Sekten är inte död, {playerName} - den har bara varit tålmodig.",
  ...
  'entities.quests.q_idols.text':
    'Fenwicks väktare säger att fiskmännen muddrar upp avgudar från sjöbotten och klamrar sig fast vid dem som heliga reliker. Om de avgudarna är vad jag fruktar, måste jag se dem med egna ögon. Ta 5 från Djupkärrsbitarna - de kommer inte att skiljas från dem med lätthet.',
  ...
  'entities.quests.q_kobold_tunnels.completion':
    'Rakt ner, varje schakt av det - kobolder gräver inte så på egen hand. Jag måste rådfråga mina böcker.',
  'entities.quests.q_kobold_tunnels.objectives.0.label': 'Djupstensgrävare dräpt',
  'entities.quests.q_kobold_tunnels.text':
    'Kobolderna vid Djupstensgrytorna gräver djupare än någon ljusråtta har ärende att gräva - rakt ner, som om något kallade på dem. Deras tunnlar löper under vår mur, {playerName}. Sätt stopp för saken: döda tolv Djupstensgrävare.',
  ...
  'entities.quests.q_mine.objectives.0.label': 'Tunnelråttsgrävare dräpt',
  'entities.quests.q_mine.text':
    'Vi stötte på en fin kopparåder och sedan kom de där koboldskadedjuren forsande ut ur bergssidan. Min besättning sätter inte sin fot i schaktet förrän det är rensat. Lägg 10 Tunnelråttsgrävare döda.',
  ...
  'entities.quests.q_mistcaller.objectives.0.label': 'Vael Dimkallaren dräpt',
  'entities.quests.q_mistcaller.text':
    'På botten av bastionen väntar Vael Dimkallaren - Morthens mästare, Voss mästare, rösten som har dränkt hundra resenärer för att resa sig en armé. Han är långt bortom en ensam hjälte: ta med fyra följeslagare, inte färre. Gör slut på honom, {playerName}, så kan kärrets döda äntligen ligga stilla.',
  'entities.quests.q_mistcaller.title': 'Dimkallaren',
  ...
  'entities.quests.q_murlocs.text':
    'I tjugo år har jag fiskat i Spegelsjön, och aldrig förlorat ett nät förrän de där bubblande fiskmännen kröp upp ur grundvattnet. Driv tillbaka Lerfenarna - dräp 8 av dem. Och se dig för: där det finns en murloc, finns det fem.',
  ...
  'entities.quests.q_rite.text':
    'Kryptan under kapellet måste öppnas om vi ska stoppa Gravkallaren - men endast en bindande rit låter de levande passera. Jag behöver 4 klumpar välsignad talg - koboldgrävarna hamstrar ljus lådvis - och 6 spöklika essenser från de rastlösa döda.',
  ...
  'entities.quests.q_spiders.objectives.0.label': 'Vävskogslurkare dräpt',
  'entities.quests.q_spiders.objectives.1.label': 'Vävskogens silkeskörtel',
  'entities.quests.q_spiders.text':
    'Lurkarna i de östra skogarna spinner ett silke jag behöver till mina omslag - och de har dessutom blivit alldeles för talrika. Gallra 6 vävskogslurkare och skär ut 4 silkeskörtlar ur deras bukar.',
  'entities.quests.q_spiders.title': 'Vävskogens plåga',
  ...
  'entities.quests.q_summoners.completion':
    "Varje chiffer är kontrasignerat 'Diakon Voss' - och vidareadresserat till en 'Dimkallare' i bastionen. Morthens mästare, {playerName}. Vi har funnit honom.",
  ...
  'entities.zones.eastbrook_vale.pois.4.label': 'Vävskogen',
  ...
  'fiesta.augment.aug_lightwell.name': 'Ljusbrunn',
  ...
  'fiesta.augment.aug_spellfire.name': 'Trolldomseld',
  ...
  'game.leaderboard.realmCol': 'Rike',
  ...
  'guide.abilityHook.divine_protection':
    'En snabb helig sköld för att suga upp skada när det blir tufft.',
  ...
  'guide.abilityHook.seal_of_righteousness':
    'Besjälar dina sving med helig skada, förbruka den sedan med Dom.',
  ...
  'guide.abilityHook.summon_imp':
    'Kallar fram en imp som slungar eldpilar mot fiender från avstånd.',
  ...
  'guide.bestiary.flavor.mirejaw_frenzy':
    'En träskmurloc som piskar upp sig själv i ett tröskande raseri mitt i striden, det högljuddaste i en högljudd, revirhävdande flock.',
  ...
  'guide.home.world.marshBlurb': 'Sjunkna kärr och tidsslitna ruiner, hem åt murlocer och värre.',
  ...
  'guide.worldPage.marshBlurb':
    'Ett dränkt land av dimma och ruiner. Murlocer svärmar i grundvattnet och något äldre rör sig under ytan, bevakat från bro-staden Fenbridge.',
  ...
  'guide.worldPage.marshPlaceNotes':
    'Fenbridge vaktar den enda torra vägen. Prowler Reeds och Deepfen Shallows kryllar av träskbestar och murlocer; Widow Thicket är tjockt spunnet med väv; Drowned Chapel och Troll Mounds rymmer äldre faror; Gravecaller Encampment är kulten nedgrävd, och Den sjunkna bastionen är myrens instansierade hjärta.',
  ...
  'loading.connectingRealm': 'Ansluter till riket...',
  ...
  'mode.onlineAria': 'Spela online: logga in på det beständiga delade riket',
  'mode.onlineDesc':
    'Logga in på riket. Dina karaktärer lever på servern och du delar världen med alla andra som är inloggade.',
  'mode.onlineTitle': 'Spela online',
  'mode.play': 'Spela',
  'mode.playAria': 'Spela World of ClaudeCraft',
  'mode.serverAria': 'Välj rike: Online eller Offline',
  'mode.serverLabel': 'Välj ditt rike',
  ...
  'realm.down': 'Riket är nere',
  'realm.full': 'Fullt',
  'realm.high': 'Hög',
  'realm.loading': 'Laddar riken...',
  'realm.low': 'Låg',
  'realm.medium': 'Medel',
  'realm.noRealms': 'Inga riken tillgängliga.',
  ...
  'realm.popTipMedium':
    'Medelhög befolkning: 15 till 39 spelare online just nu. Ett friskt och aktivt rike.',
  'realm.popTipOffline':
    'Offline: det här riket går inte att nå just nu och kan inte anslutas till.',
  'realm.recommended': 'Rekommenderas',
  'realm.selectedRealm': 'Rike: {name}',
  ...
  'serverUnavailable.heading': 'Riket är tillfälligt otillgängligt.',
  'serverUnavailable.logoAlt': 'World of ClaudeCraft',
  'serverUnavailable.status': 'Tillbaka snart',
  'serverUnavailable.title': 'World of ClaudeCraft - Riket otillgängligt',
  ...
  'stats.realmName': 'Rikets namn',
  'stats.title': 'Rikesstatus',
  ...
  'entities.itemSets.necromancers.bonus2': 'Minskar kastfördröjning från skada med 50%.',
  'entities.itemSets.necromancers.bonus3': 'Skada du tar fördröjer inte dina besvärjelser.',
  ...
  'entities.itemSets.soulflame.bonus2': 'Minskar kastfördröjning från skada med 50%.',
  'entities.itemSets.soulflame.bonus3': 'Skada du tar fördröjer inte dina besvärjelser.',
  'entities.itemSets.stormcallers.name': 'Stormkallarens skrud',
  'entities.itemSets.stormcallers.bonus2': 'Minskar kastfördröjning från skada med 50%.',
  'entities.itemSets.stormcallers.bonus3': 'Skada du tar fördröjer inte dina besvärjelser.',
