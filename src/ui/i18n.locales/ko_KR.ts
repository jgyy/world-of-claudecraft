...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.auraEffect.armorReduce': '방어도를 {pct}% 감소시킵니다',
  'hudChrome.auraEffect.armorReduceStacks': '방어도를 {pct}% 감소시킵니다 ({stacks}중첩)',
  ...
  'hudChrome.auraEffect.hex': '저주: 행동할 수 없습니다',
