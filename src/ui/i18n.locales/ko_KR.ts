...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.flightmaster_eastbrook.name': '렌 홀리스',
  'entities.npcs.flightmaster_eastbrook.title': '비행 조련사',
  'entities.npcs.flightmaster_eastbrook.greeting': '그리핀은 푹 쉬었고 하늘도 맑습니다, {className}님. 어디로 가시겠습니까?',
  'entities.npcs.flightmaster_fenbridge.name': '오도 마시윅',
  'entities.npcs.flightmaster_fenbridge.title': '비행 조련사',
  'entities.npcs.flightmaster_fenbridge.greeting': '올라갈 때 갈대를 조심하세요. 마을 이름만 대면 데려다 드리지요.',
  'entities.npcs.flightmaster_highwatch.name': '브람 시슬크래그',
  'entities.npcs.flightmaster_highwatch.title': '비행 조련사',
  'entities.npcs.flightmaster_highwatch.greeting':
    '공기는 희박하고 시야는 멀리 트였지요. 이 새들은 이 봉우리의 고개란 고개는 다 압니다.',
  'entities.npcs.flightmaster_eldergleam.name': '실베인 더스크워든',
  'entities.npcs.flightmaster_eldergleam.title': '비행 조련사',
  'entities.npcs.flightmaster_eldergleam.greeting': '골짜기는 위에서 보면 훨씬 온화합니다. 착륙지를 고르세요.',
  'entities.npcs.flightmaster_wyrmwatch.name': '카르스크 엠버하이드',
  'entities.npcs.flightmaster_wyrmwatch.title': '비행 조련사',
  'entities.npcs.flightmaster_wyrmwatch.greeting': '와이름조차 내 새들은 멀찍이 피해 갑니다. 요새가 당신을 어디로 보내던가요?',
  'entities.npcs.flightmaster_icemantle.name': '힐데 프로스트맨틀',
  'entities.npcs.flightmaster_icemantle.title': '비행 조련사',
  'entities.npcs.flightmaster_icemantle.greeting': '단단히 여미세요. 빙하 위 바람은 살을 에지만, 비행은 금방 끝납니다.',
  'entities.npcs.flightmaster_lanternmere.name': '페닉 앰버게일',
  'entities.npcs.flightmaster_lanternmere.title': '비행 조련사',
  'entities.npcs.flightmaster_lanternmere.greeting': '야간 비행을 위해 등불을 밝혔습니다. 목적지를 고르세요.',
  'entities.npcs.flightmaster_bridgemere.name': '탐신 리드라이트',
  'entities.npcs.flightmaster_bridgemere.title': '비행 조련사',
  'entities.npcs.flightmaster_bridgemere.greeting': '다리에서 늪이 허락하는 어디로든. 어디로 가시겠습니까, {className}님?',
  'entities.npcs.flightmaster_moonrest.name': '엘로웬 나이트송',
  'entities.npcs.flightmaster_moonrest.title': '비행 조련사',
  'entities.npcs.flightmaster_moonrest.greeting': '나방이 밤새들을 집으로 이끕니다. 어디인지 말하면 날아가지요.',
  'entities.npcs.flightmaster_gallowmere.name': '코빈 그레이브젠드',
  'entities.npcs.flightmaster_gallowmere.title': '비행 조련사',
  'entities.npcs.flightmaster_gallowmere.greeting': '이곳 하늘에는 출몰하는 것이 없습니다. 아직은요. 마을 이름을 대세요.',
  'entities.npcs.flightmaster_drifthaven.name': '니아 솔트윈드',
  'entities.npcs.flightmaster_drifthaven.title': '비행 조련사',
  'entities.npcs.flightmaster_drifthaven.greeting': '얕은 물에서 올라오는 따뜻한 바람이 새를 잘 띄워 줍니다. 어디로 가시나요?',
  'entities.npcs.flightmaster_hedgewick.name': '핍 그린바우어',
  'entities.npcs.flightmaster_hedgewick.title': '비행 조련사',
  'entities.npcs.flightmaster_hedgewick.greeting': '울타리를 넘고 과수원을 지나서. 어디로 할까요?',
  'entities.npcs.flightmaster_wickharbor.name': '말로 게일슨',
  'entities.npcs.flightmaster_wickharbor.title': '비행 조련사',
  'entities.npcs.flightmaster_wickharbor.greeting': '오늘은 항구 바람이 고릅니다. 착륙지를 고르세요.',
  'entities.npcs.flightmaster_gullhaven.name': '사빈 걸윙',
  'entities.npcs.flightmaster_gullhaven.title': '비행 조련사',
  'entities.npcs.flightmaster_gullhaven.greeting': '갈매기들은 내 새들을 싫어합니다. 새들은 신경도 안 쓰지요. 어디로 가시겠습니까?',
  ...
  'hudChrome.flight.title': '비행 경로',
  'hudChrome.flight.gossipOption': '비행 타기',
  'hudChrome.flight.gossipOptionAria': '{name}의 비행 타기',
  'hudChrome.flight.rowAria': '{town}(으)로 비행, {hops} 구간, {fare}',
  'hudChrome.flight.hops': '{count} 구간',
  'hudChrome.flight.fare': '요금: {fare}',
  'hudChrome.flight.empty': '아직 아는 다른 비행 경로가 없습니다. 다른 마을의 비행 조련사에게 말을 걸어 그 경로를 익히세요.',
  'hudChrome.flight.close': '비행 경로 닫기',
};
