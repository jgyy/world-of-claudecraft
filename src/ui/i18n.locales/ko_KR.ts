...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_daily_wolves.title': '일일: 무리 솎아내기',
  'entities.quests.q_daily_wolves.text':
    '늑대들이 북쪽 길을 노리는 것을 멈추지 않는군, {playerName}. 오늘도 그 수를 줄여주게. 숲늑대 6마리를 처치하면 보수를 주겠네.',
  'entities.quests.q_daily_wolves.completion':
    '잘했네. 늑대가 줄어드는 날은 이스트브룩이 이기는 날이지.',
  'entities.quests.q_daily_wolves.objectives.0.label': '숲늑대 처치',
  'entities.quests.q_daily_boars.title': '일일: 멧돼지 골칫거리',
  'entities.quests.q_daily_boars.text':
    '서쪽 초원의 멧돼지들이 농부들이 고치는 것보다 빠르게 밭을 파헤치네. 나를 위해 멧돼지 6마리를 잡아주게, {playerName}.',
  'entities.quests.q_daily_boars.completion':
    '농부들은 자네에게 고마워할 걸세. 멧돼지는 아니겠지만.',
  'entities.quests.q_daily_boars.objectives.0.label': '야생 멧돼지 처치',
  'entities.quests.q_daily_spiders.title': '일일: 거미줄 청소',
  'entities.quests.q_daily_spiders.text':
    '동쪽 숲의 잠복자들이 우리가 거미줄을 태우는 것보다 빠르게 번식하네. 오늘 세이블웹 잠복자 5마리를 처치해주게, {playerName}.',
  'entities.quests.q_daily_spiders.completion': '걱정거리 하나가 줄었군. 고맙네.',
  'entities.quests.q_daily_spiders.objectives.0.label': '세이블웹 잠복자 처치',
  'entities.quests.q_daily_murlocs.title': '일일: 머드핀 격퇴',
  'entities.quests.q_daily_murlocs.text':
    '머드핀이 밤마다 호수에서 더 멀리 기어 올라오네. 그중 5마리를 얕은 물로 몰아내주게, {playerName}.',
  'entities.quests.q_daily_murlocs.completion': '호숫가가 조금은 안전해졌군. 잘했네.',
  'entities.quests.q_daily_murlocs.objectives.0.label': '머드핀 잠행자 처치',
  'entities.quests.q_daily_bandits.title': '일일: 대로의 정의',
  'entities.quests.q_daily_bandits.text':
    '길의 산적들이 다시 대담해졌네. 그중 4명을 법의 심판대에 세워주게, {playerName}. 그러면 마차 행렬도 편히 다닐 걸세.',
  'entities.quests.q_daily_bandits.completion': '길에 칼이 넷 줄었군. 마차 행렬이 자네에게 빚졌네.',
  'entities.quests.q_daily_bandits.objectives.0.label': '골짜기 산적 처치',
  'entities.quests.q_daily_rats.title': '일일: 해로운 짐승 퇴치',
  'entities.quests.q_daily_rats.text':
    '광부들이 굴을 파는 해로운 짐승들을 갱도에서 막지 못하고 있네. 오늘 심층암 굴착꾼 6마리를 잡으면 그들도 편히 일할 수 있을 걸세.',
  'entities.quests.q_daily_rats.completion':
    '하! 광부들이 곡괭이로 돌아갈 수 있겠군. 고맙네, {playerName}.',
  'entities.quests.q_daily_rats.objectives.0.label': '심층암 굴착꾼 처치',
  'entities.quests.q_daily_fangs.title': '일일: 송곳니 전리품',
  'entities.quests.q_daily_fangs.text':
    '이번 철에는 현상금을 송곳니로 쳐주네. 숲늑대에게서 늑대 송곳니 5개를 가져다주게, {playerName}.',
  'entities.quests.q_daily_fangs.completion': '깨끗한 송곳니 다섯 개로군. 현상금은 자네 것일세.',
  'entities.quests.q_daily_fangs.objectives.0.label': '늑대 송곳니',
  'entities.quests.q_daily_legs.title': '일일: 거미 부위',
  'entities.quests.q_daily_legs.text':
    '약제사가 팅크제에 쓸 거미 다리를 원하고, 하나당 값을 쳐주네. 동쪽 숲에서 거미 다리 5개를 모아주게, {playerName}.',
  'entities.quests.q_daily_legs.completion': '그녀가 기뻐할 걸세. 이건 자네 몫이네.',
  'entities.quests.q_daily_legs.objectives.0.label': '거미 다리',
  ...
  'hudChrome.questTracker.dailyBadge': '일일',
  ...
  'guide.professions.gatherIntro':
    "세 가지 채집 전문직을 통해 세계에서 직접 원재료를 얻을 수 있다. 채광은 광맥에서 광석과 돌을 캐고, 벌목은 나무숲에서 목재를 베어내며, 약초학은 야생에서 자라는 약초와 식물을 모은다. 각각 별도로 진행이 추적되므로, 하나를 익힌다고 해서 다른 하나의 진행이 늦어지지 않는다. 처음이라면? 이스트브룩의 오델 십장이 첫 채집을 안내하는 짧은 심부름 '누구에게나 맞는 생업'을 맡기고 있다.",
  'guide.professions.gatherWhatTitle': '자원 노드',
  'guide.professions.gatherWhatBody':
    '광맥, 나무숲, 약초 군락은 골짜기와 습지 곳곳에 눈에 보이는 주인 없는 지형지물로 배치되어 있다. 다가가 상호작용하면 그 안에 있는 것을 채집할 수 있다. 한 번 채집한 노드는 여러분이 다시 채집하려면 회복할 시간이 필요하지만, 다른 플레이어를 막는 일은 결코 없다. 그동안 다른 플레이어가 같은 노드를 채집할 수 있다.',
  'guide.professions.gatherProficiencyTitle': '숙련도',
  'guide.professions.gatherProficiencyBody':
    '채집에 성공할 때마다 해당 채집 전문직의 숙련도가 오르며, 캐릭터 정보 창이 각 전문직을 저마다 따로 기록한다. 더 많은 연습은 결코 진행을 해치지 않고, 오직 보탤 뿐이다.',
  'guide.professions.gatherToolsTitle': '전문 도구',
  'guide.professions.gatherToolsBody':
    '상인들은 각 채집 전문직의 기본 도구를 판매하며, 더 좋은 도구는 제작할 수 있다. 오늘날 자원 노드를 캐는 데 도구가 반드시 필요하지는 않다. 도구는 앞으로 등장할 더 풍부한 노드를 위한 토대이며, 그곳에서는 상위 등급 곡괭이와 도끼, 낫이 그 관문이 될 것이다.',
  ...
  'guide.professions.craftHowBody':
    '제작 창(기본 키 T)을 열면 여러분이 아는 모든 제작법과 각각에 필요한 재료, 그리고 지금 지닌 재료를 볼 수 있다. 재료가 갖춰져 있으면 클릭 한 번으로 제작된다. 일반적인 제작법은 세계 어디에서나 만들 수 있다. 다만 상위 도구와 희귀한 시전자 방어구를 비롯한 몇몇 고급 제작법은 하이워치의 제작 거점에 서 있어야 한다.',
