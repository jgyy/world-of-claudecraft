...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.disenchantWarningEnchanted': '이 아이템에는 마법부여, 명품 보너스, 또는 제작자 각인이 있어 사라집니다.',
  'hudChrome.bags.disenchantResult': '아이템을 분해하여 {material} {count}개를 얻었습니다.',
  'hudChrome.bags.disenchantTypedResult': '아이템을 분해하여 {material} {count}개를 얻었습니다. 주문 제작용 재료입니다.',
