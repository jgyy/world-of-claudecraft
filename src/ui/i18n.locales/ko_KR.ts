...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.interfaceUnlock.frameNames.deedTracker': '업적 추적기',
  'hudChrome.interfaceUnlock.frameNames.delveTracker': '탐굴 추적기',
  'hudChrome.interfaceUnlock.frameNames.riftTracker': '균열 추적기',
  'hudChrome.interfaceUnlock.frameNames.targetDots': '대상 디버프',
  ...
  'hudChrome.keybindTransfer.setup': '단축키 설정',
  'hudChrome.keybindTransfer.apply': '적용',
  ...
  'hudChrome.keyboardMap.notBindable': '그 키는 지정할 수 없습니다.',
  'hudChrome.keyboardMap.boundTo': '{action}을(를) {key} 키에 지정했습니다.',
  'hudChrome.keyboardMap.assignHint': '{key} 키에 지정할 행동을 선택하세요.',
  'hudChrome.keyboardMap.assignPlaceholder': '{key} 키에 행동 지정',
  'hudChrome.keyboardMap.layerGroup': '보조키 레이어',
  'hudChrome.keyboardMap.formGroup': '키보드 크기',
  ...
  'hudChrome.keyboardMap.otherLayers': '보조키 조합으로도 지정됨',
  'hudChrome.fullTransfer.menu': '가져오기 / 내보내기',
  'hudChrome.fullTransfer.title': '설정 가져오기 / 내보내기',
  'hudChrome.fullTransfer.fullSettings': '전체 설정',
  'hudChrome.fullTransfer.intro': '이 기기에 저장된 모든 설정을 하나의 코드로 내보내고 다른 기기나 브라우저에 붙여넣어 가져올 수 있습니다: 그래픽, 오디오, 인터페이스, 테마, 프레임 배치, 모든 캐릭터의 단축키, 컨트롤러와 크로스 핫바 설정, 채팅, 창 필터, 언어, 닫은 안내.',
  'hudChrome.fullTransfer.excluded': '포함되지 않는 항목: 로그인, 계정, 지갑, 구매 데이터. 행동 단축바 배치는 계정에 저장되어 계정과 함께 이동합니다.',
  ...
  'entities.npcs.riftwright_maelis.name': '균열장인 마엘리스',
  'entities.npcs.riftwright_maelis.title': '균열 화로장',
  'entities.npcs.riftwright_maelis.greeting':
    '균열결속 반지는 자신을 만든 균열을 기억한다네, {className}. 반지와 균열이 흘린 정수를 가져오게. 더 많은 것을 기억하도록 가르쳐 주지.',
  ...
  'entities.mobs.nythraxis_bone_spike.name': '뼈가시',
  ...
  'guide.worldPage.intro': 'World of ClaudeCraft는 당신이 두 발로 가로지르는 하나로 이어진 땅입니다. 옛 길은 남쪽에서 북쪽으로 시작의 골짜기와 늪지와 봉우리를 꿰뚫고, 그것들을 지나 그 너머의 분지와 지도 꼭대기의 눈의 땅까지 계속 올라갑니다. 그 길에서 서쪽으로 더 높은 왕국들이 한 줄, 동쪽으로 또 한 줄 열리고, 밸리의 동쪽 해안 앞바다에는 섬이 하나 놓여 있습니다. 다다르는 일 자체가 모험의 일부입니다. 모든 여정은 걷거나 타고 가며, 각 중심 마을의 웨이스톤은 당신이 이미 만진 적 있는 다른 어떤 돌로든 순식간에 당신을 데려다줍니다.\n\n이 땅은 시간도 셉니다. 낮과 밤의 순환은 당신의 세계에 있는 모두가 함께 쓰는 실제 시계로 돌아가므로, 하늘은 여러분 모두에게 동시에 새벽에서 한낮을 지나 황혼과 어둠으로 옮겨가고, 달은 차고 기울며 오가고, 땅 위의 빛도 그에 따라 바뀝니다. 미니맵을 두른 눈금판이 시각을 읽는 곳입니다.',
  ...
  'hudChrome.nythraxisCallout.impaled': '뼈가시! 꿰뚫린 아군을 구하세요!',
  'hudChrome.nythraxisCallout.youAreImpaled': '뼈가시에 꿰뚫렸습니다! 버티세요!',
  'hudChrome.nythraxisCallout.spikeBroken': '가시가 부서졌습니다!',
  'hudChrome.nythraxisCallout.dreadCurseSwap': '공포의 저주: 방어 담당을 교대하세요!',
  'hudChrome.nythraxisCallout.sigilAppears': '결속의 인장이 나타났습니다! 나이트락시스를 그 위로 끌고 가세요!',
  'hudChrome.nythraxisCallout.sigilBound': '나이트락시스가 결속되었습니다! 화력을 집중하세요!',
  'hudChrome.nythraxisCallout.sigilUnbound': '인장이 결속하지 못한 채 사라집니다! 나이트락시스가 강해집니다!',
  'hudChrome.nythraxisCallout.gravefireTarget': '무덤불길이 당신을 향해 돌진합니다! 옆으로 피하세요!',
  'hudChrome.nythraxisCallout.kingsWrath': '왕이 분노하여 일어섭니다! 이제 모든 공격이 더 강해집니다!',
  'hudChrome.nythraxisCallout.boneStormBegins': '뼈 폭풍! 흩어져서 도망치세요!',
  'hudChrome.nythraxisCallout.boneStormCharge': '나이트락시스가 당신에게 돌진합니다! 도망치세요!',
  'hudChrome.nythraxisCallout.boneStormEnds': '뼈 폭풍이 끝났습니다. 방어 담당은 대상을 확보하세요!',
  'hudChrome.nythraxisCallout.crownEndures60': '굴하지 않는 왕관까지 1분!',
  'hudChrome.nythraxisCallout.crownEndures30': '굴하지 않는 왕관까지 30초!',
  'hudChrome.nythraxisCallout.crownEndures10': '10초 남았습니다! 화력을 집중하세요!',
  'hudChrome.nythraxisCallout.crownEndures': '굴하지 않는 왕관! 나이트락시스가 격노합니다!',
  ...
  'hudChrome.raidBossGuide.nythraxis.phaseKingsWrathSummary': '생명력이{health}가 되면 나이트락시스가 왕의 분노로 포효하며, 이후 전투가 끝날 때까지 일반 난이도에서 {bonusNormal}, 영웅 난이도에서 {bonusHeroic}의 피해를 추가로 입힙니다. 무덤 분출 주기가 {eruptionEveryNormal}초(영웅 {eruptionEveryHeroic}초)로, 무덤불길 주기가 {gravefireEveryNormal}초(영웅 {gravefireEveryHeroic}초)로 짧아집니다. 다른 모든 메커니즘의 주기는 그대로 유지됩니다.',
  'hudChrome.raidBossGuide.nythraxis.gravebreakerName': '무덤파괴자',
  'hudChrome.raidBossGuide.nythraxis.gravebreakerSummary': '{seconds}초마다 나이트락시스가 다음 공격을 충전합니다. 대상은 그 공격만 받지만, 그의 전방 {arc}도 부채꼴 안 {range}야드 이내에 있는 다른 모든 플레이어는 그 공격의 {splash}만큼을 각자의 방어도로 감소한 물리 피해로 받습니다.',
  'hudChrome.raidBossGuide.nythraxis.gravebreakerResponse': '방어 담당은 나이트락시스가 계속 공격대 반대쪽을 향하게 합니다. 나머지 인원은 그의 뒤나 옆에 머물며 절대 부채꼴 범위를 가로지르지 않습니다.',
  'hudChrome.raidBossGuide.nythraxis.dreadCurseName': '공포의 저주',
  'hudChrome.raidBossGuide.nythraxis.dreadCurseSummary': '{every}초마다 나이트락시스가 현재 방어 담당을 공격해 최대 생명력의 {hitNormal}만큼 암흑 피해를 입히고 공포의 저주를 1중첩 추가합니다. {duration}초 동안 중첩당 그 방어 담당이 나이트락시스에게 받는 피해가 {perStackNormal}만큼 증가하며, 최대 {max}중첩까지 쌓입니다.',
  'hudChrome.raidBossGuide.nythraxis.dreadCurseHeroicSummary': '{every}초마다 나이트락시스가 현재 방어 담당을 공격해 최대 생명력의 {hitHeroic}만큼 암흑 피해를 입히고 공포의 저주를 1중첩 추가합니다. {duration}초 동안 중첩당 그 방어 담당이 나이트락시스에게 받는 피해가 {perStackHeroic}만큼 증가하며, 최대 {max}중첩까지 쌓입니다.',
  'hudChrome.raidBossGuide.nythraxis.dreadCurseResponse': '방어 담당은 {stacks}중첩에서 교대합니다: 다른 방어 담당이 도발하고, 저주에 걸린 방어 담당은 중첩이 사라질 때까지 무덤파괴자의 부채꼴 밖에 머뭅니다. 치유 담당은 교대 전에 새로 들어올 방어 담당의 생명력을 채워 둡니다.',
  'hudChrome.raidBossGuide.nythraxis.boneSpikeName': '뼈가시',
  'hudChrome.raidBossGuide.nythraxis.boneSpikeSummary': '{everyNormal}초마다 나이트락시스가 현재 대상을 제외한 플레이어 {victimsNormal}명을 뼈가시에 꿰뚫습니다. 꿰뚫린 플레이어는 행동할 수 없으며 자신의 가시가 파괴될 때까지 매초 최대 생명력의 {drainNormal}만큼 잃습니다.',
  'hudChrome.raidBossGuide.nythraxis.boneSpikeHeroicSummary': '{everyHeroic}초마다 나이트락시스가 현재 대상을 제외한 플레이어 {victimsHeroic}명을 뼈가시에 꿰뚫습니다. 꿰뚫린 플레이어는 행동할 수 없으며 자신의 가시가 파괴될 때까지 매초 최대 생명력의 {drainHeroic}만큼 잃습니다.',
  'hudChrome.raidBossGuide.nythraxis.boneSpikeResponse': '공격 담당은 즉시 뼈가시로 전환해 파괴하고 꿰뚫린 플레이어를 구합니다. 치유 담당은 가시가 파괴되는 동안 꿰뚫린 플레이어를 살려 둡니다.',
  'hudChrome.raidBossGuide.nythraxis.graveEruptionName': '무덤 분출',
  'hudChrome.raidBossGuide.nythraxis.graveEruptionSummary': '{everyNormal}초마다 해골 손이 플레이어 발밑에 반경 {radius}야드의 원 {countNormal}개를 표시합니다. {warning}초 후 각 원이 폭발해 최대 생명력의 {burstNormal}만큼 암흑 피해를 입힌 뒤, {flameNormal}초 동안 무덤 화염으로 타올라 그 안에 서 있는 대상에게 매초 최대 생명력의 {tickNormal}만큼 피해를 입힙니다.',
  'hudChrome.raidBossGuide.nythraxis.graveEruptionHeroicSummary': '{everyHeroic}초마다 해골 손이 플레이어 발밑에 반경 {radius}야드의 원 {countHeroic}개를 표시합니다. {warning}초 후 각 원이 폭발해 최대 생명력의 {burstHeroic}만큼 암흑 피해를 입힌 뒤, {flameHeroic}초 동안 무덤 화염으로 타오르며 그 안에 서 있는 대상에게 매초 최대 생명력의 {tickHeroic}만큼 피해를 입힙니다.',
  'hudChrome.raidBossGuide.nythraxis.graveEruptionResponse': '폭발하기 전에 모든 경고 원 밖으로 나가고 불타는 바닥을 피하세요. 방어 담당은 근접 딜러가 움직일 공간을 확보할 수 있도록 나이트락시스를 화염에서 멀리 끌어냅니다.',
  'hudChrome.raidBossGuide.nythraxis.bindingSigilName': '결속의 인장',
  'hudChrome.raidBossGuide.nythraxis.bindingSigilSummary': '{everyNormal}초마다 나이트락시스로부터 {minDist}에서 {maxDist}야드 떨어진 바닥에 옛 결계의 인장이 타오르며, 그가 불사의 상승을 시작해 {ascensionEvery}초마다 피해량과 공격 속도가 {ascensionNormal}씩 증가합니다. {bindNormal}초 안에 그가 인장 위에 서면 결속됩니다: 상승 효과가 정화되고 {stunNormal}초 동안 기절하며, {boundNormal}초 동안 {vulnerability}만큼 더 큰 피해를 받습니다. 그러지 못하면 모든 플레이어가 최대 생명력의 {unboundHitNormal}만큼 암흑 피해를 입고, 그는 다음 결속까지 {unboundBonusNormal}만큼 더 큰 피해를 유지합니다.',
  'hudChrome.raidBossGuide.nythraxis.bindingSigilHeroicSummary': '{everyHeroic}초마다 나이트락시스로부터 {minDist}에서 {maxDist}야드 떨어진 바닥에 옛 결계의 인장이 타오르며, 그가 불사의 상승을 시작해 {ascensionEvery}초마다 피해량과 공격 속도가 {ascensionHeroic}씩 증가합니다. {bindHeroic}초 안에 그가 인장 위에 서면 결속됩니다: 상승 효과가 정화되고 {stunHeroic}초 동안 기절하며, {boundHeroic}초 동안 {vulnerability}만큼 더 큰 피해를 받습니다. 그러지 못하면 모든 플레이어가 최대 생명력의 {unboundHitHeroic}만큼 암흑 피해를 입고, 그는 다음 결속까지 {unboundBonusHeroic}만큼 더 큰 피해를 유지합니다.',
  'hudChrome.raidBossGuide.nythraxis.bindingSigilResponse': '방어 담당은 공격대가 남긴 불길이 있더라도 즉시 나이트락시스를 인장 위로 끌고 갑니다. 근접 딜러는 끌려가는 경로를 따라가고 원거리 딜러는 새로 생긴 무덤파괴자의 부채꼴을 피합니다. 그가 결속된 동안 모두 화력을 집중합니다.',
  'hudChrome.raidBossGuide.nythraxis.raiseFallenName': '망자 소생',
  'hudChrome.raidBossGuide.nythraxis.raiseFallenSummary': '왕좌 단계 동안 {every}초마다 나이트락시스가 자신의 뒤에서 되살아난 왕실 근위병을 일으킵니다. 그들은 현재 대상에게 돌진해 파괴될 때까지 싸웁니다.',
  'hudChrome.raidBossGuide.nythraxis.raiseFallenResponse': '보조 방어 담당이 일어나는 웨이브마다 대상을 확보합니다. 공격 담당은 뼈가시 사이사이에 근위병을 처리해 왕좌 단계가 끝나기 전에 웨이브가 쌓이지 않게 합니다.',
  'hudChrome.raidBossGuide.nythraxis.soulRendSummary': '나이트락시스가 현재 대상을 제외한 플레이어 {marksNormal}명에게 영혼 가르기 표식을 남깁니다. {fuse}초 후 각 표식은 대상자의 최대 생명력 전체에 해당하는 암흑 피해를 입히며, 이 피해는 그 대상자로부터 {range}야드 이내에 있는 표식 보유자 수만큼 나뉩니다.',
  'hudChrome.raidBossGuide.nythraxis.soulRendHeroicSummary': '나이트락시스가 현재 대상을 제외한 플레이어 {marksHeroic}명에게 영혼 가르기 표식을 남깁니다. {fuse}초 후 각 표식은 대상자의 최대 생명력의 {damageHeroic}만큼 암흑 피해를 입히며, 이 피해는 그 대상자로부터 {range}야드 이내에 있는 표식 보유자 수만큼 나뉩니다. 표식이 혼자 터지면 치명적입니다.',
  'hudChrome.raidBossGuide.nythraxis.soulRendResponse': '표식을 받은 모든 플레이어는 {fuse}초의 시간이 끝나기 전에 한 집결 지점으로 달려가 다른 표식 보유자로부터 {range}야드 이내에 섭니다. 치유 담당은 표식이 터지는 동안 그룹의 생명력을 채웁니다.',
  'hudChrome.raidBossGuide.nythraxis.soulfireName': '영혼불길',
  'hudChrome.raidBossGuide.nythraxis.soulfireSummary': '영혼 가르기가 터질 때마다 각 표식이 있던 자리에 반경 {radius}야드의 보라색 불웅덩이가 남아 {seconds}초 동안 타오르며 매초 최대 생명력의 {tickNormal}만큼 피해를 입힙니다. 웅덩이가 겹치는 곳에서는 각 웅덩이의 피해를 모두 받습니다. 웅덩이는 수호석 {clearance}야드 이내에는 절대 생기지 않습니다.',
  'hudChrome.raidBossGuide.nythraxis.soulfireHeroicSummary': '영혼 가르기가 터질 때마다 겹쳐진 표식 무리마다 반경 {radius}야드의 보라색 불웅덩이가 하나만 남아 {secondsHeroic}초 동안 타오르며 매초 최대 생명력의 {tickHeroic}만큼 피해를 입힙니다. 웅덩이가 겹쳐도 피해는 한 번만 적용되며 중첩되지 않습니다. 웅덩이는 수호석 {clearance}야드 이내에는 절대 생기지 않습니다.',
  'hudChrome.raidBossGuide.nythraxis.soulfireResponse': '표식이 터지면 곧바로 보라색 웅덩이에서 벗어나세요. 다음 집결 지점은 불타는 곳과 겹치지 않게 정하세요.',
  'hudChrome.raidBossGuide.nythraxis.gravefireName': '무덤불길',
  'hudChrome.raidBossGuide.nythraxis.gravefireSummary': '{everyNormal}초마다 보랏빛 무덤불길이 나이트락시스에게서 플레이어 한 명을 향해 뻗어나가며, 매초 {speed}야드씩 자라 최대 {length}야드까지 이어집니다. 지나간 자리마다 {burnNormal}초 동안 타오르며 그 안에 서 있는 대상에게 매초 최대 생명력의 {tickNormal}만큼 피해를 입힙니다.',
  'hudChrome.raidBossGuide.nythraxis.gravefireHeroicSummary': '{everyHeroic}초마다 보랏빛 무덤불길이 나이트락시스에게서 플레이어 한 명을 향해 뻗어나가며, 매초 {speed}야드씩 자라 최대 {length}야드까지 이어집니다. 지나간 자리마다 {burnHeroic}초 동안 타오르며 그 안에 서 있는 대상에게 매초 최대 생명력의 {tickHeroic}만큼 피해를 입힙니다.',
  'hudChrome.raidBossGuide.nythraxis.gravefireResponse': '다가오는 줄기를 옆으로 피하세요: 폭이 좁고 절대 방향을 바꾸지 않습니다. 원거리 플레이어는 한 자리에 머물지 말고 계속 움직입니다.',
  'hudChrome.raidBossGuide.nythraxis.deathlessRageName': '불사의 격노',
  'hudChrome.raidBossGuide.nythraxis.deathlessRageSummary': '{every}초마다 나이트락시스가 {cast}초에 걸쳐 불사의 격노를 시전합니다. 시전하는 동안 불이 켜진 수호석마다 플레이어 한 명이 {channel}초 동안 정신을 집중할 수 있습니다. 시전이 끝나기 전에 서로 다른 플레이어 셋이 각자 수호석을 완료하면 격노가 차단되고 나이트락시스가 {stun}초 동안 기절합니다. 그러지 못하면 모든 플레이어가 최대 생명력의 {damageNormal}만큼 암흑 피해를 입습니다.',
  'hudChrome.raidBossGuide.nythraxis.deathlessRageHeroicSummary': '{every}초마다 나이트락시스가 {cast}초에 걸쳐 불사의 격노를 시전합니다. 시전하는 동안 불이 켜진 수호석마다 플레이어 한 명이 {channel}초 동안 정신을 집중할 수 있습니다. 시전이 끝나기 전에 서로 다른 플레이어 셋이 각자 수호석을 완료하면 격노가 차단되고 나이트락시스가 {stun}초 동안 기절합니다. 그러지 못하면 모든 플레이어가 최대 생명력의 {damageHeroic}만큼 암흑 피해를 입으며, 이는 어떤 생명력으로도 버틸 수 없습니다.',
  'hudChrome.raidBossGuide.nythraxis.deathlessRageResponse': '전투 시작 전에 수호석마다 플레이어를 한 명씩 배정하세요. 시전이 시작되면 각자 자신의 수호석으로 달려가 완료될 때까지 정신을 집중합니다. 기절하거나 자리를 벗어나거나 사망하면 집중이 깨지므로 담당 플레이어를 안전하게 지키고 꿰뚫린 플레이어는 절대 배정하지 마세요.',
  'hudChrome.raidBossGuide.nythraxis.courtName': '불사의 궁정',
  'hudChrome.raidBossGuide.nythraxis.courtSummary': '영웅 난이도에서는 이전 궁정이 쓰러지고 나면 불사의 격노가 차단되었든 아니든 매번 나이트락시스가 자신의 궁정을 새로 일으킵니다. 알드렌의 영혼은 왕실 참격으로 자신의 대상 근처에 있는 모두를 베어냅니다. 말릭의 영혼은 말릭의 치유를 정신 집중으로 시전하며, 시전할 때마다 나이트락시스를 더 많이 치유합니다. 보스의 영혼은 도발을 무시하고 공격대를 사냥합니다.',
  'hudChrome.raidBossGuide.nythraxis.courtResponse': '방어 담당은 알드렌의 대상을 확보해 참격이 공격대 반대편을 향하게 합니다. 말릭의 치유가 시작되는 순간 말릭을 기절시키거나 침묵시켜 가장 먼저 처치하고, 도발이 통하지 않는 보스는 치유 담당에게서 떼어 내도록 속박하거나 기절시켜 그다음으로 처치합니다.',
  'hudChrome.raidBossGuide.nythraxis.kingsWrathName': '왕의 분노',
  'hudChrome.raidBossGuide.nythraxis.kingsWrathSummary': '나이트락시스가 이후 전투가 끝날 때까지 일반 난이도에서 {bonusNormal}, 영웅 난이도에서 {bonusHeroic}의 피해를 추가로 입힙니다. 무덤 분출이 {eruptionEveryNormal}초(영웅 {eruptionEveryHeroic}초)마다, 무덤불길이 {gravefireEveryNormal}초(영웅 {gravefireEveryHeroic}초)마다 발생합니다.',
  'hudChrome.raidBossGuide.nythraxis.kingsWrathResponse': '피할 수 없는 피해에 남은 방어 재사용 기술을 사용하세요. 공격대가 전투를 마무리하는 동안 앞선 모든 메커니즘을 깔끔하게 처리하세요.',
  'hudChrome.raidBossGuide.nythraxis.boneStormName': '뼈 폭풍',
  'hudChrome.raidBossGuide.nythraxis.boneStormSummary': '왕의 분노 시작 {first}초 후부터 이후 {everyNormal}초마다 나이트락시스가 {duration}초 동안 뼈 폭풍을 시작합니다. 그는 위협 수준을 무시하고 평소의 {speed}배 속도로 이동하며, 각각 {chargeSeconds}초씩 지속되는 돌진을 {charges}회 합니다. 회전 공격은 {radius}야드 이내에 매초 최대 생명력의 {whirlNormal}만큼 피해를 입힙니다. 각 돌진은 같은 범위 안에서 뼈 강타로 끝나 최대 생명력의 {slamNormal}만큼 피해를 입힙니다. 폭풍이 시작되고 {spikeAt}초 후 뼈가시를 시전하며, 폭풍이 끝난 {rearm}초 후 무덤파괴자가 다시 준비됩니다.',
  'hudChrome.raidBossGuide.nythraxis.boneStormHeroicSummary': '왕의 분노 시작 {first}초 후부터 이후 {everyHeroic}초마다 나이트락시스가 {duration}초 동안 뼈 폭풍을 시작합니다. 그는 위협 수준을 무시하고 평소의 {speed}배 속도로 이동하며, 각각 {chargeSeconds}초씩 지속되는 돌진을 {charges}회 합니다. 회전 공격은 {radius}야드 이내에 매초 최대 생명력의 {whirlHeroic}만큼 피해를 입힙니다. 각 돌진은 같은 범위 안에서 뼈 강타로 끝나 최대 생명력의 {slamHeroic}만큼 피해를 입힙니다. 폭풍이 시작되고 {spikeAt}초 후 뼈가시를 시전하며, 폭풍이 끝난 {rearm}초 후 무덤파괴자가 다시 준비됩니다.',
  'hudChrome.raidBossGuide.nythraxis.boneStormResponse': '흩어져서 나이트락시스로부터 계속 도망치세요. 돌진 대상으로 지목된 플레이어는 멀리 달아나고 나머지는 돌진 경로 주변에 공간을 남겨 두며, 폭풍이 끝나면 방어 담당이 대상을 확보합니다.',
  'hudChrome.raidBossGuide.nythraxis.crownEnduresName': '굴하지 않는 왕관',
  'hudChrome.raidBossGuide.nythraxis.crownEnduresSummary': '전투 시작 {enrageNormal}초 후(생명력 70%에서 알드릭 수사가 등장하는 동안 시간이 멈춥니다) 굴하지 않는 왕관이 강제 격노로 발동합니다. 나이트락시스는 피해량이 {damage}, 공격 속도가 {haste} 늘어나며, 이후 {rampEveryNormal}초마다 피해량이 {rampStep}씩 더 늘어납니다. 타이머 표시줄은 없습니다. 남은 시간이 {warn60}초, {warn30}초, {warn10}초일 때 외침으로 경고합니다.',
  'hudChrome.raidBossGuide.nythraxis.crownEnduresHeroicSummary': '전투 시작 {enrageHeroic}초 후(생명력 70%에서 알드릭 수사가 등장하는 동안 시간이 멈춥니다) 굴하지 않는 왕관이 강제 격노로 발동합니다. 나이트락시스는 피해량이 {damage}, 공격 속도가 {haste} 늘어나며, 이후 {rampEveryHeroic}초마다 피해량이 {rampStep}씩 더 늘어납니다. 타이머 표시줄은 없습니다. 남은 시간이 {warn60}초, {warn30}초, {warn10}초일 때 외침으로 경고합니다.',
  'hudChrome.raidBossGuide.nythraxis.crownEnduresResponse': '첫 경고를 마지막 화력 집중 구간으로 여기세요. 이동기와 방어 재사용 기술은 남은 메커니즘을 위해 아껴 두었다가 격노가 오기 전에 나이트락시스를 처치하세요.',
  ...
  'entities.itemSets.bramblehide.name': '루츠의 가시덤불가죽',
  'entities.itemSets.bramblehide.bonus2': '힘이 10, 체력이 10만큼 증가합니다.',
  'entities.itemSets.bramblehide.bonus4': '전투력이 25만큼 증가합니다. 무기 치명타 적중 시 50% 확률로 "무덤의 위력"이 발동하여 전투력이 40만큼 증가합니다. 10초 동안 지속됩니다.',
  'entities.itemSets.bramblehide.bonus6': '공격 및 시전 속도가 4%, 적중이 3% 증가합니다. 무기 치명타 적중 시 대상에게 "뼈 파편"을 남겨 12초 동안 2초마다 5의 출혈 피해를 입힙니다. 최대 3번 중첩됩니다.',
  'entities.items.bramblehide_crown.name': '루츠의 가시덤불가죽 왕관',
  'entities.items.bramblehide_mantle.name': '루츠의 가시덤불가죽 어깨보호구',
  'entities.items.bramblehide_harness.name': '루츠의 가시덤불가죽 흉갑',
  'entities.items.bramblehide_cinch.name': '루츠의 가시덤불가죽 허리띠',
  'entities.items.bramblehide_legguards.name': '루츠의 가시덤불가죽 다리보호구',
  'entities.items.bramblehide_grips.name': '루츠의 가시덤불가죽 장갑',
  'entities.items.bramblehide_treads.name': '루츠의 가시덤불가죽 장화',
  'entities.items.courtiers_bonefang.name': '조신의 뼈송곳니',
  'entities.items.thornpeak_wardblade.name': '가시봉우리 수호검',
  'entities.items.gravecourt_hewer.name': '무덤궁정 도끼',
  'entities.items.votive_ward_of_the_deathless_court.name': '불사 궁정의 봉헌 방패',
  ...
  'hudChrome.bank.guildHistoryTab': '기록',
  'hudChrome.bank.logShowing': '길드 은행 활동 {count}건을 최신순으로 표시합니다.',
  'hudChrome.bank.logFilterAria': '길드 은행 기록 필터',
  'hudChrome.bank.logFilterAll': '전체',
  'hudChrome.bank.logFilterItems': '아이템',
  'hudChrome.bank.logFilterMoney': '골드',
  'hudChrome.bank.logOlder': '이전 기록 보기',
  'hudChrome.bank.logOlderLoading': '이전 활동을 불러오는 중...',
  'hudChrome.bank.logEnd': '길드 은행의 전체 기록입니다.',
  'hudChrome.bank.logEmptyFiltered': '이 필터와 일치하는 길드 은행 활동이 없습니다.',
  'hudChrome.bank.logColTime': '시간',
  'hudChrome.bank.logColMember': '구성원',
  'hudChrome.bank.logColAction': '활동',
  'hudChrome.bank.logColDetail': '내용',
  'hudChrome.bank.logActionDeposit': '입금',
  'hudChrome.bank.logActionWithdraw': '출금',
  'hudChrome.bank.logActionBuySlots': '확장 구매',
  'hudChrome.bank.logActionOpenBank': '은행 개설',
  'hudChrome.bank.logActionCharterFee': '창설 수수료 지불',
  'hudChrome.bank.logActionAdminPurge': '삭제',
  'hudChrome.bank.logActorAdmin': '관리자',
  'hudChrome.bank.logDetailItem': '{item} {count}개',
  'hudChrome.bank.logSearchPlaceholder': '이 기록 검색',
  'hudChrome.bank.logSearchAria': '불러온 길드 은행 활동을 구성원, 활동, 아이템으로 검색',
  'hudChrome.bank.logShowingMatched': '불러온 길드 은행 활동 {count}건 중 {matched}건을 표시합니다.',
  'hudChrome.bank.logSearchNoMatch': '검색과 일치하는 활동이 없습니다. 이전 기록을 불러와 범위를 넓히세요.',
  ...
  'hudChrome.riftForge.refused': '화로가 거부했습니다. 균열장인 곁에 서서 다시 시도하세요.',
  'hudChrome.riftForge.reason.notFound': '그 반지는 가방에 없습니다.',
  'hudChrome.riftForge.reason.notRiftGear': '균열결속 반지만 화로에 올릴 수 있습니다.',
  'hudChrome.riftForge.reason.maxUpgrade': '그 반지는 이미 최대로 강화되었습니다.',
  'hudChrome.riftForge.reason.insufficientEssence': '균열의 정수가 부족합니다.',
  'hudChrome.riftForge.reason.invalidGem': '그런 균열 보석이 없습니다.',
  'hudChrome.riftForge.reason.dead': '죽은 상태에서는 할 수 없습니다.',
  ...
  'sim.rift.forgeGemReplaced': '{name}의 균열 보석을 교체했습니다. {gem}은(는) 파괴되었습니다.',
  ...
  'hudChrome.finder.mech.binding_sigil': '결속의 인장(나이트락시스를 인장 위로 끌지 못하면 공격대가 대가를 치름)',
  ...
  'hudChrome.finder.mech.deathless_court': '불사의 궁정(영웅 전용, 불사의 격노 이후 왕실 궁정이 일어남)',
  ...
  'hudChrome.auraEffect.nythraxisKingsWrath': '왕의 분노: 나이트락시스가 이후 전투가 끝날 때까지 {pct}% 더 큰 피해를 입힙니다.',
  'hudChrome.auraEffect.nythraxisBoneStorm': '뼈 폭풍: 나이트락시스가 위협 수준을 무시하고 {radius}야드 이내에서 매초 최대 생명력의 {tick}%만큼 회전 피해를 입히며 플레이어에게 돌진합니다. 흩어져서 도망치세요.',
  'hudChrome.auraEffect.nythraxisCrownEndures': '굴하지 않는 왕관: {stacks}중첩, 피해량 {pct}%, 공격 속도 {haste}% 증가. 공격대에게 남은 시간이 없습니다.',
  ...
  'entities.npcs.waystone_keeper_eastbrook.name': '렌 홀리스',
  'entities.npcs.waystone_keeper_eastbrook.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_eastbrook.greeting':
    '돌이 당신을 위해 웅웅거립니다, {className}님. 한 번 만지면 돌은 당신의 이름을 영영 잊지 않습니다.',
  'entities.npcs.waystone_keeper_fenbridge.name': '오도 마시윅',
  'entities.npcs.waystone_keeper_fenbridge.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_fenbridge.greeting': '돌에 낀 이끼를 조심하세요. 마을 이름만 대면 거기 서 있게 됩니다.',
  'entities.npcs.waystone_keeper_highwatch.name': '브람 시슬크래그',
  'entities.npcs.waystone_keeper_highwatch.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_highwatch.greeting':
    '공기는 희박하고 길은 빠르지요. 이 돌은 당신이 밟았던 봉우리를 하나도 잊지 않습니다.',
  'entities.npcs.waystone_keeper_eldergleam.name': '실베인 더스크워든',
  'entities.npcs.waystone_keeper_eldergleam.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_eldergleam.greeting': '골짜기는 이 돌을 나뭇가지 아래에 지켜 둡니다. 가고 싶은 곳을 고르세요.',
  'entities.npcs.waystone_keeper_wyrmwatch.name': '카르스크 엠버하이드',
  'entities.npcs.waystone_keeper_wyrmwatch.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_wyrmwatch.greeting': '와이름조차 이 돌은 건드리지 않습니다. 요새가 당신을 어디로 보내던가요?',
  'entities.npcs.waystone_keeper_icemantle.name': '힐데 프로스트맨틀',
  'entities.npcs.waystone_keeper_icemantle.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_icemantle.greeting':
    '이 돌은 만지면 따뜻합니다, 빙하 위에서 유일하게 따뜻한 것이지요. 어디로 가시겠습니까?',
  'entities.npcs.waystone_keeper_lanternmere.name': '페닉 앰버게일',
  'entities.npcs.waystone_keeper_lanternmere.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_lanternmere.greeting': '오늘 밤은 돌 주위에 등불이 밝혀져 있습니다. 목적지를 고르세요.',
  'entities.npcs.waystone_keeper_bridgemere.name': '탐신 리드라이트',
  'entities.npcs.waystone_keeper_bridgemere.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_bridgemere.greeting':
    '다리의 돌에서 당신이 아는 어느 돌로든. 어디로 가시겠습니까, {className}님?',
  'entities.npcs.waystone_keeper_moonrest.name': '엘로웬 나이트송',
  'entities.npcs.waystone_keeper_moonrest.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_moonrest.greeting': '나방이 황혼녘에 돌 주위를 맴돕니다. 어디인지 말하면 그곳에 있게 됩니다.',
  'entities.npcs.waystone_keeper_gallowmere.name': '코빈 그레이브젠드',
  'entities.npcs.waystone_keeper_gallowmere.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_gallowmere.greeting': '이 돌에는 아직 아무것도 씌지 않았습니다. 마을 이름을 대세요.',
  'entities.npcs.waystone_keeper_drifthaven.name': '니아 솔트윈드',
  'entities.npcs.waystone_keeper_drifthaven.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_drifthaven.greeting': '소금기도 이 돌을 조금도 무디게 하지 못했습니다. 어디로 가시나요?',
  'entities.npcs.waystone_keeper_hedgewick.name': '핍 그린바우어',
  'entities.npcs.waystone_keeper_hedgewick.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_hedgewick.greeting': '이 돌은 울타리와 과수원 사이에 놓여 있습니다. 어디로 할까요?',
  'entities.npcs.waystone_keeper_wickharbor.name': '말로 게일슨',
  'entities.npcs.waystone_keeper_wickharbor.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_wickharbor.greeting': '항구의 돌은 바람이 어떻든 흔들리지 않습니다. 착륙지를 고르세요.',
  'entities.npcs.waystone_keeper_gullhaven.name': '사빈 걸윙',
  'entities.npcs.waystone_keeper_gullhaven.title': '웨이스톤지기',
  'entities.npcs.waystone_keeper_gullhaven.greeting': '갈매기들이 이 돌에 앉습니다. 돌은 개의치 않지요. 어디로 가시겠습니까?',
  ...
  'entities.items.tome_grand_teleport_eastbrook.name': '통행의 서: 이스트브룩',
  'entities.items.tome_grand_teleport_fenbridge.name': '통행의 서: 펜브리지',
  'entities.items.tome_grand_teleport_highwatch.name': '통행의 서: 하이워치',
  'entities.items.tome_grand_teleport_eldergleam.name': '통행의 서: 엘더글림',
  'entities.abilities.grand_teleport_eastbrook.name': '대규모 순간이동: 이스트브룩',
  'entities.abilities.grand_teleport_eastbrook.description':
    '이스트브룩(으)로 통하는 대규모 차원문을 5분 동안 엽니다. 시전 순간에 당신의 파티에 있던 파티원만 통과할 수 있습니다. 통행의 룬 1개를 소모합니다. 시전 시간 10초. 다른 모든 대규모 순간이동과 20분의 재사용 대기시간을 공유합니다.',
  'entities.abilities.grand_teleport_fenbridge.name': '대규모 순간이동: 펜브리지',
  'entities.abilities.grand_teleport_fenbridge.description':
    '펜브리지(으)로 통하는 대규모 차원문을 5분 동안 엽니다. 시전 순간에 당신의 파티에 있던 파티원만 통과할 수 있습니다. 통행의 룬 1개를 소모합니다. 시전 시간 10초. 다른 모든 대규모 순간이동과 20분의 재사용 대기시간을 공유합니다.',
  'entities.abilities.grand_teleport_highwatch.name': '대규모 순간이동: 하이워치',
  'entities.abilities.grand_teleport_highwatch.description':
    '하이워치(으)로 통하는 대규모 차원문을 5분 동안 엽니다. 시전 순간에 당신의 파티에 있던 파티원만 통과할 수 있습니다. 통행의 룬 1개를 소모합니다. 시전 시간 10초. 다른 모든 대규모 순간이동과 20분의 재사용 대기시간을 공유합니다.',
  'entities.abilities.grand_teleport_eldergleam.name': '대규모 순간이동: 엘더글림',
  'entities.abilities.grand_teleport_eldergleam.description':
    '엘더글림(으)로 통하는 대규모 차원문을 5분 동안 엽니다. 시전 순간에 당신의 파티에 있던 파티원만 통과할 수 있습니다. 통행의 룬 1개를 소모합니다. 시전 시간 10초. 다른 모든 대규모 순간이동과 20분의 재사용 대기시간을 공유합니다.',
  ...
  'hudChrome.waystone.title': '웨이스톤',
  'hudChrome.waystone.gossipOption': '웨이스톤 이용하기',
  'hudChrome.waystone.gossipOptionAria': '{name}의 웨이스톤 이용하기',
  'hudChrome.waystone.rowAria': '{town}(으)로 순간이동, {distance}야드, {price}',
  'hudChrome.waystone.distance': '{distance}야드',
  'hudChrome.waystone.fee': '요금: {fee}',
  'hudChrome.waystone.ticketPrice': '티켓 1장',
  'hudChrome.waystone.tickets': '웨이스톤 티켓: {count}',
  'hudChrome.waystone.guildDiscount': '길드 할인: {pct}%',
  'hudChrome.waystone.empty': '아직 다른 웨이스톤에 조율되어 있지 않습니다. 다른 마을의 돌을 만져 조율하세요.',
  'hudChrome.waystone.close': '웨이스톤 닫기',
};
