...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.soulKey.unboundLine': '영혼의 열쇠로 귀속이 풀림',
  'hudChrome.soulKey.menuAction': '영혼의 열쇠로 귀속 풀기',
  'hudChrome.soulKey.confirmTitle': '영혼 귀속 풀기',
  'hudChrome.soulKey.confirmBody': '{name}에 영혼의 열쇠를 사용할까요? 귀속은 영구히 풀립니다. 각 캐릭터는 주간 초기화마다 {cap}번까지 귀속을 풀 수 있습니다.',
  'hudChrome.soulKey.confirmOk': '귀속 풀기',
  'hudChrome.soulKey.confirmCancel': '취소',
  'hudChrome.soulKey.keyUse': '가방 속 영혼에 귀속된 장비를 우클릭하여 귀속을 영구히 풉니다. 각 캐릭터는 주간 초기화마다 {cap}번까지.',
  'hudChrome.soulKey.released': '{name}의 귀속이 풀렸습니다. 이번 주에 영혼의 열쇠 해제가 {left}번 남았습니다.',
  'hudChrome.soulKey.notEligible': '영혼의 열쇠로는 그 아이템의 귀속을 풀 수 없습니다.',
  'hudChrome.soulKey.notBound': '그 아이템은 영혼에 귀속되어 있지 않습니다.',
  'hudChrome.soulKey.noneHeld': '영혼의 열쇠가 없습니다.',
  'hudChrome.soulKey.weeklyCap': '이 캐릭터는 이번 주의 영혼의 열쇠 해제를 모두 사용했습니다.',
  'guide.gear.soulKeyBody': '영혼에 귀속된 장비가 영원히 귀속되어 있는 것은 아닙니다. 하이워치의 병참장교 브리는 영혼의 열쇠를 골드에 팔며, 가방 속 귀속된 장비 하나에 열쇠를 사용하면 그 귀속은 영구히 풀립니다. 그때부터 그 장비는 누구의 손에 있든 다른 아이템처럼 거래, 우편, 판매, 등록이 가능합니다. 각 캐릭터는 주간 초기화마다 두 번까지만 귀속을 풀 수 있으므로, 열쇠는 잘못된 특성에 떨어진 전리품이나 길드원이 필요로 하는 여분을 위한 것이지, 장비를 모든 캐릭터에게 돌려 쓰기 위한 수단이 아닙니다.',
  'guide.gear.heroicUpgradeBody': '영웅 병참장교 벡스는 영웅의 징표 스무 개로 크루서블 세트 부위를 영웅 형태로 벼려 주기도 합니다. 영웅 부위는 세트 효과와 직업 제한을 그대로 유지하고, 아이템 레벨과 주 능력치가 오르며, 더 이상 귀속되지 않아 다른 전리품처럼 주인을 바꿀 수 있습니다.',
  'heroicShop.upgradeTitle': '영웅 강화',
  'heroicShop.upgradeIntro': '영웅의 징표 {marks}개로 크루서블 세트 부위를 영웅 형태로 벼립니다. 힘이 한 단계 오르고, 더 이상 귀속되지 않습니다.',
  'heroicShop.upgradeEmpty': '강화할 크루서블 세트 부위가 없습니다.',
  'heroicShop.upgradeAria': '영웅의 징표 {marks}개로 {item}을(를) 영웅으로 강화',
  'heroicShop.upgradeConfirmTitle': '영웅 강화 확인',
  'heroicShop.upgradeConfirmBody': '영웅의 징표 {marks}개로 {item}을(를) 영웅 형태로 강화할까요? 강화에 쓴 징표는 환불되지 않습니다.',
  'heroicShop.upgradeConfirmAccept': '강화',
  'heroicShop.upgraded': '{item}이(가) 영웅 형태로 벼려졌습니다.',
  'heroicShop.upgradeNotEligible': '그 아이템은 강화할 수 없습니다.',
  'heroicShop.upgradeOutOfRange': '강화하려면 영웅 병참장교 곁에 있어야 합니다.',
  'heroicShop.upgradeNotEnoughMarks': '강화하려면 영웅의 징표 {marks}개가 필요합니다.',
};
