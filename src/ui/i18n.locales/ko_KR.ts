...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.itemBindsOnEquip': '착용 시 귀속',
  ...
  'guide.gear.bindOnEquipBody': '대부분의 장비는 이 두 규칙 사이에 있으며 착용 시 귀속됩니다. 착용할 수 있는 초록, 파랑, 보라, 주황 등급 아이템은 한 번도 착용하지 않은 동안에는 자유롭게 거래하고 우편으로 보내고 시장에 등록할 수 있으며, 그동안 툴팁에는 "착용 시 귀속"이라고 표시됩니다. 처음 착용하는 순간 그 캐릭터에게 영구히 귀속되며, 다시 벗어도 되돌릴 수 없습니다. 착용했던 장비는 상인에게 팔 수는 있지만 다시는 거래, 우편, 등록이 불가능합니다. 정말 남겨 둘 생각일 때만 착용해 보세요.',
