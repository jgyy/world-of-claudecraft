...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.waystone_warden_ilse.greeting': '은화 오십 닢이면 와이름 관문이 하이워치까지 데려다줍니다. 용보다 싸고, 두 다리보다는 비싸죠.',
  'entities.npcs.waystone_warden_ilse.name': '길잡이돌 감시자 일제',
  'entities.npcs.waystone_warden_ilse.title': '와이름 관문의 수호자',
  'entities.npcs.provisioner_dunmore.greeting': '염소는 구워졌고 물은 차갑고, 트롤들은 이번 주엔 아직 창고를 태우지 않았습니다. 살 수 있을 때 사 두세요.',
  'entities.npcs.provisioner_dunmore.name': '보급관 던모어',
  'entities.npcs.provisioner_dunmore.title': '마지막 요새의 종군 상인',
  'entities.npcs.sergeant_varga.greeting': '이 요새를 지키던 수비대는 돌아오지 못했습니다. 이제 우리가 그들을 대신해 지킵니다. 동쪽 성벽의 틈을 조심하세요.',
  'entities.npcs.sergeant_varga.name': '병장 바르가',
  'entities.npcs.sergeant_varga.title': '외성의 감시자',
  'entities.npcs.chaplain_ondrey.greeting': '대장장이 아버지가 무엇을 훔쳐 갔든, 마지막 샘은 아직 이 성벽 곁에서 흐릅니다. 잠시 앉았다 가세요. 전당은 고요할 뿐, 비어 있지 않습니다.',
  'entities.npcs.chaplain_ondrey.name': '군목 온드레이',
  'entities.npcs.chaplain_ondrey.title': '고요한 전당의 목소리',
  'entities.npcs.paymaster_edda_thorne.greeting': '수비대의 급료 궤짝은 용들을 견뎌 냈고, 당신의 돈도 그럴 것이오. 맡기든, 찾든, 선반을 하나 더 사든; 금고실은 열려 있소.',
  'entities.npcs.paymaster_edda_thorne.name': '경리관 에다 손',
  'entities.npcs.paymaster_edda_thorne.title': '금고실의 수호자',
  'entities.npcs.auctioneer_bram_kestrel.greeting': '세계 시장은 이 먼 곳까지 닿는다오, {className}. 온 왕국이 파는 물건에 입찰하거나, 사구에서 얻은 전리품을 직접 내놓으시오.',
  'entities.npcs.auctioneer_bram_kestrel.name': '경매인 브람 케스트렐',
  'entities.npcs.auctioneer_bram_kestrel.title': '세계 시장의 목소리',
  'entities.npcs.armorer_tam_rusk.greeting': '용은 방패를 쪼개고 트롤은 칼날을 무디게 하지. 사구가 무엇을 앗아갔든, 대장간에 대신할 것이 있소.',
  'entities.npcs.armorer_tam_rusk.name': '무기공 탐 러스크',
  'entities.npcs.armorer_tam_rusk.title': '요새 무기공',
