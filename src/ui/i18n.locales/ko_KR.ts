...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.disenchantButton': '마법 분해',
  'hudChrome.bags.disenchantWarningEnchanted':
    '이 아이템에는 마법부여, 명품 보너스, 또는 제작자 각인이 있어 사라집니다.',
  'hudChrome.bags.disenchantResult': '아이템을 분해하여 {material} {count}개를 얻었습니다.',
  'hudChrome.bags.disenchantTypedResult':
    '아이템을 분해하여 {material} {count}개를 얻었습니다. 주문 제작용 재료입니다.',
  'hudChrome.bags.disenchantNotEligible': '그 아이템은 분해할 수 없습니다.',
  'hudChrome.bags.disenchantFailed': '분해하려던 아이템을 더 이상 가지고 있지 않습니다.',
  ...
  'entities.items.arcane_bound_cloth.name': '비전 결속의 천',
  'entities.items.arcane_bound_hide.name': '비전 결속의 가죽',
  'entities.items.arcane_bound_chain.name': '비전 결속의 사슬',
  'entities.items.arcane_bound_edge.name': '비전 결속의 칼날',
  'entities.items.arcane_bound_focus.name': '비전 결속의 매개체',
  'entities.items.arcanists_mantle.name': '비전술사의 망토',
  'entities.items.wyrmstalkers_hide.name': '웜스토커의 가죽',
  'entities.items.ironbound_hauberk.name': '강철결속 하버크',
  'entities.items.edgebound_greatblade.name': '칼날결속 대검',
  'entities.items.focusbound_channeler.name': '매개결속 채널러',
