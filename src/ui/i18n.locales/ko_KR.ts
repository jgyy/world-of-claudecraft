...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wheel.title': '전문직 수레바퀴',
  'hudChrome.wheel.close': '전문직 수레바퀴 닫기',
  'hudChrome.wheel.archetypeLabel': '원형',
  'hudChrome.wheel.hobbyLabel': '취미',
  'hudChrome.wheel.dormantLabel': '휴면',
  'hudChrome.wheel.amends': '배상 진행도: {progress}/{required}',
  'hudChrome.wheel.craftTier': '{craft}: {tier}',
  'hudChrome.wheel.armorcrafting': '방어구 제작',
  'hudChrome.wheel.weaponcrafting': '무기 제작',
  'hudChrome.wheel.jewelcrafting': '보석 세공',
  'hudChrome.wheel.alchemy': '연금술',
  'hudChrome.wheel.engineering': '공학',
  'hudChrome.wheel.cooking': '요리',
  'hudChrome.wheel.inscription': '주문각인',
  'hudChrome.wheel.enchanting': '마법부여',
  'hudChrome.wheel.tailoring': '재봉',
  'hudChrome.wheel.leatherworking': '가죽 세공',
