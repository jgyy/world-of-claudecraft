...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.crystal_shard.name': '반짝이는 수정 조각',
  ...
  'entities.mobs.glimmervein_spider.name': '글리머베인 수정 거미',
  'entities.mobs.glimmervein_bat.name': '글리머베인 동굴박쥐',
  ...
  'entities.mobs.glimmervein_broodling.name': '글리머베인 새끼거미',
  ...
  'entities.zones.mirefen_marsh.pois.8.label': '글리머베인 동굴',
  ...
  'entities.zones.eastbrook_vale.pois.10.label': '글리머베인 동굴',
