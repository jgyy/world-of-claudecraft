...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'classDetails.lore.card_adept':
    '卡牌贤者操控一副洗好的充能卡牌，消耗专注打出从不断循环的手牌中抽取的伤害、治疗与护盾卡牌。',
