...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'crucibleShop.tradeSectionTitle': '交换印记',
  'crucibleShop.tradeAria': '用{from}交换{to}',
  'crucibleShop.tradeHint': '点击交换',
  'crucibleShop.tradeConfirmTitle': '确认交换',
  'crucibleShop.tradeConfirmBody': '用你的{from}交换{to}？消耗的印记无法退还。',
  'crucibleShop.tradeConfirmAccept': '交换',
  'crucibleShop.tradeConfirmCancel': '取消',
