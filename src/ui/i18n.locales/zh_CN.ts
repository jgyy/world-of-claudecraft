...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.flightmaster_eastbrook.name': '雯·霍利斯',
  'entities.npcs.flightmaster_eastbrook.title': '飞行管理员',
  'entities.npcs.flightmaster_eastbrook.greeting': '狮鹫已经歇够了，天也晴了，{className}。去哪儿？',
  'entities.npcs.flightmaster_fenbridge.name': '奥多·沼威克',
  'entities.npcs.flightmaster_fenbridge.title': '飞行管理员',
  'entities.npcs.flightmaster_fenbridge.greeting': '起飞时留神芦苇。说个镇名，我们送你过去。',
  'entities.npcs.flightmaster_highwatch.name': '布拉姆·荆崖',
  'entities.npcs.flightmaster_highwatch.title': '飞行管理员',
  'entities.npcs.flightmaster_highwatch.greeting': '空气稀薄，视野辽阔。这些鸟认得群峰里的每一道山口。',
  'entities.npcs.flightmaster_eldergleam.name': '席尔凡·暮守',
  'entities.npcs.flightmaster_eldergleam.title': '飞行管理员',
  'entities.npcs.flightmaster_eldergleam.greeting': '从高处看，幽谷温柔多了。选个落脚点吧。',
  'entities.npcs.flightmaster_wyrmwatch.name': '卡斯克·余烬皮',
  'entities.npcs.flightmaster_wyrmwatch.title': '飞行管理员',
  'entities.npcs.flightmaster_wyrmwatch.greeting': '连巨龙都会绕开我的鸟。要塞派你去哪儿？',
  'entities.npcs.flightmaster_icemantle.name': '希尔德·霜幔',
  'entities.npcs.flightmaster_icemantle.title': '飞行管理员',
  'entities.npcs.flightmaster_icemantle.greeting': '裹紧些。冰川上的风刺骨，不过飞得很快。',
  'entities.npcs.flightmaster_lanternmere.name': '芬尼克·琥珀风',
  'entities.npcs.flightmaster_lanternmere.title': '飞行管理员',
  'entities.npcs.flightmaster_lanternmere.greeting': '夜航的灯笼已经点亮。选个目的地吧。',
  'entities.npcs.flightmaster_bridgemere.name': '塔姆辛·苇匠',
  'entities.npcs.flightmaster_bridgemere.title': '飞行管理员',
  'entities.npcs.flightmaster_bridgemere.greeting': '从桥头飞往沼泽允许的任何地方。去哪儿，{className}？',
  'entities.npcs.flightmaster_moonrest.name': '埃洛温·夜歌',
  'entities.npcs.flightmaster_moonrest.title': '飞行管理员',
  'entities.npcs.flightmaster_moonrest.greeting': '飞蛾会引夜鸟回家。说个地方，我们就飞。',
  'entities.npcs.flightmaster_gallowmere.name': '科尔文·墓尽',
  'entities.npcs.flightmaster_gallowmere.title': '飞行管理员',
  'entities.npcs.flightmaster_gallowmere.greeting': '这里的天空没有什么在作祟。暂时没有。说出你的镇子。',
  'entities.npcs.flightmaster_drifthaven.name': '妮娅·盐风',
  'entities.npcs.flightmaster_drifthaven.title': '飞行管理员',
  'entities.npcs.flightmaster_drifthaven.greeting': '浅滩上的暖风托得鸟儿很轻。你要去哪儿？',
  'entities.npcs.flightmaster_hedgewick.name': '皮普·绿荫',
  'entities.npcs.flightmaster_hedgewick.title': '飞行管理员',
  'entities.npcs.flightmaster_hedgewick.greeting': '越过树篱，掠过果园。去哪儿好呢？',
  'entities.npcs.flightmaster_wickharbor.name': '马洛·风之子',
  'entities.npcs.flightmaster_wickharbor.title': '飞行管理员',
  'entities.npcs.flightmaster_wickharbor.greeting': '今天港口的风很稳。选个落脚点。',
  'entities.npcs.flightmaster_gullhaven.name': '萨宾·鸥翼',
  'entities.npcs.flightmaster_gullhaven.title': '飞行管理员',
  'entities.npcs.flightmaster_gullhaven.greeting': '海鸥讨厌我的鸟。鸟儿才不在乎。去哪儿？',
  ...
  'hudChrome.flight.title': '飞行路线',
  'hudChrome.flight.gossipOption': '乘坐飞行',
  'hudChrome.flight.gossipOptionAria': '与{name}一起乘坐飞行',
  'hudChrome.flight.rowAria': '飞往{town}，{hops}段航程，{fare}',
  'hudChrome.flight.hops': '{count}段航程',
  'hudChrome.flight.fare': '费用：{fare}',
  'hudChrome.flight.empty': '你还不认识其他飞行路线。去别的城镇找飞行管理员交谈，以学会那里的航线。',
  'hudChrome.flight.close': '关闭飞行路线',
};
