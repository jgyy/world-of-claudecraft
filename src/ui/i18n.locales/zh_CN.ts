...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.riftForge.upgradeBtn': '强化（{cost} 精华）',
  'hudChrome.riftForge.upgradeMax': '已强化至满级',
  'hudChrome.riftForge.enchantCurrent': '附魔：+{value} {stat}',
  'hudChrome.riftForge.enchantNone': '附魔：无',
  'hudChrome.riftForge.enchantBtn': '附魔（{cost} 精华）',
  'hudChrome.riftForge.statPickAria': '要附魔的属性',
  'hudChrome.riftForge.gemPickAria': '要镶嵌的宝石',
  'hudChrome.riftForge.socketBtn': '镶嵌',
  'hudChrome.riftForge.socketsNone': '没有宝石',
  'hudChrome.riftForge.socketsFull': '所有插槽已填满',
  ...
  'hudChrome.riftForge.reason.invalidStat': '那项属性无法在此附魔。',
  'hudChrome.riftForge.reason.invalidGem': '你没有那种裂隙宝石。',
  'hudChrome.riftForge.reason.socketsFull': '那枚戒指的插槽都已填满。',
  ...
  'hudChrome.riftForge.done.enchant': '已为{name}附魔。',
  ...
  'guide.riftsPage.forgeBody':
    '首次通关排位裂隙铸造的戒指，在你拿到手时还没有完工。裂隙锻匠梅莉丝在远滩的守望草甸、沿岸上行离开鸥港后的破裂学者身旁守着一座熔炉，她会一步步强化戒指、为它附上一道附魔，并把裂隙掉落的彩色宝石镶进插槽。这一切都以裂隙精华和裂隙宝石支付，它们是裂隙首领掉落、可自由交易的熔炉货币，所以缺的精华可以请朋友递给你。带去之前先把戒指卸下：她只处理背包里的东西，而且除非你站在她的熔炉旁，否则她什么都不会做。',
