...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'game.honing.title': '淬炼',
  'game.honing.unspent': '未使用的虚拟等级',
  'game.honing.item': '物品',
  'game.honing.stat': '属性',
  'game.honing.cost': '费用',
  'game.honing.chance': '成功率',
  'game.honing.action': '淬炼',
  'game.honing.rank': '淬炼 +{rank}',
  'game.honing.maxed': '已淬炼至满级',
  'game.honing.nothingWorn': '未装备任何物品',
  'game.honing.needCap': '达到等级上限后才能淬炼装备。',
  'game.honing.hint': '每一级为所选属性 +1。淬炼会将物品绑定给你，失败的尝试同样会消耗等级和金币。',
  'game.honing.hintReset': '失败的尝试还会清除物品上的全部淬炼等级。',
  ...
  'hudChrome.plurals.honingLevels.one': '{count} 个虚拟等级',
  'hudChrome.plurals.honingLevels.few': '{count} 个虚拟等级',
  'hudChrome.plurals.honingLevels.many': '{count} 个虚拟等级',
  'hudChrome.plurals.honingLevels.other': '{count} 个虚拟等级',
  ...
  'hudChrome.itemTooltip.honedBadge': '淬炼 +{rank}',
