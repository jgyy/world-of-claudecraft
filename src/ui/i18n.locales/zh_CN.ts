...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.arcane_bound_cloth.name': '秘法束缚布',
  'entities.items.arcane_bound_hide.name': '秘法束缚兽皮',
  'entities.items.arcane_bound_chain.name': '秘法束缚锁链',
  'entities.items.arcane_bound_edge.name': '秘法束缚锋刃',
  'entities.items.arcane_bound_focus.name': '秘法束缚法器',
  'entities.items.arcanists_mantle.name': '秘法者斗篷',
  'entities.items.wyrmstalkers_hide.name': '潜龙者兽皮',
  'entities.items.ironbound_hauberk.name': '铁束胸甲',
  'entities.items.edgebound_greatblade.name': '锋束巨剑',
  'entities.items.focusbound_channeler.name': '法束引导者',
