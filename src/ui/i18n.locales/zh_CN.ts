...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  // Profession Schools board (M16 non-Latin fills added with the keys).
  'hudChrome.school.openButton': '学派',
  'hudChrome.school.openButtonAria': '打开职业学派面板',
  'hudChrome.school.title': '职业学派',
  'hudChrome.school.close': '关闭职业学派',
  'hudChrome.school.intro': '加入一个职业学派，完成其轮换任务以获取晋阶点数。',
  'hudChrome.school.name.enchantersSchool': '附魔师学派',
  'hudChrome.school.rank.enchantersSchool.initiate': '初学者',
  'hudChrome.school.rank.enchantersSchool.apprentice': '学徒',
  'hudChrome.school.rank.enchantersSchool.journeyman': '熟练工',
  'hudChrome.school.rank.enchantersSchool.adept': '精通者',
  'hudChrome.school.rank.enchantersSchool.master': '大师',
  'hudChrome.school.rank.enchantersSchool.grandmaster': '宗师',
  'hudChrome.school.taskKind.daily': '每日委托',
  'hudChrome.school.taskKind.contract': '委托',
  'hudChrome.school.taskKind.materials': '材料委托',
  'hudChrome.school.taskKind.weeklyGroup': '每周组队委托',
  'hudChrome.school.rankLine': '{rank}，{points}点',
  'hudChrome.school.nextRankLine': '{points} / {nextPoints}点晋升下一阶',
  'hudChrome.school.swearToProgress': '宣誓效忠以继续晋升。',
  'hudChrome.school.qualifyHint': '需要{skill}点{profession}技能（你目前拥有{current}点）。',
  'hudChrome.school.swearButton': '宣誓效忠',
  'hudChrome.school.swornBadge': '已宣誓',
  'hudChrome.school.taskPoints': '{points}点',
  'hudChrome.school.submitButton': '提交',
  'hudChrome.school.readyIn': '{duration}后可用',
  'hudChrome.school.taskSubmitted': '你为{school}完成了一项任务（+{points}点）。',
  'hudChrome.school.denyUnknownTask': '该任务已不存在。',
  'hudChrome.school.denyNotAMember': '你不是{school}的成员。',
  'hudChrome.school.denyOutOfRange': '你必须靠近学派导师才能提交任务。',
  'hudChrome.school.denyOnCooldown': '该任务尚未就绪。',
  'hudChrome.school.denyPartyRequired': '该任务需要组队。',
  'hudChrome.school.denyInsufficientMaterials': '你没有该任务所需的材料。',
  ...
  'guide.professions.schoolsHeading': '职业学派',
  'guide.professions.schoolsBody':
    '一门手艺可以从轮环之上成长为独立的机构：一所实体学派扎根于某位大师的工作站，向证明了自身技艺的人敞开大门，并设有一套可以通过持续参与学派事务来攀登的军衔阶梯。附魔是第一个建成的学派。',
  'guide.professions.schoolCraftFmt': '一所按军衔分级的{craft}机构，扎根于{hub}。',
