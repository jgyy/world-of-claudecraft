...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bank.accountTab': '账号',
  'hudChrome.bank.accountEmpty': '账号银行是空的。',
  'hudChrome.bank.accountBuyConfirm': '花费 {price} 购买 {count} 个额外的账号银行格子吗？',
  'hudChrome.bank.accountDepositHint': '点击存入账号银行',
  'hudChrome.bank.accountCannotDeposit': '无法放入账号银行',
