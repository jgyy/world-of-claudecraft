...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.trade.cancel': '取消',
  'hud.cardHand.label': '手牌',
  'hud.cardHand.discardTitle': '弃牌堆',
  'hud.cardDuel.close': '关闭卡牌决斗',
  'hud.cardDuel.notEligible': '只有卡牌行家才能排队进行卡牌决斗。',
  'hud.cardDuel.enterQueue': '加入队列',
  'hud.cardDuel.leaveQueue': '离开队列',
  'hud.cardDuel.searching': '正在寻找对手...（队列中 {count} 人）',
  'hud.cardDuel.queueNote': '一场 1v1 卡牌行家决斗，你将与下一位排队的对手匹配。',
  ...
  'classes.card_adept': '卡牌贤者',
  'classes.card_adeptAria': '卡牌贤者职业',
  'classDetails.roles.card_adept': '远程输出',
  'classDetails.lore.card_adept': '卡牌贤者操控一副洗好的充能卡牌，消耗专注打出从不断循环的手牌中抽取的伤害、治疗与护盾卡牌。',
  'guide.abilityHook.ca_quickstrike': '一张廉价的充能卡牌，快速甩向敌人造成奥术伤害。',
  'guide.abilityHook.ca_arcane_bolt': '你可靠的远程卡牌，一道扎实的奥术之力箭。',
  'guide.abilityHook.ca_flame_fan': '扇出一片燃烧的卡牌，造成一次打击并附加持续灼烧。',
  'guide.abilityHook.ca_mending_card': '打出一张恢复卡牌，治疗你自己或盟友。',
  'guide.abilityHook.ca_warding_card': '一张快速的自我护盾卡牌，短时间内提升护甲。',
  'guide.abilityHook.ca_hex_card': '掷出一张妖术卡牌，减速目标使其无法追击。',
  'guide.abilityHook.ca_empower_card': '从牌堆汲取力量，在大招之前提升你的智力。',
  'guide.abilityHook.ca_royal_flush': '你的终结技，一手同花大顺释放沉重的火焰伤害。',
  'entities.abilities.ca_quickstrike.name': '疾击牌',
  'entities.abilities.ca_quickstrike.description': '将一张充能卡牌甩向目标，造成 {damage} 点奥术伤害。',
  'entities.abilities.ca_arcane_bolt.name': '奥术箭牌',
  'entities.abilities.ca_arcane_bolt.description': '射出一道奥术之力箭，造成 {damage} 点伤害。',
  'entities.abilities.ca_flame_fan.name': '火焰扇牌',
  'entities.abilities.ca_flame_fan.description': '扇出一片燃烧的卡牌，造成 {damage} 点火焰伤害并附加灼烧。',
  'entities.abilities.ca_mending_card.name': '愈合牌',
  'entities.abilities.ca_mending_card.description': '打出一张恢复卡牌，为友方目标治疗 {damage} 点生命。',
  'entities.abilities.ca_warding_card.name': '守护牌',
  'entities.abilities.ca_warding_card.description': '以一张守护卡牌环绕自身，护甲提升 {buff}，持续 30 秒。',
  'entities.abilities.ca_hex_card.description': '打出一张妖术卡牌，使目标减速，持续 6 秒。',
  'entities.abilities.ca_empower_card.name': '强化牌',
  'entities.abilities.ca_empower_card.description': '从牌堆汲取力量，智力提升 {buff}%，持续 1 分钟。',
  'entities.abilities.ca_royal_flush.name': '同花顺牌',
  'entities.abilities.ca_royal_flush.description': '释放一手同花大顺，造成 {damage} 点火焰伤害。',
};
