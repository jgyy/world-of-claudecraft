...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.thornpeak_heights.pois.10.label': '龙门路碑',
  ...
  'entities.npcs.waystone_warden_ilse.greeting': '五十银币，龙门便送你去高望。比骑龙便宜，比你的双腿金贵。',
  'entities.npcs.waystone_warden_ilse.name': '路碑守卫伊尔莎',
  'entities.npcs.waystone_warden_ilse.title': '龙门守护者',
  'entities.npcs.provisioner_dunmore.greeting': '山羊烤好了，水是凉的，巨魔这周还没烧掉仓库。趁着还能买，赶紧买吧。',
  'entities.npcs.provisioner_dunmore.name': '军需官邓莫尔',
  'entities.npcs.provisioner_dunmore.title': '最后的堡垒随军商贩',
  'entities.npcs.sergeant_varga.greeting': '守过这座堡垒的驻军再没回来。如今我们替他们守着。当心东墙的缺口。',
  'entities.npcs.sergeant_varga.name': '中士瓦尔加',
  'entities.npcs.sergeant_varga.title': '外院守卫',
  'entities.npcs.chaplain_ondrey.greeting': '最后之泉仍在这些墙边流淌，无论锻造之父从中偷走了什么。坐一会儿吧。厅堂寂静，却并不空荡。',
  'entities.npcs.chaplain_ondrey.name': '牧师安德烈',
  'entities.npcs.chaplain_ondrey.title': '寂静厅堂之声',
  'entities.npcs.paymaster_edda_thorne.greeting': '守备队的军饷箱熬过了巨龙，你的钱也会平安无事。存入、支取，或再买一层货架；金库已开放。',
  'entities.npcs.paymaster_edda_thorne.name': '军需官埃达·索恩',
  'entities.npcs.paymaster_edda_thorne.title': '金库守护者',
  'entities.npcs.auctioneer_bram_kestrel.greeting': '世界市场的触角连这里都够得着，{className}。竞拍全境的货物，或者把你从沙丘里带回的战利品挂上去。',
  'entities.npcs.auctioneer_bram_kestrel.name': '拍卖师布拉姆·凯斯特雷尔',
  'entities.npcs.auctioneer_bram_kestrel.title': '世界市场之声',
  'entities.npcs.armorer_tam_rusk.greeting': '巨龙能砸裂盾牌，巨魔能磨钝刀刃。不管沙丘夺走了你什么，锻炉都有替换的。',
  'entities.npcs.armorer_tam_rusk.name': '军械师塔姆·拉斯克',
  'entities.npcs.armorer_tam_rusk.title': '要塞军械师',
