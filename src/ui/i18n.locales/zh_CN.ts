...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.soulKey.unboundLine': '灵魂之钥已解除绑定',
  'hudChrome.soulKey.menuAction': '用灵魂之钥解除绑定',
  'hudChrome.soulKey.confirmTitle': '解除灵魂绑定',
  ...
  'hudChrome.soulKey.noneHeld': '你没有灵魂之钥。',
  'hudChrome.soulKey.weeklyCap': '该角色本周的灵魂之钥解除次数已用尽。',
  'guide.gear.soulKeyBody': '灵魂绑定的装备并非永远绑定。高望镇的军需官布蕾以金币出售灵魂之钥，对背包中一件已绑定的装备使用一把，即可永久解除其绑定：从那时起，它可以像其他物品一样交易、邮寄、出售和上架，无论落在谁的手中。每个角色每次周重置最多可解除两次绑定，所以钥匙是为了那件掉给错误专精的装备，或公会成员需要的备用件，而不是把装备在你所有角色之间轮转的手段。',
  'guide.gear.heroicUpgradeBody': '英雄军需官维克斯还能以二十枚英雄徽记将一件熔炉套装部件锻造为英雄形态。英雄部件保留套装加成和职业限制，物品等级和主属性提升，并且不再绑定，因此可以像其他战利品一样易手。',
  'heroicShop.upgradeTitle': '英雄升级',
  'heroicShop.upgradeIntro': '以{marks}枚英雄徽记将一件熔炉套装部件锻造为英雄形态：实力更上一层，且不再绑定。',
  'heroicShop.upgradeEmpty': '你没有可升级的熔炉套装部件。',
  'heroicShop.upgradeAria': '以{marks}枚英雄徽记将{item}升级为英雄',
  'heroicShop.upgradeConfirmTitle': '确认英雄升级',
  'heroicShop.upgradeConfirmBody': '以{marks}枚英雄徽记将{item}升级为英雄形态？用于升级的徽记无法退还。',
  'heroicShop.upgradeConfirmAccept': '升级',
  'heroicShop.upgraded': '{item}已被锻造为英雄形态。',
  'heroicShop.upgradeNotEligible': '该物品无法升级。',
  'heroicShop.upgradeOutOfRange': '你必须在英雄军需官处才能升级。',
  'heroicShop.upgradeNotEnoughMarks': '升级需要{marks}枚英雄徽记。',
};
