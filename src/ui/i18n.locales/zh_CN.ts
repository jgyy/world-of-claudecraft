...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.worldPage.intro': 'World of ClaudeCraft 是一片你要靠双脚走遍的连续大陆。古道自南向北穿过起始山谷、沼泽和山峰，并越过它们继续攀升，通向其后的洼地以及地图顶端的雪境。自那条路向西展开一列更高等级的国度，向东另有一列，谷地东岸外还有一座岛屿。抵达本身就是冒险的一部分：每一段路程都靠步行或骑乘完成，每座中心城镇的路石都能瞬间把你送到你已经触碰过的任何其他路石那里。\n\n这片大地也记录着时间。昼夜循环依照一只你所在世界人人共享的真实时钟运转，因此天空会为你们所有人同时从黎明经正午走向黄昏与夜色，月亮循着盈亏来去，地面上的光影也随之变化。小地图周围的表盘，就是你读取时辰的地方。',
  ...
  'guide.worldPage.travelBody':
    '王国里的每一条路，都得靠走或者骑，地图是一整块相连的陆地：每一处连接都是你可以踩上去的东西。路石能帮你找到回去的路。每座中心城镇都守着一座路石，旁边有一位守护者，你只要徒步触碰过一座城镇的路石，就能付费从你所知道的任何其他路石瞬间传送到那里。费用随距离增加，从每日地下城队列中获得的路石凭证可以用一次传送抵替金币，而公会的声望会从价格中扣去一部分。学会了大传送术的法师，能打开一道传送门，把队伍带到旧路四座城市中的一座；走过地狱之门契约的术士，则能撕开一道门，把队伍成员拉到自己身边。山脊把一片土地与下一片隔开，两地共享一道山脊时，道路便会翻过一处山口。不过并非每一处边界都是这样。北面有一条长长的堤道，载着道路从帷幕幽谷跨过水面，通往更北的雪国；而回到南边，有一道细细的天然沙洲，名叫沙洲堤道，自东溪谷海岸向东延伸，直抵远岸岛上的登岸口，那座岛根本没有陆上边界。整个地表世界里恰好只有一道真正的门户：荆峰高处的一层暮色之幕，通往帷幕幽谷。幽谷的南侧山脊被封死，没有山口可以穿过，所以那层幕正是你最初进去的方式，而回程时它会在你身后合上。\n\n无论你倒在哪里，走回来的路都不长。每一片区域至少有一座墓地，一位灵魂医者悬在墓碑上方，释放出的灵魂会在最近的那一座升起。\n\n地图不会终结于一堵看不见的墙。陆地会一路铺展成海滩与岬角，然后没入开阔的水面。世界本就打算让你游过去的那些地方，也就是两片土地之间的海峡与湖泊，都平静而安全。若你偏要向外海进发，距离本身会把你劝回来：你会被警告一次，再警告一次，而如果你还继续游，大海就会把你耗到死。下潜也有它自己的限度，因为你的气在水下会用尽，所以水一提醒你，就浮上来换口气、掉头回去吧。',
  ...
  'entities.npcs.waystone_keeper_eastbrook.name': '雯·霍利斯',
  'entities.npcs.waystone_keeper_eastbrook.title': '路石守护者',
  'entities.npcs.waystone_keeper_eastbrook.greeting': '石头正为你嗡鸣，{className}。触碰一次，它就永远记得你的名字。',
  'entities.npcs.waystone_keeper_fenbridge.name': '奥多·沼威克',
  'entities.npcs.waystone_keeper_fenbridge.title': '路石守护者',
  'entities.npcs.waystone_keeper_fenbridge.greeting': '当心石头上的苔藓。说个镇名，你就已经站在那儿了。',
  'entities.npcs.waystone_keeper_highwatch.name': '布拉姆·荆崖',
  'entities.npcs.waystone_keeper_highwatch.title': '路石守护者',
  'entities.npcs.waystone_keeper_highwatch.greeting': '空气稀薄，道路却快。石头记得你踏过的每一座山峰。',
  'entities.npcs.waystone_keeper_eldergleam.name': '席尔凡·暮守',
  'entities.npcs.waystone_keeper_eldergleam.title': '路石守护者',
  'entities.npcs.waystone_keeper_eldergleam.greeting': '幽谷把石头藏在枝叶之下。选个你更想去的地方吧。',
  'entities.npcs.waystone_keeper_wyrmwatch.name': '卡斯克·余烬皮',
  'entities.npcs.waystone_keeper_wyrmwatch.title': '路石守护者',
  'entities.npcs.waystone_keeper_wyrmwatch.greeting': '连巨龙都不碰这块石头。要塞派你去哪儿？',
  'entities.npcs.waystone_keeper_icemantle.name': '希尔德·霜幔',
  'entities.npcs.waystone_keeper_icemantle.title': '路石守护者',
  'entities.npcs.waystone_keeper_icemantle.greeting': '这块石头摸起来是暖的，是冰川上唯一暖和的东西。去哪儿？',
  'entities.npcs.waystone_keeper_lanternmere.name': '芬尼克·琥珀风',
  'entities.npcs.waystone_keeper_lanternmere.title': '路石守护者',
  'entities.npcs.waystone_keeper_lanternmere.greeting': '今晚石头周围的灯笼已经点亮。选个目的地吧。',
  'entities.npcs.waystone_keeper_bridgemere.name': '塔姆辛·苇匠',
  'entities.npcs.waystone_keeper_bridgemere.title': '路石守护者',
  'entities.npcs.waystone_keeper_bridgemere.greeting': '从桥头的石头到你知道的任何一块石头。去哪儿，{className}？',
  'entities.npcs.waystone_keeper_moonrest.name': '埃洛温·夜歌',
  'entities.npcs.waystone_keeper_moonrest.title': '路石守护者',
  'entities.npcs.waystone_keeper_moonrest.greeting': '飞蛾在黄昏时绕着石头飞舞。说个地方，你就到了那儿。',
  'entities.npcs.waystone_keeper_gallowmere.name': '科尔文·墓尽',
  'entities.npcs.waystone_keeper_gallowmere.title': '路石守护者',
  'entities.npcs.waystone_keeper_gallowmere.greeting': '这块石头还没有什么在作祟。暂时没有。说出你的镇子。',
  'entities.npcs.waystone_keeper_drifthaven.name': '妮娅·盐风',
  'entities.npcs.waystone_keeper_drifthaven.title': '路石守护者',
  'entities.npcs.waystone_keeper_drifthaven.greeting': '盐分丝毫没有磨钝这块石头。你要去哪儿？',
  'entities.npcs.waystone_keeper_hedgewick.name': '皮普·绿荫',
  'entities.npcs.waystone_keeper_hedgewick.title': '路石守护者',
  'entities.npcs.waystone_keeper_hedgewick.greeting': '石头就立在树篱与果园之间。去哪儿好呢？',
  'entities.npcs.waystone_keeper_wickharbor.name': '马洛·风之子',
  'entities.npcs.waystone_keeper_wickharbor.title': '路石守护者',
  'entities.npcs.waystone_keeper_wickharbor.greeting': '不管风怎么吹，港口的石头都很稳。选个落脚点。',
  'entities.npcs.waystone_keeper_gullhaven.name': '萨宾·鸥翼',
  'entities.npcs.waystone_keeper_gullhaven.title': '路石守护者',
  'entities.npcs.waystone_keeper_gullhaven.greeting': '海鸥栖在这块石头上。石头毫不在意。去哪儿？',
  ...
  'entities.quests.q_hellgate_pact.completion':
    '骸骨已归于平静，而你还站着。很好。契约的下一段文字被一个守口如瓶的斥候带去了北边的沼泽。去芬桥找玛伦斥候。',
  'entities.quests.q_hellgate_pact.objectives.0.label': '不宁骸骨已安息',
  'entities.quests.q_hellgate_rite.title': '唤墓者的仪式',
  'entities.quests.q_hellgate_rite.text':
    '是林派你来的？那你已经知道，唤墓者唤起溺亡者不是为了作伴。他们的教徒吟诵一种能撕薄帷幕的仪式，正是契约需要的那种。让6个唤墓者教徒闭嘴，并在他们倒下前听清他们说了什么。',
  'entities.quests.q_hellgate_rite.completion':
    '这么说你也听见了：门会回应为它流血的人。高望有位博学者掌握着最后的部分，他不会乐意被人问起。去找凯迪斯博学者。',
  'entities.quests.q_hellgate_rite.objectives.0.label': '唤墓者教徒已被肃清',
  'entities.quests.q_hellgate_gate.title': '地狱之门',
  'entities.quests.q_hellgate_gate.text':
    '这下玛伦把沼泽都送到我门口了。好吧，{playerName}。契约写在页岩里：行走于群峰的骨甲亡魂是最后一批撑开过门的人，他们为此付出了鲜血。击碎5个骨甲亡魂，山会把咒文给你。',
  'entities.quests.q_hellgate_gate.completion':
    '咒文归你了。记住它让骨甲亡魂付出了什么：地狱之门每开一秒，都在吞噬开门的人。为你的朋友使用它，并在它吞掉你之前把它关上。',
  'entities.quests.q_hellgate_gate.objectives.0.label': '骨甲亡魂已被击碎',
  'entities.items.rune_of_passage.name': '通行符文',
  'entities.items.tome_grand_teleport_eastbrook.name': '通行之书：东溪',
  'entities.items.tome_grand_teleport_fenbridge.name': '通行之书：芬桥',
  'entities.items.tome_grand_teleport_highwatch.name': '通行之书：高望',
  'entities.items.tome_grand_teleport_eldergleam.name': '通行之书：古辉镇',
  'entities.abilities.grand_teleport_eastbrook.name': '宏大传送：东溪',
  'entities.abilities.grand_teleport_eastbrook.description':
    '开启一道通往东溪的宏大传送门，持续5分钟。只有施法瞬间处于你队伍中的成员才能穿过。消耗一枚通行符文。施法时间10秒。与其他所有宏大传送共享20分钟冷却时间。',
  'entities.abilities.grand_teleport_fenbridge.name': '宏大传送：芬桥',
  'entities.abilities.grand_teleport_fenbridge.description':
    '开启一道通往芬桥的宏大传送门，持续5分钟。只有施法瞬间处于你队伍中的成员才能穿过。消耗一枚通行符文。施法时间10秒。与其他所有宏大传送共享20分钟冷却时间。',
  'entities.abilities.grand_teleport_highwatch.name': '宏大传送：高望',
  'entities.abilities.grand_teleport_highwatch.description':
    '开启一道通往高望的宏大传送门，持续5分钟。只有施法瞬间处于你队伍中的成员才能穿过。消耗一枚通行符文。施法时间10秒。与其他所有宏大传送共享20分钟冷却时间。',
  'entities.abilities.grand_teleport_eldergleam.name': '宏大传送：古辉镇',
  'entities.abilities.grand_teleport_eldergleam.description':
    '开启一道通往古辉镇的宏大传送门，持续5分钟。只有施法瞬间处于你队伍中的成员才能穿过。消耗一枚通行符文。施法时间10秒。与其他所有宏大传送共享20分钟冷却时间。',
  'entities.abilities.hellgate.name': '地狱之门',
  'entities.abilities.hellgate.description':
    '在你脚下撕开一道地狱之门，持续99秒。选中队伍成员后点击门，即可将其拉到门前。门存在期间，门后的恶魔每秒使你流失最大生命值的1%，并阻止你的生命值回复。施法时间10秒。',
  'hudChrome.waystone.title': '路石',
  'hudChrome.waystone.gossipOption': '使用路石',
  'hudChrome.waystone.gossipOptionAria': '与{name}一起使用路石',
  'hudChrome.waystone.rowAria': '传送至{town}，{distance}码，{price}',
  'hudChrome.waystone.distance': '{distance}码',
  'hudChrome.waystone.fee': '费用：{fee}',
  'hudChrome.waystone.ticketPrice': '1张凭证',
  'hudChrome.waystone.tickets': '路石凭证：{count}',
  'hudChrome.waystone.guildDiscount': '公会折扣：{pct}%',
  'hudChrome.waystone.empty': '你还未与其他路石调谐。触碰另一座城镇的路石即可调谐。',
  'hudChrome.waystone.close': '关闭路石',
};
