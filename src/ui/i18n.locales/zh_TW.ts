...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bank.accountTab': '帳號',
  'hudChrome.bank.accountEmpty': '帳號銀行是空的。',
  'hudChrome.bank.accountBuyConfirm': '花費 {price} 購買 {count} 個額外的帳號銀行格子嗎？',
  'hudChrome.bank.accountDepositHint': '點擊存入帳號銀行',
  'hudChrome.bank.accountCannotDeposit': '無法放入帳號銀行',
