...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.soulKey.unboundLine': '靈魂之鑰已解除綁定',
  'hudChrome.soulKey.menuAction': '用靈魂之鑰解除綁定',
  'hudChrome.soulKey.confirmTitle': '解除靈魂綁定',
  ...
  'hudChrome.soulKey.noneHeld': '你沒有靈魂之鑰。',
  'hudChrome.soulKey.weeklyCap': '該角色本週的靈魂之鑰解除次數已用盡。',
  'guide.gear.soulKeyBody': '靈魂綁定的裝備並非永遠綁定。高望鎮的軍需官布蕾以金幣出售靈魂之鑰，對背包中一件已綁定的裝備使用一把，即可永久解除其綁定：從那時起，它可以像其他物品一樣交易、郵寄、出售和上架，無論落在誰的手中。每個角色每次週重置最多可解除兩次綁定，所以鑰匙是為了那件掉給錯誤專精的裝備，或公會成員需要的備用件，而不是把裝備在你所有角色之間輪轉的手段。',
  'guide.gear.heroicUpgradeBody': '英雄軍需官維克斯還能以二十枚英雄徽記將一件熔爐套裝部件鍛造為英雄形態。英雄部件保留套裝加成和職業限制，物品等級和主屬性提升，並且不再綁定，因此可以像其他戰利品一樣易手。',
  'heroicShop.upgradeTitle': '英雄升級',
  'heroicShop.upgradeIntro': '以{marks}枚英雄徽記將一件熔爐套裝部件鍛造為英雄形態：實力更上一層，且不再綁定。',
  'heroicShop.upgradeEmpty': '你沒有可升級的熔爐套裝部件。',
  'heroicShop.upgradeAria': '以{marks}枚英雄徽記將{item}升級為英雄',
  'heroicShop.upgradeConfirmTitle': '確認英雄升級',
  'heroicShop.upgradeConfirmBody': '以{marks}枚英雄徽記將{item}升級為英雄形態？用於升級的徽記無法退還。',
  'heroicShop.upgradeConfirmAccept': '升級',
  'heroicShop.upgraded': '{item}已被鍛造為英雄形態。',
  'heroicShop.upgradeNotEligible': '該物品無法升級。',
  'heroicShop.upgradeOutOfRange': '你必須在英雄軍需官處才能升級。',
  'heroicShop.upgradeNotEnoughMarks': '升級需要{marks}枚英雄徽記。',
};
