...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "hudChrome.account.open": "帳號",
  "hudChrome.account.openAria": "開啟帳號設定",
  "hudChrome.account.title": "帳號設定",
  "hudChrome.account.close": "關閉",
  "hudChrome.account.closeAria": "關閉帳號設定",
  "hudChrome.account.working": "處理中…",
  "hudChrome.account.infoHeading": "帳號",
  "hudChrome.account.usernameLabel": "使用者名稱",
  "hudChrome.account.emailInfoLabel": "電子郵件",
  "hudChrome.account.emailNone": "未設定",
  "hudChrome.account.memberSince": "註冊時間",
  "hudChrome.account.lastLogin": "上次登入",
  "hudChrome.account.lastLoginNever": "從未",
  "hudChrome.account.charactersLabel": "角色",
  "hudChrome.account.emailHeading": "聯絡電子郵件",
  "hudChrome.account.emailNote": "選填。用於日後找回帳號——我們目前不會寄送郵件。",
  "hudChrome.account.emailLabel": "電子郵件地址",
  "hudChrome.account.saveEmailBtn": "儲存電子郵件",
  "hudChrome.account.emailSaved": "電子郵件已儲存。",
  "hudChrome.account.emailCleared": "電子郵件已清除。",
  "hudChrome.account.passwordHeading": "變更密碼",
  "hudChrome.account.currentPassword": "目前密碼",
  "hudChrome.account.newPassword": "新密碼",
  "hudChrome.account.confirmNewPassword": "確認新密碼",
  "hudChrome.account.changePasswordBtn": "變更密碼",
  "hudChrome.account.passwordChanged": "密碼已變更。",
  "hudChrome.account.passwordMismatch": "兩次輸入的新密碼不一致。",
  "hudChrome.account.dangerHeading": "停用帳號",
  "hudChrome.account.dangerWarning": "這將停用你的帳號並在所有裝置上登出。你的角色會保留，但你將無法再次登入——如需重新啟用請聯絡客服。",
  "hudChrome.account.deletePasswordLabel": "密碼",
  "hudChrome.account.deleteConfirmLabel": "輸入你的使用者名稱以確認",
  "hudChrome.account.deleteBtn": "停用帳號",
  "hudChrome.account.deleted": "帳號已停用。",
  "hudChrome.account.errIncorrectPassword": "密碼錯誤。",
  "hudChrome.account.errSamePassword": "新密碼必須與目前密碼不同。",
  "hudChrome.account.errInvalidEmail": "請輸入有效的電子郵件地址。",
  "hudChrome.account.errDeleteConfirm": "請準確輸入你的使用者名稱以確認停用。",
  "hudChrome.account.errDeleteOnline": "停用帳號前請先登出所有角色。",
  "hudChrome.account.errDeactivated": "此帳號已被停用。如需重新啟用請聯絡客服。",
  "hudChrome.account.errAccountNotFound": "找不到帳號。",
  "hudChrome.account.errRateLimited": "請求過於頻繁——請稍後再試。",
};
