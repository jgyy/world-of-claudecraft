...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.cardHand.discardTitle': '棄牌堆',
  'hud.cardDuel.close': '關閉卡牌決鬥',
  'hud.cardDuel.notEligible': '只有卡牌行家才能排隊進行卡牌決鬥。',
  'hud.cardDuel.enterQueue': '加入佇列',
  'hud.cardDuel.leaveQueue': '離開佇列',
  'hud.cardDuel.searching': '正在尋找對手...（佇列中 {count} 人）',
  'hud.cardDuel.queueNote': '一場 1v1 卡牌行家決鬥，你將與下一位排隊的對手配對。',
  ...
  'guide.abilityHook.ca_mending_card': '打出一張恢復卡牌，治療你自己或盟友。',
  'guide.abilityHook.ca_warding_card': '一張快速的自我護盾卡牌，短時間內提升護甲。',
  'guide.abilityHook.ca_hex_card': '擲出一張妖術卡牌，減速目標使其無法追擊。',
