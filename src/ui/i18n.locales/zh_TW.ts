...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'crucibleShop.tradeSectionTitle': '交換印記',
  'crucibleShop.tradeAria': '用{from}交換{to}',
  'crucibleShop.tradeHint': '點擊交換',
  'crucibleShop.tradeConfirmTitle': '確認交換',
  'crucibleShop.tradeConfirmBody': '用你的{from}交換{to}？消耗的印記無法退還。',
  'crucibleShop.tradeConfirmAccept': '交換',
