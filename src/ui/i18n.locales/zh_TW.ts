...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'game.honing.title': '淬鍊',
  'game.honing.unspent': '未使用的虛擬等級',
  'game.honing.item': '物品',
  'game.honing.stat': '屬性',
  'game.honing.cost': '費用',
  'game.honing.chance': '成功率',
  'game.honing.action': '淬鍊',
  'game.honing.rank': '淬鍊 +{rank}',
  'game.honing.maxed': '已淬鍊至滿級',
  'game.honing.nothingWorn': '未裝備任何物品',
  'game.honing.needCap': '達到等級上限後才能淬鍊裝備。',
  'game.honing.hint': '每一級為所選屬性 +1。淬鍊會將物品綁定給你，失敗的嘗試同樣會消耗等級與金幣。',
  'game.honing.hintReset': '失敗的嘗試還會清除物品上的全部淬鍊等級。',
  ...
  'hudChrome.plurals.honingLevels.one': '{count} 個虛擬等級',
  'hudChrome.plurals.honingLevels.few': '{count} 個虛擬等級',
  'hudChrome.plurals.honingLevels.many': '{count} 個虛擬等級',
  'hudChrome.plurals.honingLevels.other': '{count} 個虛擬等級',
  ...
  'hudChrome.itemTooltip.honedBadge': '淬鍊 +{rank}',
