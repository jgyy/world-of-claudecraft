...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.worldPage.intro': 'World of ClaudeCraft 是一片你要靠雙腳走遍的連續大陸。古道自南向北穿過起始山谷、沼澤和山峰，並越過它們繼續攀升，通向其後的窪地以及地圖頂端的雪境。自那條路向西展開一列更高等級的國度，向東另有一列，谷地東岸外還有一座島嶼。抵達本身就是冒險的一部分：每一段路程都靠步行或騎乘完成，每座中心城鎮的路石都能瞬間把你送到你已經觸碰過的任何其他路石那裡。\n\n這片大地也記錄著時間。晝夜循環依照一只你所在世界人人共享的真實時鐘運轉，因此天空會為你們所有人同時從黎明經正午走向黃昏與夜色，月亮循著盈虧來去，地面上的光影也隨之變化。小地圖周圍的錶盤，就是你讀取時辰的地方。',
  ...
  'guide.worldPage.travelBody':
    '王國裡的每一條路，都得用走的或用騎的，地圖是一整塊相連的陸地：每一段連結都是你可以踏上去的東西。路石能幫你找到回去的路。每座中心城鎮都守著一座路石，旁邊有一位守護者，你只要徒步觸碰過一座城鎮的路石，就能付費從你所知道的任何其他路石瞬間傳送到那裡。費用隨距離增加，從每日地城佇列中獲得的路石憑證可以用一次傳送抵替金幣，而公會的聲望會從價格中扣去一部分。學會了大傳送術的法師，能打開一道傳送門，把隊伍帶到舊路四座城市中的一座；走過地獄之門契約的術士，則能撕開一道門，把隊伍成員拉到自己身邊。山脊把一片疆域與下一片隔開，而在兩片疆域共用一道山脊之處，道路便會攀上一處隘口。不過並非每一道邊界都是那樣。北方有一條長長的堤道，把道路從帷幕幽谷帶過水面，通往更遠處的雪國；往南回來，一條名為沙洲堤道的細長天然沙洲從東溪谷的海岸向東延伸，抵達遠岸那座島上的登岸碼頭，而那座島根本沒有任何陸上邊界。而整個外部世界中確實只有一道真正的門扉：荊峰高處一層暮色之帷，通往帷幕幽谷。幽谷的南側山脊完全封閉、沒有隘口可通，因此那層帷幕就是你最初進入的方式，而它會在你回程時於身後闔上。\n\n無論你在哪裡倒下，走回去的路都不長。每個區域都至少保有一座墓地，一位靈魂醫者盤旋在墓石之上，而釋放的靈魂會在最近的一座升起。\n\n地圖不會在一道看不見的牆前結束。陸地會延伸成沙灘與海岬，再延伸成開闊的水域。那些世界本就要你游過去的地方，也就是一片疆域與下一片之間的海峽與湖泊，都平靜而安全。但若你朝著外海一路游去，距離本身就會把你逼回來：你會收到警告，接著再收到一次，而如果你還繼續游，大海便會慢慢磨損你，直到把你殺死。潛水也有自己的限度，因為你的氣息在水面下會用盡，所以當水告訴你該回頭時，就浮上來換氣、掉頭吧。',
  ...
  'entities.npcs.waystone_keeper_eastbrook.title': '路石守護者',
  'entities.npcs.waystone_keeper_eastbrook.greeting': '石頭正為你嗡鳴，{className}。觸碰一次，它就永遠記得你的名字。',
  'entities.npcs.waystone_keeper_fenbridge.name': '奧多·沼威克',
  'entities.npcs.waystone_keeper_fenbridge.title': '路石守護者',
  'entities.npcs.waystone_keeper_fenbridge.greeting': '當心石頭上的苔蘚。說個鎮名，你就已經站在那兒了。',
  'entities.npcs.waystone_keeper_highwatch.name': '布拉姆·荊崖',
  'entities.npcs.waystone_keeper_highwatch.title': '路石守護者',
  'entities.npcs.waystone_keeper_highwatch.greeting': '空氣稀薄，道路卻快。石頭記得你踏過的每一座山峰。',
  'entities.npcs.waystone_keeper_eldergleam.name': '席爾凡·暮守',
  'entities.npcs.waystone_keeper_eldergleam.title': '路石守護者',
  'entities.npcs.waystone_keeper_eldergleam.greeting': '幽谷把石頭藏在枝葉之下。選個你更想去的地方吧。',
  'entities.npcs.waystone_keeper_wyrmwatch.name': '卡斯克·餘燼皮',
  'entities.npcs.waystone_keeper_wyrmwatch.title': '路石守護者',
  'entities.npcs.waystone_keeper_wyrmwatch.greeting': '連巨龍都不碰這塊石頭。要塞派你去哪兒？',
  'entities.npcs.waystone_keeper_icemantle.name': '希爾德·霜幔',
  'entities.npcs.waystone_keeper_icemantle.title': '路石守護者',
  'entities.npcs.waystone_keeper_icemantle.greeting': '這塊石頭摸起來是暖的，是冰川上唯一暖和的東西。去哪兒？',
  'entities.npcs.waystone_keeper_lanternmere.name': '芬尼克·琥珀風',
  'entities.npcs.waystone_keeper_lanternmere.title': '路石守護者',
  'entities.npcs.waystone_keeper_lanternmere.greeting': '今晚石頭周圍的燈籠已經點亮。選個目的地吧。',
  'entities.npcs.waystone_keeper_bridgemere.name': '塔姆辛·葦匠',
  'entities.npcs.waystone_keeper_bridgemere.title': '路石守護者',
  'entities.npcs.waystone_keeper_bridgemere.greeting': '從橋頭的石頭到你知道的任何一塊石頭。去哪兒，{className}？',
  'entities.npcs.waystone_keeper_moonrest.name': '埃洛溫·夜歌',
  'entities.npcs.waystone_keeper_moonrest.title': '路石守護者',
  'entities.npcs.waystone_keeper_moonrest.greeting': '飛蛾在黃昏時繞著石頭飛舞。說個地方，你就到了那兒。',
  'entities.npcs.waystone_keeper_gallowmere.name': '科爾文·墓盡',
  'entities.npcs.waystone_keeper_gallowmere.title': '路石守護者',
  'entities.npcs.waystone_keeper_gallowmere.greeting': '這塊石頭還沒有什麼在作祟。暫時沒有。說出你的鎮子。',
  'entities.npcs.waystone_keeper_drifthaven.name': '妮婭·鹽風',
  'entities.npcs.waystone_keeper_drifthaven.title': '路石守護者',
  'entities.npcs.waystone_keeper_drifthaven.greeting': '鹽分絲毫沒有磨鈍這塊石頭。你要去哪兒？',
  'entities.npcs.waystone_keeper_hedgewick.name': '皮普·綠蔭',
  'entities.npcs.waystone_keeper_hedgewick.title': '路石守護者',
  'entities.npcs.waystone_keeper_hedgewick.greeting': '石頭就立在樹籬與果園之間。去哪兒好呢？',
  'entities.npcs.waystone_keeper_wickharbor.name': '馬洛·風之子',
  'entities.npcs.waystone_keeper_wickharbor.title': '路石守護者',
  'entities.npcs.waystone_keeper_wickharbor.greeting': '不管風怎麼吹，港口的石頭都很穩。選個落腳點。',
  'entities.npcs.waystone_keeper_gullhaven.name': '薩賓·鷗翼',
  'entities.npcs.waystone_keeper_gullhaven.title': '路石守護者',
  'entities.npcs.waystone_keeper_gullhaven.greeting': '海鷗棲在這塊石頭上。石頭毫不在意。去哪兒？',
  ...
  'entities.items.tome_grand_teleport_eastbrook.name': '通行之書：東溪',
  'entities.items.tome_grand_teleport_fenbridge.name': '通行之書：芬橋',
  'entities.items.tome_grand_teleport_highwatch.name': '通行之書：高望',
  'entities.items.tome_grand_teleport_eldergleam.name': '通行之書：古輝鎮',
  'entities.abilities.grand_teleport_eastbrook.name': '宏大傳送：東溪',
  'entities.abilities.grand_teleport_eastbrook.description':
    '開啟一道通往東溪的宏大傳送門，持續5分鐘。只有施法瞬間處於你隊伍中的成員才能穿過。消耗一枚通行符文。施法時間10秒。與其他所有宏大傳送共享20分鐘冷卻時間。',
  'entities.abilities.grand_teleport_fenbridge.name': '宏大傳送：芬橋',
  'entities.abilities.grand_teleport_fenbridge.description':
    '開啟一道通往芬橋的宏大傳送門，持續5分鐘。只有施法瞬間處於你隊伍中的成員才能穿過。消耗一枚通行符文。施法時間10秒。與其他所有宏大傳送共享20分鐘冷卻時間。',
  'entities.abilities.grand_teleport_highwatch.name': '宏大傳送：高望',
  'entities.abilities.grand_teleport_highwatch.description':
    '開啟一道通往高望的宏大傳送門，持續5分鐘。只有施法瞬間處於你隊伍中的成員才能穿過。消耗一枚通行符文。施法時間10秒。與其他所有宏大傳送共享20分鐘冷卻時間。',
  'entities.abilities.grand_teleport_eldergleam.name': '宏大傳送：古輝鎮',
  'entities.abilities.grand_teleport_eldergleam.description':
    '開啟一道通往古輝鎮的宏大傳送門，持續5分鐘。只有施法瞬間處於你隊伍中的成員才能穿過。消耗一枚通行符文。施法時間10秒。與其他所有宏大傳送共享20分鐘冷卻時間。',
  ...
  'hudChrome.waystone.gossipOptionAria': '與{name}一起使用路石',
  'hudChrome.waystone.rowAria': '傳送至{town}，{distance}碼，{price}',
  'hudChrome.waystone.distance': '{distance}碼',
  'hudChrome.waystone.fee': '費用：{fee}',
  'hudChrome.waystone.ticketPrice': '1張憑證',
  'hudChrome.waystone.tickets': '路石憑證：{count}',
  'hudChrome.waystone.guildDiscount': '公會折扣：{pct}%',
  'hudChrome.waystone.empty': '你還未與其他路石調諧。觸碰另一座城鎮的路石即可調諧。',
  'hudChrome.waystone.close': '關閉路石',
};
