...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.flightmaster_eastbrook.title': '飛行管理員',
  'entities.npcs.flightmaster_eastbrook.greeting': '獅鷲已經歇夠了，天也放晴了，{className}。去哪兒？',
  'entities.npcs.flightmaster_fenbridge.name': '奧多·沼威克',
  'entities.npcs.flightmaster_fenbridge.title': '飛行管理員',
  'entities.npcs.flightmaster_fenbridge.greeting': '起飛時留神蘆葦。說個鎮名，我們送你過去。',
  'entities.npcs.flightmaster_highwatch.name': '布拉姆·荊崖',
  'entities.npcs.flightmaster_highwatch.title': '飛行管理員',
  'entities.npcs.flightmaster_highwatch.greeting': '空氣稀薄，視野遼闊。這些鳥認得群峰裡的每一道山口。',
  'entities.npcs.flightmaster_eldergleam.name': '席爾凡·暮守',
  'entities.npcs.flightmaster_eldergleam.title': '飛行管理員',
  'entities.npcs.flightmaster_eldergleam.greeting': '從高處看，幽谷溫柔多了。選個落腳點吧。',
  'entities.npcs.flightmaster_wyrmwatch.name': '卡斯克·餘燼皮',
  'entities.npcs.flightmaster_wyrmwatch.title': '飛行管理員',
  'entities.npcs.flightmaster_wyrmwatch.greeting': '連巨龍都會繞開我的鳥。要塞派你去哪兒？',
  'entities.npcs.flightmaster_icemantle.name': '希爾德·霜幔',
  'entities.npcs.flightmaster_icemantle.title': '飛行管理員',
  'entities.npcs.flightmaster_icemantle.greeting': '裹緊些。冰川上的風刺骨，不過飛得很快。',
  'entities.npcs.flightmaster_lanternmere.name': '芬尼克·琥珀風',
  'entities.npcs.flightmaster_lanternmere.title': '飛行管理員',
  'entities.npcs.flightmaster_lanternmere.greeting': '夜航的燈籠已經點亮。選個目的地吧。',
  'entities.npcs.flightmaster_bridgemere.name': '塔姆辛·葦匠',
  'entities.npcs.flightmaster_bridgemere.title': '飛行管理員',
  'entities.npcs.flightmaster_bridgemere.greeting': '從橋頭飛往沼澤允許的任何地方。去哪兒，{className}？',
  'entities.npcs.flightmaster_moonrest.name': '埃洛溫·夜歌',
  'entities.npcs.flightmaster_moonrest.title': '飛行管理員',
  'entities.npcs.flightmaster_moonrest.greeting': '飛蛾會引夜鳥回家。說個地方，我們就飛。',
  'entities.npcs.flightmaster_gallowmere.name': '科爾文·墓盡',
  'entities.npcs.flightmaster_gallowmere.title': '飛行管理員',
  'entities.npcs.flightmaster_gallowmere.greeting': '這裡的天空沒有什麼在作祟。暫時沒有。說出你的鎮子。',
  'entities.npcs.flightmaster_drifthaven.name': '妮婭·鹽風',
  'entities.npcs.flightmaster_drifthaven.title': '飛行管理員',
  'entities.npcs.flightmaster_drifthaven.greeting': '淺灘上的暖風托得鳥兒很輕。你要去哪兒？',
  'entities.npcs.flightmaster_hedgewick.name': '皮普·綠蔭',
  'entities.npcs.flightmaster_hedgewick.title': '飛行管理員',
  'entities.npcs.flightmaster_hedgewick.greeting': '越過樹籬，掠過果園。去哪兒好呢？',
  'entities.npcs.flightmaster_wickharbor.name': '馬洛·風之子',
  'entities.npcs.flightmaster_wickharbor.title': '飛行管理員',
  'entities.npcs.flightmaster_wickharbor.greeting': '今天港口的風很穩。選個落腳點。',
  'entities.npcs.flightmaster_gullhaven.name': '薩賓·鷗翼',
  'entities.npcs.flightmaster_gullhaven.title': '飛行管理員',
  'entities.npcs.flightmaster_gullhaven.greeting': '海鷗討厭我的鳥。鳥兒才不在乎。去哪兒？',
  ...
  'hudChrome.flight.title': '飛行路線',
  'hudChrome.flight.gossipOption': '搭乘飛行',
  'hudChrome.flight.gossipOptionAria': '與{name}一起搭乘飛行',
  'hudChrome.flight.rowAria': '飛往{town}，{hops}段航程，{fare}',
  'hudChrome.flight.hops': '{count}段航程',
  'hudChrome.flight.fare': '費用：{fare}',
  'hudChrome.flight.empty': '你還不認識其他飛行路線。去別的城鎮找飛行管理員交談，以學會那裡的航線。',
  'hudChrome.flight.close': '關閉飛行路線',
};
