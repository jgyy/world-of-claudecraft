...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.waystone_warden_ilse.greeting': '五十銀幣，龍門便送你去高望。比騎龍便宜，比你的雙腿金貴。',
  'entities.npcs.waystone_warden_ilse.name': '路碑守衛伊爾莎',
  'entities.npcs.waystone_warden_ilse.title': '龍門守護者',
  'entities.npcs.provisioner_dunmore.greeting': '山羊烤好了，水是涼的，巨魔這週還沒燒掉倉庫。趁著還能買，趕緊買吧。',
  'entities.npcs.provisioner_dunmore.name': '軍需官鄧莫爾',
  'entities.npcs.provisioner_dunmore.title': '最後的堡壘隨軍商販',
  'entities.npcs.sergeant_varga.greeting': '守過這座堡壘的駐軍再沒回來。如今我們替他們守著。當心東牆的缺口。',
  'entities.npcs.sergeant_varga.name': '中士瓦爾加',
  'entities.npcs.sergeant_varga.title': '外院守衛',
  'entities.npcs.chaplain_ondrey.greeting': '最後之泉仍在這些牆邊流淌，無論鍛造之父從中偷走了什麼。坐一會兒吧。廳堂寂靜，卻並不空蕩。',
  'entities.npcs.chaplain_ondrey.name': '牧師安德烈',
  'entities.npcs.chaplain_ondrey.title': '寂靜廳堂之聲',
  'entities.npcs.paymaster_edda_thorne.greeting': '守備隊的軍餉箱熬過了巨龍，你的錢也會平安無事。存入、支取，或再買一層貨架；金庫已開放。',
  'entities.npcs.paymaster_edda_thorne.name': '軍需官艾達·索恩',
  'entities.npcs.paymaster_edda_thorne.title': '金庫守護者',
  'entities.npcs.auctioneer_bram_kestrel.greeting': '世界市場的觸角連這裡都構得著，{className}。競標全境的貨物，或者把你從沙丘帶回的戰利品掛上去。',
  'entities.npcs.auctioneer_bram_kestrel.name': '拍賣師布拉姆·凱斯特雷爾',
  'entities.npcs.auctioneer_bram_kestrel.title': '世界市場之聲',
  'entities.npcs.armorer_tam_rusk.greeting': '巨龍能砸裂盾牌，巨魔能磨鈍刀刃。不管沙丘奪走了你什麼，鍛爐都有替換的。',
  'entities.npcs.armorer_tam_rusk.name': '軍械師塔姆·拉斯克',
  'entities.npcs.armorer_tam_rusk.title': '要塞軍械師',
