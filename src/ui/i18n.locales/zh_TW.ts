...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.crystal_shard.name': '閃光水晶碎片',
  ...
  'entities.mobs.glimmervein_broodling.name': '微光蜘蛛幼蟲',
  ...
  'entities.zones.mirefen_marsh.pois.8.label': '微光礦脈洞穴',
  ...
  'entities.zones.eastbrook_vale.pois.10.label': '微光礦脈洞穴',
