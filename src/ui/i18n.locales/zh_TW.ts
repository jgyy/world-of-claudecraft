...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.riftForge.upgradeBtn': '強化（{cost} 精華）',
  'hudChrome.riftForge.upgradeMax': '已強化至滿級',
  'hudChrome.riftForge.enchantCurrent': '附魔：+{value} {stat}',
  'hudChrome.riftForge.enchantNone': '附魔：無',
  'hudChrome.riftForge.enchantBtn': '附魔（{cost} 精華）',
  'hudChrome.riftForge.statPickAria': '要附魔的屬性',
  'hudChrome.riftForge.gemPickAria': '要鑲嵌的寶石',
  'hudChrome.riftForge.socketBtn': '鑲嵌',
  'hudChrome.riftForge.socketsNone': '沒有寶石',
  'hudChrome.riftForge.socketsFull': '所有插槽已填滿',
  ...
  'hudChrome.riftForge.reason.invalidStat': '那項屬性無法在此附魔。',
  'hudChrome.riftForge.reason.invalidGem': '你沒有那種裂隙寶石。',
  'hudChrome.riftForge.reason.socketsFull': '那枚戒指的插槽都已填滿。',
  ...
  'hudChrome.riftForge.done.enchant': '已為{name}附魔。',
  ...
  'guide.riftsPage.forgeBody':
    '首次通關排位裂隙鑄造的戒指，在你拿到手時還沒有完工。裂隙鍛匠梅莉絲在遠灘的守望草甸、沿岸上行離開鷗港後的破裂學者身旁守著一座熔爐，她會一步步強化戒指、為它附上一道附魔，並把裂隙掉落的彩色寶石鑲進插槽。這一切都以裂隙精華和裂隙寶石支付，它們是裂隙首領掉落、可自由交易的熔爐貨幣，所以缺的精華可以請朋友遞給你。帶去之前先把戒指卸下：她只處理背包裡的東西，而且除非你站在她的熔爐旁，否則她什麼都不會做。',
