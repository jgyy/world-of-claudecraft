...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wheel.title': '職業之輪',
  'hudChrome.wheel.close': '關閉職業之輪',
  'hudChrome.wheel.archetypeLabel': '命途',
  'hudChrome.wheel.hobbyLabel': '愛好',
  'hudChrome.wheel.dormantLabel': '未涉獵',
  'hudChrome.wheel.amends': '補償進度：{progress}/{required}',
  'hudChrome.wheel.craftTier': '{craft}：{tier}',
  'hudChrome.wheel.armorcrafting': '製甲',
  'hudChrome.wheel.weaponcrafting': '武器鍛造',
  'hudChrome.wheel.jewelcrafting': '珠寶加工',
  'hudChrome.wheel.alchemy': '煉金術',
  'hudChrome.wheel.engineering': '工程學',
  'hudChrome.wheel.cooking': '烹飪',
  'hudChrome.wheel.inscription': '銘文',
  'hudChrome.wheel.enchanting': '附魔',
  'hudChrome.wheel.tailoring': '裁縫',
  'hudChrome.wheel.leatherworking': '製皮',
