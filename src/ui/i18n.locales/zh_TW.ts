...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "entities.items.elixir_of_the_eagle.name": "雄鷹藥劑",
  "entities.items.elixir_of_the_sage.name": "賢者藥劑",
  "entities.items.elixir_of_the_owl.name": "梟智藥劑",
  "entities.items.elixir_of_stoneskin.name": "石膚藥劑",
  "entities.items.elixir_of_brute_force.name": "蠻力藥劑",
  "entities.items.elixir_of_the_wilds.name": "荒野藥劑",
  "entities.items.greater_elixir_of_fortitude.name": "高級堅韌藥劑",
  "entities.items.elixir_of_brilliance.name": "璀璨藥劑",
  "entities.items.greater_healing_potion.name": "強效治療藥水",
  "entities.items.greater_mana_potion.name": "強效法力藥水",
  "entities.items.hunters_stew.name": "豐盛獵人燉肉",
  "entities.items.spiced_cider.name": "香料熱蘋果酒",
  ...
  "entities.items.stormtable_trencher.name": "風暴餐桌木盤餐",
  "entities.items.ridgeline_meat_pie.name": "山脊肉派",
  "entities.items.peakberry_tart.name": "峰頂漿果撻",
  "entities.items.smoked_summit_ram.name": "煙燻峰巔公羊",
  "entities.items.hearthstone_bread.name": "爐石麵包",
  "entities.items.pinewarden_tea.name": "松衛茶",
  "entities.items.spiced_summit_cider.name": "香料峰頂蘋果酒",
  "entities.items.frostmint_draught.name": "霜薄荷飲劑",
  "entities.items.emberbark_brew.name": "餘燼樹皮釀",
  "entities.items.highwatch_mulled_wine.name": "高守熱紅酒",
  ...
  "entities.items.highwatch_warhelm.name": "高望戰盔",
  "entities.items.highwatch_pauldrons.name": "高望護肩",
  "entities.items.highwatch_girdle.name": "高望戰腰帶",
  "entities.items.highwatch_gauntlets.name": "高望護手",
  "entities.items.peakwool_hood.name": "峰羊毛兜帽",
  "entities.items.peakwool_mantle.name": "峰羊毛披肩",
  "entities.items.peakwool_cord.name": "峰羊毛束帶",
  "entities.items.peakwool_gloves.name": "峰羊毛手套",
  "entities.items.ridgestalker_cowl.name": "山脊追獵者頭罩",
  "entities.items.ridgestalker_spaulders.name": "山脊追獵者護肩",
  "entities.items.ridgestalker_belt.name": "山脊追獵者腰帶",
  "entities.items.ridgestalker_grips.name": "山脊追獵者手套",
  "entities.items.monarch_heart.name": "君主之心",
  "entities.items.reedwarden_greathelm.name": "葦衛巨盔",
  "entities.items.reedwarden_pauldrons.name": "葦衛肩鎧",
  "entities.items.reedwarden_girdle.name": "葦衛腰帶",
  "entities.items.reedwarden_gauntlets.name": "葦衛戰手",
  "entities.items.mistweaver_cowl.name": "織霧者頭巾",
  "entities.items.mistweaver_mantle.name": "織霧者披肩",
  "entities.items.mistweaver_cord.name": "織霧者腰索",
  "entities.items.mistweaver_gloves.name": "織霧者手套",
  "entities.items.marshstalker_hood.name": "沼澤潛行者兜帽",
  "entities.items.marshstalker_spaulders.name": "沼澤潛行者肩飾",
  "entities.items.marshstalker_belt.name": "沼澤潛行者腰帶",
  "entities.items.marshstalker_grips.name": "沼澤潛行者手扣",
  "entities.items.drownhammer_warblade.name": "溺錘戰刃",
  "entities.items.fensteel_longsword.name": "沼鋼長劍",
  "entities.items.marshwarden_maul.name": "沼澤守望者重槌",
  "entities.items.reedbinder_mace.name": "縛蘆釘錘",
  "entities.items.silt_dirk.name": "淤泥磨蝕短刀",
  "entities.items.mirewhisper_dagger.name": "沼語匕首",
  "entities.items.eelhide_saber.name": "鰻皮軍刀",
  "entities.items.boglight_staff.name": "沼光法杖",
  "entities.items.fenmist_rod.name": "沼霧魔杖",
  "entities.items.drownreed_cudgel.name": "溺蘆短棍",
  "entities.items.marshlord_greatsword.name": "沼澤領主巨劍",
  "entities.items.venomreed_kris.name": "毒蘆波刃刀",
};
