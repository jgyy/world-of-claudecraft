...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.school.openButton': '學派',
  'hudChrome.school.openButtonAria': '開啟職業學派面板',
  'hudChrome.school.title': '職業學派',
  'hudChrome.school.close': '關閉職業學派',
  'hudChrome.school.intro': '加入一個職業學派，完成其輪換任務以獲取晉階點數。',
  'hudChrome.school.name.enchantersSchool': '附魔師學派',
  'hudChrome.school.rank.enchantersSchool.initiate': '初學者',
  'hudChrome.school.rank.enchantersSchool.apprentice': '學徒',
  'hudChrome.school.rank.enchantersSchool.journeyman': '熟練工',
  'hudChrome.school.rank.enchantersSchool.adept': '精通者',
  'hudChrome.school.rank.enchantersSchool.master': '大師',
  'hudChrome.school.rank.enchantersSchool.grandmaster': '宗師',
  'hudChrome.school.taskKind.daily': '每日委託',
  'hudChrome.school.taskKind.contract': '委託',
  'hudChrome.school.taskKind.materials': '材料委託',
  'hudChrome.school.taskKind.weeklyGroup': '每週組隊委託',
  'hudChrome.school.rankLine': '{rank}，{points}點',
  'hudChrome.school.nextRankLine': '{points} / {nextPoints}點晉升下一階',
  'hudChrome.school.swearToProgress': '宣誓效忠以繼續晉升。',
  'hudChrome.school.qualifyHint': '需要{skill}點{profession}技能（你目前擁有{current}點）。',
  'hudChrome.school.swearButton': '宣誓效忠',
  'hudChrome.school.swornBadge': '已宣誓',
  'hudChrome.school.taskPoints': '{points}點',
  'hudChrome.school.submitButton': '提交',
  'hudChrome.school.readyIn': '{duration}後可用',
  'hudChrome.school.taskSubmitted': '你為{school}完成了一項任務（+{points}點）。',
  'hudChrome.school.denyUnknownTask': '該任務已不存在。',
  'hudChrome.school.denyNotAMember': '你不是{school}的成員。',
  'hudChrome.school.denyOutOfRange': '你必須靠近學派導師才能提交任務。',
  'hudChrome.school.denyOnCooldown': '該任務尚未就緒。',
  'hudChrome.school.denyPartyRequired': '該任務需要組隊。',
  'hudChrome.school.denyInsufficientMaterials': '你沒有該任務所需的材料。',
  ...
  'guide.professions.schoolsHeading': '職業學派',
  'guide.professions.schoolsBody':
    '一門手藝可以從輪環之上成長為獨立的機構：一所實體學派紮根於某位大師的工作站，向證明了自身技藝的人敞開大門，並設有一套可以透過持續參與學派事務來攀登的軍銜階梯。附魔是第一個建成的學派。',
  'guide.professions.schoolCraftFmt': '一所按軍銜分級的{craft}機構，紮根於{hub}。',
