...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bags.disenchantWarningEnchanted':
    '此物品帶有附魔、傑作加成或製作者印記，分解後將會遺失。',
  'hudChrome.bags.disenchantResult': '你分解了物品，獲得{count}個{material}。',
  'hudChrome.bags.disenchantTypedResult':
    '你分解了物品，獲得{count}個{material}，這是訂製打造所需的材料。',
  'hudChrome.bags.disenchantNotEligible': '該物品無法分解。',
  'hudChrome.bags.disenchantFailed': '你已不再持有該物品，無法分解。',
  ...
  'entities.items.arcane_bound_cloth.name': '秘法束縛布',
  'entities.items.arcane_bound_hide.name': '秘法束縛獸皮',
  'entities.items.arcane_bound_chain.name': '秘法束縛鎖鏈',
  'entities.items.arcane_bound_edge.name': '秘法束縛鋒刃',
  'entities.items.arcane_bound_focus.name': '秘法束縛法器',
  'entities.items.arcanists_mantle.name': '秘法者斗篷',
  'entities.items.wyrmstalkers_hide.name': '潛龍者獸皮',
  'entities.items.ironbound_hauberk.name': '鐵束胸甲',
  'entities.items.edgebound_greatblade.name': '鋒束巨劍',
  'entities.items.focusbound_channeler.name': '法束引導者',
