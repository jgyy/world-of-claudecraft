...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.crystal_shard.name': 'Мерцающий осколок кристалла',
  ...
  'entities.mobs.glimmervein_spider.name': 'Мерцающий кристальный паук',
  'entities.mobs.glimmervein_bat.name': 'Мерцающая пещерная летучая мышь',
  ...
  'entities.mobs.glimmervein_broodling.name': 'Мерцающий паучонок',
  ...
  'entities.zones.mirefen_marsh.pois.8.label': 'Пещера Мерцающей Жилы',
  ...
  'entities.zones.eastbrook_vale.pois.10.label': 'Пещера Мерцающей Жилы',
