...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.abilities.raging_gale.description':
    'Мгновенно бьет оружием дважды, каждый удар наносит 40% урона оружием плюс {damage}, и создает 8 ярости. Хранит до 2 зарядов. (ветка «Неистовство»)',
  ...
  'hudChrome.wheel.title': 'Колесо профессий',
  'hudChrome.wheel.close': 'Закрыть колесо профессий',
  'hudChrome.wheel.archetypeLabel': 'Призвание',
  'hudChrome.wheel.hobbyLabel': 'Увлечение',
  'hudChrome.wheel.dormantLabel': 'Не освоено',
  'hudChrome.wheel.amends': 'Прогресс искупления: {progress}/{required}',
  'hudChrome.wheel.craftTier': '{craft}: {tier}',
  'hudChrome.wheel.armorcrafting': 'Бронное дело',
  'hudChrome.wheel.weaponcrafting': 'Оружейное дело',
  'hudChrome.wheel.jewelcrafting': 'Ювелирное дело',
  'hudChrome.wheel.alchemy': 'Алхимия',
  'hudChrome.wheel.engineering': 'Инженерное дело',
  'hudChrome.wheel.cooking': 'Кулинария',
  'hudChrome.wheel.inscription': 'Начертание',
  'hudChrome.wheel.enchanting': 'Наложение чар',
  'hudChrome.wheel.tailoring': 'Портняжное дело',
  'hudChrome.wheel.leatherworking': 'Кожевничество',
