...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hud.cardHand.label': 'Рука карт',
  'hud.cardHand.discardTitle': 'Сброс',
  'hud.cardDuel.close': 'Закрыть карточную дуэль',
  'hud.cardDuel.notEligible': 'Только Мастера карт могут вставать в очередь на карточную дуэль.',
  'hud.cardDuel.enterQueue': 'Встать в очередь',
  'hud.cardDuel.leaveQueue': 'Покинуть очередь',
  'hud.cardDuel.searching': 'Поиск соперника... (в очереди {count})',
  'hud.cardDuel.queueNote':
    'Дуэль 1 на 1 между Мастерами карт. Вас сведут со следующим игроком в очереди.',
  ...
  'classes.card_adept': 'Мастер карт',
  'classes.card_adeptAria': 'Класс мастера карт',
  'classDetails.roles.card_adept': 'Дальний боец',
  'classDetails.lore.card_adept': 'Мастера карт плетут перетасованную колоду заряженных карт, тратя Фокус на карты урона, лечения и защиты, вытянутые из вечно обновляющейся руки.',
  'guide.abilityHook.ca_quickstrike': 'Дешёвая заряженная карта, брошенная во врага для быстрого чародейского урона.',
  'guide.abilityHook.ca_arcane_bolt': 'Надёжная дальнобойная карта, крепкий заряд чародейской силы.',
  'guide.abilityHook.ca_flame_fan': 'Веер горящих карт наносит удар и оставляет тлеющий ожог.',
  'guide.abilityHook.ca_mending_card': 'Восстанавливающая карта, исцеляющая вас или союзника.',
  'guide.abilityHook.ca_warding_card': 'Быстрая карта защиты, ненадолго повышающая броню.',
  'guide.abilityHook.ca_hex_card': 'Карта порчи замедляет цель, не давая ей преследовать.',
  'guide.abilityHook.ca_empower_card': 'Черпает силу из колоды, повышая интеллект перед крупным ходом.',
  'guide.abilityHook.ca_royal_flush': 'Ваш финишер: роял-флеш обрушивает тяжёлый огненный урон.',
  'entities.abilities.ca_quickstrike.name': 'Карта быстрого удара',
  'entities.abilities.ca_quickstrike.description': 'Бросает заряженную карту в цель, нанося {damage} чародейского урона.',
  'entities.abilities.ca_arcane_bolt.name': 'Карта чародейского заряда',
  'entities.abilities.ca_arcane_bolt.description': 'Выпускает заряд чародейской силы, нанося {damage} урона.',
  'entities.abilities.ca_flame_fan.name': 'Карта веера пламени',
  'entities.abilities.ca_flame_fan.description': 'Веер горящих карт наносит {damage} огненного урона и поджигает.',
  'entities.abilities.ca_mending_card.name': 'Карта исцеления',
  'entities.abilities.ca_mending_card.description': 'Восстанавливающая карта исцеляет союзную цель на {damage}.',
  'entities.abilities.ca_warding_card.name': 'Карта оберега',
  'entities.abilities.ca_warding_card.description': 'Окружает вас картой оберега, повышая броню на {buff} на 30 сек.',
  'entities.abilities.ca_hex_card.description': 'Карта порчи замедляет цель на 6 сек.',
  'entities.abilities.ca_empower_card.name': 'Карта усиления',
  'entities.abilities.ca_empower_card.description': 'Черпает силу из колоды, повышая интеллект на {buff}% на 1 мин.',
  'entities.abilities.ca_royal_flush.name': 'Карта роял-флеш',
  'entities.abilities.ca_royal_flush.description': 'Разыгрывает роял-флеш, нанося {damage} огненного урона.',
};
