...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.bank.guildReadOnlyNote': 'Вносить изменения в банк гильдии могут только офицеры гильдии.',
  'hudChrome.bank.guildUnopenedNote': 'Банк гильдии пока не открыт.',
  ...
  'hudChrome.bank.logUnavailable': 'Журнал банка гильдии сейчас недоступен.',
  ...
  'hudChrome.professions.craftingProgress': 'Вы создаёте предмет: осталось {remaining} с из {total} с.',
  ...
  'hudChrome.commissionBoard.openButton': 'Заказы',
  'hudChrome.commissionBoard.openButtonAria': 'Открыть доску заказов',
  'hudChrome.commissionBoard.intro': 'Закажите ремесленнику изготовление предмета или возьмите чужой заказ.',
  'hudChrome.commissionBoard.formTitle': 'Разместить заказ',
  'hudChrome.commissionBoard.recipeLabel': 'Предмет',
  'hudChrome.commissionBoard.recipeEmpty': 'Вы пока не знаете рецептов снаряжения, доступных для заказа.',
  'hudChrome.commissionBoard.scopeLabel': 'Кто может принять',
  'hudChrome.commissionBoard.scopeOpen': 'Любой (открытая доска)',
  'hudChrome.commissionBoard.scopeCrafter': 'Определённый мастер',
  'hudChrome.commissionBoard.crafterNameLabel': 'Имя мастера',
  'hudChrome.commissionBoard.crafterNamePlaceholder': 'Имя персонажа',
  'hudChrome.commissionBoard.openSubmit': 'Разместить заказ',
  'hudChrome.commissionBoard.sectionMine': 'Мои заказы',
  'hudChrome.commissionBoard.sectionToCraft': 'Заказы, которые я выполняю',
  'hudChrome.commissionBoard.sectionBoard': 'Открытая доска',
  'hudChrome.commissionBoard.boardEmpty': 'Сейчас нет открытых заказов.',
  'hudChrome.commissionBoard.mineEmpty': 'Вы ещё не разместили ни одного заказа.',
  'hudChrome.commissionBoard.toCraftEmpty': 'Сейчас вы не выполняете ничей заказ.',
  ...
  'hudChrome.commissionBoard.statusCancelled': 'Отменён',
  'hudChrome.commissionBoard.statusExpired': 'Истёк',
  'hudChrome.commissionBoard.cancelButton': 'Отменить',
  'hudChrome.commissionBoard.acceptButton': 'Принять',
  'hudChrome.commissionBoard.deliverButton': 'Доставить',
  'hudChrome.commissionBoard.deliverHint': 'Сначала изготовьте изделие на заказ (включив переключатель заказа), затем вернитесь сюда, чтобы доставить его.',
  'hudChrome.commissionBoard.opened': 'Вы разместили заказ на {item}.',
  'hudChrome.commissionBoard.cancelled': 'Вы отменили заказ на {item}.',
  'hudChrome.commissionBoard.accepted': 'Вы приняли заказ на {item}.',
  'hudChrome.commissionBoard.delivered': 'Вы доставили {item} игроку {name}.',
  'hudChrome.commissionBoard.denyUnknownRecipe': 'Такого рецепта не существует.',
  'hudChrome.commissionBoard.denyNotCommissionEligible': 'Этот рецепт нельзя заказать.',
  'hudChrome.commissionBoard.denyUnknownCrafter': 'Персонаж с таким именем не найден.',
  'hudChrome.commissionBoard.denySelfCrafter': 'Нельзя заказать предмет самому себе.',
  'hudChrome.commissionBoard.denyTooManyOpen': 'У вас уже слишком много открытых заказов.',
  'hudChrome.commissionBoard.denyUnknownOrder': 'Этот заказ больше не существует.',
  'hudChrome.commissionBoard.denyOrderNotOpen': 'Этот заказ больше не открыт.',
  'hudChrome.commissionBoard.denySelfOrder': 'Нельзя принять собственный заказ.',
  'hudChrome.commissionBoard.denyNotEligibleCrafter': 'Этот заказ размещён для другого мастера.',
  'hudChrome.commissionBoard.denyNotYourOrder': 'Это не ваш заказ.',
  'hudChrome.commissionBoard.denyOrderNotAccepted': 'Этот заказ ещё не принят.',
  'hudChrome.commissionBoard.denyNotYourAcceptance': 'Вы не принимали этот заказ.',
  'hudChrome.commissionBoard.denyNotCrafted': 'Сначала изготовьте изделие на заказ (включив переключатель заказа).',
  'hudChrome.commissionBoard.denyOutOfRange': 'Чтобы доставить заказ, нужно быть рядом с заказчиком.',
  'hudChrome.commissionBoard.denyNoSpace': 'У заказчика нет места в сумках.',
  ...
  'auth.jewelSilver': 'Серебро',
  'auth.jewelBone': 'Кость',
  'auth.jewelIron': 'Железо',
  'auth.jewelCopper': 'Медь',
  'auth.jewelBronze': 'Бронза',
  'auth.jewelObsidian': 'Обсидиан',
  'auth.jewelJade': 'Нефрит',
  'auth.jewelAmethyst': 'Аметист',
  'auth.jewelRuby': 'Рубин',
  'auth.jewelPearl': 'Жемчуг',
  'auth.jewelTurquoise': 'Бирюза',
  'auth.earNone': 'Нет',
  'auth.earStud': 'Гвоздик',
  'auth.earBone': 'Костяной оберег',
  'auth.earBonehoop': 'Костяное кольцо',
  'auth.earMoon': 'Полумесяц',
  'auth.earMoonstar': 'Лунная звезда',
  'auth.earRunic': 'Рунный камень',
  'auth.earChain': 'Бисерная подвеска',
  'auth.earSeptum': 'Кольцо в носу',
  'auth.earWarden': 'Железо Стража',
  'auth.earHoop': 'Кольцо',
  'auth.earCuff': 'Клипса',
  'auth.earFeather': 'Перо',
  'auth.beard': 'Борода',
  'auth.face': 'Лицо',
  'auth.bodyShoulders': 'Плечи',
  'auth.bodyChest': 'Грудь',
  'auth.bodyHips': 'Бёдра',
  'auth.bodyHands': 'Размер кистей',
  'auth.bodyElbows': 'Локти',
  'auth.bodyKnees': 'Колени',
  'auth.bodyFeet': 'Ступни',
  'auth.faceNose': 'Нос',
  'auth.faceEyes': 'Размер глаз',
  'auth.faceJaw': 'Челюсть',
  'auth.faceBrow': 'Бровь',
  'auth.faceCheeks': 'Щёки',
  'auth.faceChin': 'Подбородок',
  'auth.mouth': 'Рот',
  'auth.mouthNeutral': 'Обычный',
  'auth.mouthLips': 'Пухлые губы',
  'auth.mouthSmile': 'Улыбка',
  'auth.mouthFrown': 'Хмурый',
  'auth.mouthWide': 'Широкий',
  'auth.mouthPout': 'Надутый',
  'auth.mouthGrin': 'Улыбка с зубами',
  'auth.mouthOpen': 'Открытый',
  'auth.mouthAwe': 'Изумление',
  'auth.faceEars': 'Уши',
  'auth.faceSmirk': 'Ухмылка',
  'auth.eyeShape': 'Форма глаз',
  'auth.eyeColor': 'Цвет глаз',
  'auth.earShape': 'Форма ушей',
  'auth.lashes': 'Ресницы',
  'auth.lashesOn': 'Вкл.',
  'auth.lashesOff': 'Выкл.',
  'auth.lashColor': 'Цвет ресниц',
  'auth.lipstick': 'Помада',
  'auth.blush': 'Румяна',
  'auth.eyeshadow': 'Тени для век',
  'auth.makeupNone': 'Нет',
  'auth.shadeRose': 'Розовый',
  'auth.shadeCoral': 'Коралловый',
  'auth.shadeRuby': 'Рубиновый',
  'auth.shadeBerry': 'Ягодный',
  'auth.shadePlum': 'Сливовый',
  'auth.shadeNude': 'Нюдовый',
  'auth.shadePeach': 'Персиковый',
  'auth.shadeWarm': 'Тёплый',
  'auth.shadeMauve': 'Лиловый',
  'auth.shadeSmoke': 'Дымчатый',
  'auth.shadeBronze': 'Бронзовый',
  'auth.shadeTeal': 'Бирюзовый',
  'auth.randomize': 'Случайный облик',
  'auth.randomizeShort': 'Случайно',
  'auth.helmPreview': 'Показать шлем',
  'auth.style': 'Стиль',
  'auth.resetLook': 'Сбросить облик',
  'auth.resetShort': 'Сброс',
  'auth.browFlat': 'Прямые',
  'auth.browArched': 'Дугой',
  'auth.browThin': 'Тонкие',
  'auth.browBushy': 'Густые',
  'auth.browWorried': 'Домиком',
  'auth.browSharp': 'Резкие',
  'auth.browRound': 'Круглые',
  'auth.eyeRound': 'Круглые',
  'auth.eyeAlmond': 'Миндалевидные',
  'auth.eyeNarrow': 'Узкие',
  'auth.eyeWide': 'Широкие',
  'auth.eyeSharp': 'Резкие',
  'auth.eyeDroopy': 'Опущенные',
  'auth.eyeSleepy': 'Сонные',
  'auth.eyeWideset': 'Широко посаженные',
  'auth.eyeCat': 'Кошачьи',
  'auth.eyeDoe': 'Оленьи',
  'auth.earRound': 'Круглые',
  'auth.earPointed': 'Острые',
  'auth.earSmall': 'Малые',
  'auth.earWide': 'Широкие',
  'auth.hairBald': 'Лысый',
  'auth.hairBuzz': 'Ёжик',
  'auth.hairCrew': 'Короткие',
  'auth.hairPompadour': 'Помпадур',
  'auth.hairMessy': 'Взъерошенный ёршик',
  'auth.hairMohawk': 'Ирокез',
  'auth.hairFauxhawk': 'Фальш-ирокез',
  'auth.hairAfro': 'Афро',
  'auth.hairTopknot': 'Пучок сверху',
  'auth.hairCrewcut': 'Текстурная стрижка',
  'auth.hairSidepart': 'Классический пробор',
  'auth.hairCurlycap': 'Короткие кудри',
  'auth.hairSweptback': 'Средние зачёсанные назад',
  'auth.hairWarriorbraid': 'Коса воина',
  'auth.hairCurtains': 'Шторки с пробором',
  'auth.hairLayered': 'Каскад до плеч',
  'auth.hairMullet': 'Пышный маллет',
  'auth.hairLongpart': 'Длинные с прямым пробором',
  'auth.hairPixie': 'Пикси',
  'auth.hairSweptpixie': 'Растрёпанное пикси',
  'auth.hairQuiff': 'Зачёс наверх',
  'auth.hairHighbun': 'Высокий пучок',
  'auth.hairLowbun': 'Низкий пучок',
  'auth.hairBraidcrown': 'Коса-корона',
  'auth.hairCurlyafro': 'Кудрявое афро',
  'auth.hairChinbob': 'Боб до подбородка',
  'auth.hairBluntbangs': 'Боб с прямой чёлкой',
  'auth.hairWavybob': 'Волнистый боб',
  'auth.hairAsymbob': 'Асимметричный боб',
  'auth.hairHighpony': 'Высокий хвост',
  'auth.hairSidepony': 'Боковой хвост',
  'auth.hairHalfbun': 'Полупучок',
  'auth.hairCurls': 'Мягкие кудри',
  'auth.hairLongwavy': 'Длинные волны',
  'auth.hairLongcenterpart': 'Длинные с прямым пробором',
  'auth.hairTwinbraids': 'Две косы',
  'auth.hairLowpony': 'Низкий хвост',
  'auth.hairFantasybraid': 'Сказочная коса',
  'auth.outfit': 'Цвет наряда',
  'auth.outfitClassic': 'Классика',
  'auth.outfitCrimson': 'Багряный',
  'auth.outfitEmber': 'Тлеющий уголь',
  'auth.outfitGold': 'Золото',
  'auth.outfitForest': 'Лесной',
  'auth.outfitEmerald': 'Изумруд',
  'auth.outfitTeal': 'Бирюзовый',
  'auth.outfitAzure': 'Лазурный',
  'auth.outfitRoyal': 'Королевский синий',
  'auth.outfitViolet': 'Фиолетовый',
  'auth.outfitMagenta': 'Пурпурный',
  'auth.outfitRose': 'Розовый',
  'auth.outfitOnyx': 'Оникс',
  'auth.outfitIvory': 'Слоновая кость',
  'auth.outfitGilded': 'Позолота',
  'auth.outfitBonewrought': 'Костяная работа',
  'auth.outfitObsidian': 'Обсидиан',
  'auth.outfitVerdigris': 'Патина',
  'auth.outfitBloodforged': 'Кровавая ковка',
  'auth.beardNone': 'Нет',
  'auth.beardStubble': 'Щетина',
  'auth.beardScruff': 'Небритость',
  'auth.beardMutton': 'Бараньи бакенбарды',
  'auth.beardGoatee': 'Эспаньолка',
  'auth.beardChinpuff': 'Клинышек',
  'auth.beardStache': 'Усы',
  'auth.beardHorseshoe': 'Подкова',
  'auth.beardShortbox': 'Короткая',
  'auth.beardFull': 'Полная',
  'auth.beardVikingb': 'Заплетённая',
  'auth.beardWizard': 'Борода мага',
  ...
  'auth.hair': 'Волосы',
  'auth.brows': 'Брови',
  'auth.skinTone': 'Тон кожи',
  'auth.hairColor': 'Цвет волос',
  'auth.lightness': 'Светлее / темнее',
  'auth.colorWheelAria': 'Цветовой круг {label}: перетаскивайте, чтобы выбрать оттенок и насыщенность',
  'auth.lightnessAria': 'Яркость {label}',
  'auth.customColor': 'Свой цвет',
  'auth.colorPresetAria': '{label}: образец {n}',
  'auth.browNone': 'Нет',
  'auth.browSoft': 'Мягкие',
  'auth.browThick': 'Густые',
  'auth.browAngled': 'Наклонные',
