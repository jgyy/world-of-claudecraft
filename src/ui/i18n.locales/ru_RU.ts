...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'classDetails.lore.card_adept':
    'Мастера карт плетут перетасованную колоду заряженных карт, тратя Фокус на карты урона, лечения и защиты, вытянутые из вечно обновляющейся руки.',
  'guide.abilityHook.ca_quickstrike':
    'Дешёвая заряженная карта, брошенная во врага для быстрого чародейского урона.',
  'guide.abilityHook.ca_arcane_bolt':
    'Надёжная дальнобойная карта, крепкий заряд чародейской силы.',
  ...
  'guide.abilityHook.ca_empower_card':
    'Черпает силу из колоды, повышая интеллект перед крупным ходом.',
  ...
  'entities.abilities.ca_empower_card.description':
    'Черпает силу из колоды, повышая интеллект на {buff}% на 1 мин.',
  'entities.abilities.ca_royal_flush.name': 'Карта роял-флеш',
  'entities.abilities.ca_royal_flush.description':
    'Разыгрывает роял-флеш, нанося {damage} огненного урона.',
};
