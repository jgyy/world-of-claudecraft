...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.arcane_bound_cloth.name': 'Дугосвязанная ткань',
  'entities.items.arcane_bound_hide.name': 'Дугосвязанная шкура',
  'entities.items.arcane_bound_chain.name': 'Дугосвязанная кольчуга',
  'entities.items.arcane_bound_edge.name': 'Дугосвязанное лезвие',
  'entities.items.arcane_bound_focus.name': 'Дугосвязанный фокус',
  'entities.items.arcanists_mantle.name': 'Мантия чароплёта',
  'entities.items.wyrmstalkers_hide.name': 'Шкура змеелова',
  'entities.items.ironbound_hauberk.name': 'Железосвязанный хауберк',
  'entities.items.edgebound_greatblade.name': 'Тяжёлый меч, связанный лезвием',
  'entities.items.focusbound_channeler.name': 'Проводник, связанный фокусом',
