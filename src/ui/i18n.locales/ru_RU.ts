...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'itemUi.market.jackpotNote': 'Торговец копит {pool} комиссии к следующему пополнению запасов.',
  ...
  'guide.economy.marketGiveawayBody':
    'Эта небольшая доля не просто комиссия: она копится в общий фонд, который периодически финансирует розыгрыш добротного снаряжения среди тех, кто на самом деле торговал на Рынке с прошлого розыгрыша. Записываться или заявлять о своём участии не нужно: покупка или продажа на Рынке уже считается участием. Победитель объявляется всему миру, а приз ждёт у Купца, как и любая другая выручка с Рынка.',
    'Эта небольшая комиссия не просто плата: она накапливается в общем фонде, который периодически пополняет полки Купца новым снаряжением, полностью за счёт торговых комиссий. Ничего вводить или забирать не нужно; новый товар просто появляется среди постоянных товаров Купца, доступный для покупки всем, как и любой другой товар лавки.',
