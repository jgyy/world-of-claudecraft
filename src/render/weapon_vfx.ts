...
import { localBounds, rand, resolvePoint, surfacePoints } from './weapon_vfx_geometry';
...
// ---------------------------------------------------------------------------
// Geometry helpers: rootRelativeMatrix, localBounds, resolvePoint, rand and
// surfacePoints now live in weapon_vfx_geometry.ts (see the import above);
// this file consumes them without re-deriving weapon-local space itself.
// ---------------------------------------------------------------------------
