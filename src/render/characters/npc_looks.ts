...
export const NPC_LOOKS: Record<string, NpcLookDef> = {
  ...
  flightmaster_eldergleam: {
    app: {
      ...
      ...skin(30, 0.2, 0.75),
      mouth: 'lips',
      face: face({ ears: 0.6, cheeks: -0.2, chin: 0.15 }),
      body: body({ shoulders: -0.15 }),
      earrings: 'moon',
      earringMaterial: 'silver',
      outfit: 'violet',
  ...
  flightmaster_wyrmwatch: {
    app: {
      ...
      ...skin(22, 0.5, 0.38),
      mouth: 'frown',
      face: face({ jaw: 0.4, brow: 0.35, nose: 0.2 }),
      body: body({ shoulders: 0.4, chest: 0.3, hands: 0.25 }),
      outfit: 'ember',
    },
    worn: kit('ranger', { chest: 'barbarian', arms: 'barbarian' }),
    props: 'none',
  },
  ...
  flightmaster_lanternmere: {
    app: {
      ...
      ...skin(28, 0.45, 0.55),
      mouth: 'smile',
      face: face({ nose: 0.1, smirk: 0.2 }),
      body: body({ shoulders: 0.05 }),
      outfit: 'gilded',
    },
    worn: kit('ranger', { back: null }),
    props: 'none',
  ...
  flightmaster_drifthaven: {
    app: {
      ...
      ...skin(24, 0.5, 0.35),
      mouth: 'grin',
      face: face({ cheeks: 0.15, eyes: 0.1 }),
      body: body({ shoulders: 0.05 }),
      earrings: 'bonehoop',
      earringMaterial: 'bone',
      outfit: 'teal',
    },
    worn: kit('ranger', { arms: null, back: null }),
    props: 'none',
  },
  ...
  flightmaster_gullhaven: {
    app: {
      ...
      ...skin(26, 0.35, 0.55),
      mouth: 'wide',
      face: face({ smirk: 0.3, cheeks: -0.1 }),
      body: body({ shoulders: 0.1 }),
      earrings: 'feather',
      earringMaterial: 'silver',
      outfit: 'teal',
