...
| `unstuck.ts` | `/unstuck` recovery countdown, the graveyard move (alive) or graveyard revive (dead), cancellation, and cooldown. Charges nothing but the cooldown (Unstuck Sickness retired in v0.44.0), never a death |
