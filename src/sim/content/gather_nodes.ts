...
export const GATHER_NODES: GatherNodeDef[] = [
  ...
  // Glimmervein Cavern ore vein, in the underground tunnel at x=110 (the
  // GLIMMERVEIN_PASS_X bore in data.ts). One vein on each side so both zone
  // files register a node for their own half.
  { id: 'ore_glimmervein_1', zoneId: 'eastbrook_vale', type: 'ore', pos: { x: 110, z: 150 } },
  { id: 'ore_glimmervein_2', zoneId: 'mirefen_marsh', type: 'ore', pos: { x: 110, z: 195 } },
];
