...
export const AUGMENTS: AugmentDef[] = [
  ...
  { id: 'aug_brutality', name: 'Brutality', tier: 'silver', classes: PHYSICAL,
    description: 'Your physical strikes hit 15% harder.',
    effect: { global: { meleeDmgPct: 0.15 } } },
  { id: 'aug_spellfire', name: 'Spellfire', tier: 'silver', classes: CASTERS,
    description: 'Your spells deal 15% more damage.',
    effect: { global: { spellDmgPct: 0.15 } } },
  { id: 'aug_toughness', name: 'Toughness', tier: 'silver',
    description: 'Gain 12% maximum health.',
    effect: { stats: { maxHpPct: 0.12 } } },
  { id: 'aug_keen_eye', name: 'Keen Eye', tier: 'silver',
    description: 'Gain 8% critical strike chance.',
    effect: { stats: { crit: 0.08 } } },
  { id: 'aug_fleetfoot', name: 'Fleetfoot', tier: 'silver',
    description: 'Move 15% faster. Run them down — or run away.',
    effect: {}, special: { moveSpeedPct: 0.15 } },
  { id: 'aug_ironhide', name: 'Ironhide', tier: 'silver',
    description: 'Gain 250 armor and 5% dodge.',
    effect: { stats: { armor: 250, dodge: 0.05 } } },
  { id: 'aug_mending', name: 'Mending', tier: 'silver', roles: ['healer'],
    description: 'Your healing is 20% more potent.',
    effect: { global: { healPct: 0.2 } } },
  { id: 'aug_bulwark', name: 'Bulwark', tier: 'silver',
    description: 'Gain 350 armor. Hold the line.',
    effect: { stats: { armor: 350 } } },
  { id: 'aug_zealotry', name: 'Zealotry', tier: 'silver', classes: PHYSICAL,
    description: 'Gain 200 attack power. Swing with purpose.',
    effect: { stats: { ap: 200 } } },
  { id: 'aug_focus', name: 'Focus', tier: 'silver', classes: CASTERS,
    description: '+6% critical strike and +8% spell damage. Sharpen the mind.',
    effect: { stats: { crit: 0.06 }, global: { spellDmgPct: 0.08 } } },
  { id: 'aug_second_wind', name: 'Second Wind', tier: 'silver',
    description: 'Heal for 8% of all damage you deal. Keep moving.',
    effect: {}, special: { lifestealPct: 0.08 } },

  // ---- GOLD (wave 2): two-stat combos, the build starts to sing ----------
  { id: 'aug_warlords_might', name: "Warlord's Might", tier: 'gold', classes: PHYSICAL,
    description: '+25% physical damage and +10% crit. Become the threat.',
    effect: { global: { meleeDmgPct: 0.25 }, stats: { crit: 0.1 } } },
  { id: 'aug_arcane_surge', name: 'Arcane Surge', tier: 'gold', classes: CASTERS,
    description: '+25% spell damage and +10% crit. Light them up.',
    effect: { global: { spellDmgPct: 0.25 }, stats: { crit: 0.1 } } },
  { id: 'aug_vampirism', name: 'Vampirism', tier: 'gold',
    description: 'Heal for 15% of all damage you deal. Sustain through chaos.',
    effect: {}, special: { lifestealPct: 0.15 } },
  { id: 'aug_juggernaut', name: 'Juggernaut', tier: 'gold',
    description: '+20% maximum health and +400 armor. Immovable.',
    effect: { stats: { maxHpPct: 0.2, armor: 400 } } },
  { id: 'aug_bloodhunter', name: 'Bloodhunter', tier: 'gold',
  ...
  { id: 'aug_lightwell', name: 'Lightwell', tier: 'gold', roles: ['healer'],
    description: '+30% healing and +15% maximum health. Anchor your team.',
    effect: { global: { healPct: 0.3 }, stats: { maxHpPct: 0.15 } } },
  { id: 'aug_bounty_hunter', name: 'Bounty Hunter', tier: 'gold',
    description: 'Your kills are worth +1 bonus team point. Close the gap fast.',
    effect: { stats: { crit: 0.05 } }, special: { scorePerKill: 1 } },
  { id: 'aug_executioner', name: 'Executioner', tier: 'gold', classes: PHYSICAL,
    description: '+22% physical damage and +8% crit. Finish what you start.',
    effect: { global: { meleeDmgPct: 0.22 }, stats: { crit: 0.08 } } },
  { id: 'aug_stormcaller', name: 'Stormcaller', tier: 'gold', classes: CASTERS,
    description: '+22% spell damage and +12% move speed. Kite and burn.',
    effect: { global: { spellDmgPct: 0.22 } }, special: { moveSpeedPct: 0.12 } },
  { id: 'aug_bastion', name: 'Bastion', tier: 'gold',
    description: '+15% maximum health, +350 armor and +5% dodge. Weather it.',
    effect: { stats: { maxHpPct: 0.15, armor: 350, dodge: 0.05 } } },
  { id: 'aug_revenant', name: 'Revenant', tier: 'gold',
    description: 'Heal for 18% of damage dealt and gain +10% maximum health.',
    effect: { stats: { maxHpPct: 0.1 } }, special: { lifestealPct: 0.18 } },

  // ---- PRISMATIC (wave 3): build-defining, screen-melting spikes ---------
  { id: 'aug_apex_predator', name: 'Apex Predator', tier: 'prismatic', classes: PHYSICAL,
  ...
  { id: 'aug_overdrive', name: 'Overdrive', tier: 'prismatic',
  ...
  { id: 'aug_warbringer', name: 'Warbringer', tier: 'prismatic', classes: PHYSICAL,
    description: '+35% physical damage, +12% crit and +250 attack power.',
    effect: { global: { meleeDmgPct: 0.35 }, stats: { crit: 0.12, ap: 250 } } },
  { id: 'aug_cataclysm', name: 'Cataclysm', tier: 'prismatic', classes: CASTERS,
    description: '+45% spell damage and +18% crit. Unmake them.',
    effect: { global: { spellDmgPct: 0.45 }, stats: { crit: 0.18 } } },
  { id: 'aug_immortal', name: 'Immortal', tier: 'prismatic',
    description: '+35% maximum health, +700 armor and +10% dodge. Refuse to fall.',
    effect: { stats: { maxHpPct: 0.35, armor: 700, dodge: 0.1 } } },
  { id: 'aug_bloodlord', name: 'Bloodlord', tier: 'prismatic',
    description: '+25% all damage, heal for 20% of damage dealt, +15% move speed.',
    effect: { global: { meleeDmgPct: 0.25, spellDmgPct: 0.25 } },
    special: { lifestealPct: 0.2, moveSpeedPct: 0.15 } },
];
...
export const AUGMENT_CATEGORY: Record<string, AugmentCategory> = {
  aug_brutality: 'offense', aug_spellfire: 'offense', aug_keen_eye: 'offense',
  aug_warlords_might: 'offense', aug_arcane_surge: 'offense', aug_apex_predator: 'offense',
  aug_archmage: 'offense', aug_avatar: 'offense', aug_overdrive: 'offense',
  aug_zealotry: 'offense', aug_focus: 'offense', aug_executioner: 'offense',
  aug_warbringer: 'offense', aug_cataclysm: 'offense',
  aug_toughness: 'defense', aug_ironhide: 'defense', aug_juggernaut: 'defense', aug_unkillable: 'defense',
  aug_bulwark: 'defense', aug_bastion: 'defense', aug_immortal: 'defense',
  aug_vampirism: 'sustain', aug_mending: 'sustain', aug_lightwell: 'sustain', aug_ascendant: 'sustain',
  aug_second_wind: 'sustain', aug_revenant: 'sustain', aug_bloodlord: 'sustain',
  aug_fleetfoot: 'mobility', aug_bloodhunter: 'mobility', aug_stormcaller: 'mobility',
...
export interface PowerupBuff { kind: AuraKind; value: number; }
...
export const POWERUPS: PowerupDef[] = [
  { id: 'pow_speed_demon', name: 'Speed Demon', color: 0x32e0ff, glow: 0x32e0ff, duration: 12,
    buffs: [{ kind: 'buff_speed', value: 1.7 }, { kind: 'buff_scale', value: 0.6 }] },
  { id: 'pow_colossus', name: 'Colossus', color: 0xff8a1e, glow: 0xff8a1e, duration: 14,
    buffs: [{ kind: 'buff_scale', value: 1.9 }, { kind: 'slow', value: 0.82 }] },
  { id: 'pow_moon_boots', name: 'Moon Boots', color: 0xb06bff, glow: 0xb06bff, duration: 14,
    buffs: [{ kind: 'buff_jump', value: 2.8 }, { kind: 'buff_speed', value: 1.25 }] },
  { id: 'pow_berserker', name: 'Berserker', color: 0xff3535, glow: 0xff3535, duration: 10,
    buffs: [{ kind: 'buff_ap', value: 280 }, { kind: 'buff_speed', value: 1.2 }] },
];
