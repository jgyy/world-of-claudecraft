...
export const FLIGHT_NODES: readonly FlightNodeDef[] = [
  ...
  },
  {
    ...
    zoneId: 'amberfall',
    town: 'Lanternmere',
    npcId: 'flightmaster_lanternmere',
    x: -346,
    z: 2086,
  },
  {
...
const FLIGHTMASTER_NAMES: Record<string, { name: string; greeting: string }> = {
  eastbrook: {
    name: 'Wren Hollis',
    greeting: 'The gryphons are rested and the sky is clear, $C. Where to?',
  },
  fenbridge: {
    name: 'Odo Marshwick',
  ...
  bridgemere: {
    ...
    greeting: 'From the bridge to anywhere the fens allow. Where to, $C?',
  },
  moonrest: {
