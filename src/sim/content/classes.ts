...
export const CLASSES: Record<PlayerClass, ClassDef> = {
  ...
  card_adept: {
    id: 'card_adept',
    name: 'Card Adept',
    baseStats: { str: 12, agi: 16, sta: 17, int: 22, spi: 18, armor: 30 },
    statsPerLevel: { str: 0, agi: 1, sta: 1, int: 3, spi: 1, armor: 5 },
    baseHp: 44,
    hpPerLevel: 14,
...
export const ABILITIES: Record<string, AbilityDef> = {
  ...
  // ====================== CARD ADEPT ======================
  // Spell-school effect templates that the CARDS table (content/cards.ts)
  // references by id. A played card triggers the referenced ability's effects
  // through the normal effect-dispatch pipeline.
  ca_quickstrike: {
    id: 'ca_quickstrike',
    ...
    school: 'arcane',
    requiresTarget: true,
    effects: [{ type: 'directDamage', min: 14, max: 20 }],
    description: 'Snaps a charged card at the target for $d Arcane damage.',
  },
  ca_arcane_bolt: {
    id: 'ca_arcane_bolt',
    ...
    school: 'arcane',
    requiresTarget: true,
    effects: [{ type: 'directDamage', min: 26, max: 34 }],
    ranks: [
      { rank: 2, level: 6, cost: 40, effects: [{ type: 'directDamage', min: 40, max: 52 }] },
      { rank: 3, level: 12, cost: 55, effects: [{ type: 'directDamage', min: 62, max: 80 }] },
    ],
    description: 'Looses a bolt of arcane force for $d damage.',
  },
  ca_flame_fan: {
    id: 'ca_flame_fan',
    name: 'Flame Fan Card',
    ...
    requiresTarget: true,
    effects: [
      { type: 'directDamage', min: 30, max: 42 },
      { type: 'dot', total: 8, duration: 4, interval: 2 },
    ],
    description: 'Fans a spread of burning cards for $d Fire damage plus a burn.',
  },
  ca_mending_card: {
    id: 'ca_mending_card',
    name: 'Mending Card',
    ...
    requiresTarget: true,
    targetType: 'friendly',
    effects: [{ type: 'heal', min: 34, max: 44 }],
    description: 'Plays a restorative card, healing a friendly target for $d.',
  },
  ca_warding_card: {
    id: 'ca_warding_card',
    name: 'Warding Card',
    ...
    school: 'arcane',
    requiresTarget: false,
    effects: [{ type: 'selfBuff', kind: 'buff_armor', value: 40, duration: 30 }],
    description: 'Surrounds you with a warding card, increasing armor by $b for 30 sec.',
  },
  ca_hex_card: {
    id: 'ca_hex_card',
    name: 'Hex Card',
    ...
    school: 'shadow',
    requiresTarget: true,
    effects: [{ type: 'slow', mult: 0.6, duration: 6 }],
  ...
  ca_empower_card: {
    ...
    school: 'arcane',
    requiresTarget: false,
    effects: [{ type: 'selfBuff', kind: 'buff_int_pct', value: 5, duration: 60 }],
    description: 'Draws on the deck to empower your Intellect by $b% for 1 min.',
  },
  ca_royal_flush: {
    id: 'ca_royal_flush',
    ...
    school: 'fire',
    requiresTarget: true,
    effects: [{ type: 'directDamage', min: 60, max: 82 }],
    description: 'Unleashes a royal flush for $d Fire damage.',
  },
