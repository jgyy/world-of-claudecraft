...
describe('nightkin family bespoke attack (issue #2889)', () => {
  ...
  it('gives mob_nightkin its own ClipMap instead of mutating the shared FLOATING constant', () => {
    ...
    // exactly 6 remaining direct `clips: FLOATING,` usages on this merged base
    // (9 originally, minus batch 1's elemental migration, minus the
    // druid/dragonkin batch's dragonkin migration, minus the one migrated to
    // NIGHTKIN_FLOATING above).
