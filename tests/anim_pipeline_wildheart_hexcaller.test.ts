...
describe('Sunbone Hexcaller bespoke attack/cast (issue #2889 round 2)', () => {
  ...
  it('gives mob_wildheart_hexcaller its own ClipMap (attack and cast) instead of mutating the shared TRIPO_BIPED_FULL_RIG constant', () => {
    ...
    // migrated to WILDHEART_HEXCALLER above, minus mob_wildheart_stalker's,
    // mob_wildheart_ravager's, mob_wildheart_beastmaster's, and mob_wildheart_high_priest's
    // parallel migrations to WILDHEART_STALKER, WILDHEART_RAVAGER, WILDHEART_BEASTMASTER, and
