...
describe('character visual manifest', () => {
  ...
  it('keeps the five Wildheart GLBs on short, non-loop-closed re-cut takes', async () => {
    ...
    for (const key of [
      ...
      // Wildheart_Hexcaller_Attack, scripts/build_wildheart_hexcaller_anims.mjs;
      // mob_wildheart_beastmaster's Wildheart_Beastmaster_Attack,
      // scripts/build_wildheart_beastmaster_anims.mjs; or mob_wildheart_high_priest's
      // Wildheart_High_Priest_Attack, scripts/build_wildheart_high_priest_anims.mjs) ships
