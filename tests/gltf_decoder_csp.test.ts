...
// which no other suite exercises. That is how the desktop build hung: three's ZSTDDecoder
// (KTX2Loader's Zstandard path) boots its WASM via
...
describe('GLB decoder stack vs the desktop shell CSP', () => {
  ...
  it('still sees the zstd data: wasm bootstrap, the desktop world-entry regression', () => {
