// The line-of-sight gate leaf (src/sim/line_of_sight_gate.ts) and the pure
// per-ability rule it composes (src/sim/ability_line_of_sight.ts): which
// abilities need a sight line (the arena point-blank exception included), and
// the composed blocked verdict over a live Sim.

import { describe, expect, it } from 'vitest';
import { abilityNeedsLineOfSight } from '../src/sim/ability_line_of_sight';
import { ABILITIES, arenaOrigin } from '../src/sim/data';
import { hasLineOfSight, lineOfSightBlocked } from '../src/sim/line_of_sight_gate';
