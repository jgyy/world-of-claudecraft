...
//
// `IWorld` (src/world_api.ts:341-510, 163 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (163 / 45 / 118)
...
// The 163 members of `interface IWorld`, in interface order (world_api.ts:342-509).
// Partition: 45 `data` + 118 `method` (read-returning + command-void + 3 async).
...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  ...
  it('the sorted method-kind set is exactly the pinned 117', () => {
...
//   (4) their union, sorted, equals the pinned 163-name IWORLD_MEMBERS set (a member
