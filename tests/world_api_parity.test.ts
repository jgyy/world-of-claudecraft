...
//
// `IWorld` (src/world_api.ts:341-510, 156 members) is the ONE seam render/ui depend
...
// The 156 members of `interface IWorld`, in interface order (world_api.ts:342-509).
...
//   (4) their union, sorted, equals the pinned 156-name IWORLD_MEMBERS set (a member
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 21 facets', () => {
  ...
  it('the union of the 21 facets equals the pinned 156-member IWORLD_MEMBERS set', () => {
