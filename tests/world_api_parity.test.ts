...
// it lands the matching edit here in the SAME commit. The count pins (237 / 63 / 174)
...
// Partition: 63 `data` + 174 `method` (read-returning + command-void + async).
...
//   (4) their union, sorted, equals the pinned 237-name IWORLD_MEMBERS set (a member
