...
//
// `IWorld` (src/world_api.ts:341-511, 149 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (149 / 37 / 112)
...
// The 149 members of `interface IWorld`, in interface order (world_api.ts:342-510).
// Partition: 37 `data` + 112 `method` (read-returning + command-void + 3 async).
