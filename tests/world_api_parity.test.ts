...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  it('pins total / data / method counts', () => {
    ...
    expect(METHOD_MEMBERS.length).toBe(184);
  });
  ...
  it('the full sorted member set is exactly the pinned 253', () => {
  ...
  it('the sorted data-kind set is exactly the pinned 69', () => {
  ...
  it('the sorted method-kind set is exactly the pinned 184', () => {
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 28 facets', () => {
  ...
  it('the union of the 28 facets equals the pinned 253-member IWORLD_MEMBERS set', () => {
