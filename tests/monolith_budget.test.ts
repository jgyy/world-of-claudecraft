...
const MONOLITHS: MonolithRow[] = [
  ...
  },
  {
    ...
    // LOWERED 18350 -> 18348 by the mount-skin preview (feature/store-mount-preview):
    // the two tracker headers' compact-touch chip test moved to
    // src/ui/mobile_hud_layout.ts isCompactTouchHud, paying for the Cosmetics
    // window's store seam line.
    ceiling: 18348,
  ...
  },
  {
    ...
    // the mount inspect's own lifecycle lines with room to spare.
    ceiling: 1225,
