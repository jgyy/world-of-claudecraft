...
const MONOLITHS: MonolithRow[] = [
  ...
  },
  {
    ...
    // zero slack.
    // Down 11822 -> 11812: the four IWorldReliquary completion reads delegate to
    // src/sim/reliquary_reads.ts, the one implementation both hosts share (PR
    // #3933, the piece the account-ledger pull did not take). Exact count.
    ceiling: 11812,
  ...
  },
  {
    ...
    // Down to 5439, the measured count: the four IWorldReliquary completion reads
    // delegate to src/sim/reliquary_reads.ts beside the Sim (PR #3933). Exact
    // count, zero slack.
    ceiling: 5439,
