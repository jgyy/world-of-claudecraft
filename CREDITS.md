...
| Valorsteed gallop layer, reused as the Veil-Wraith Courser's gallop donor pitched up in `scripts/sfx/sfx_speed_map.json` (`mount_run_valorsteed.mp3`, `mount_run_veil_wraith_courser.mp3`) | D4XX, adapted by congusbongus | [Horse gallop on different surfaces](https://opengameart.org/content/horse-gallop-on-different-surfaces), individual `ground.mp3` source identified as CC0 in the included credits | CC0 1.0 | Yes |
| Mount footfall layers (`mount_run_grag_bear.mp3`, `mount_run_shadowjump_toad.mp3`, `mount_run_stormfeather_griffin.mp3`, `mount_run_thunderstrut_gobbler.mp3`), reused as Grimtusk the Ironhide Boar's footfall donor pitched down and Ashfang the Cinderhide Hound's footfall donor pitched up in `scripts/sfx/sfx_speed_map.json` (`mount_run_grimtusk_boar.mp3`, `mount_run_cinderhide_hound.mp3`) | Fantozzi, extracted by qubodup | [Fantozzi's Footsteps](https://opengameart.org/content/fantozzis-footsteps-grasssand-stone) | CC0 1.0 | Yes |
...
| Generated creature model + animations (solmane_charger) | World of ClaudeCraft | Project-generated via scripts/asset_pipeline (Tripo AI 3D, auto-rig + preset retargets) | Project asset | With the project only |
