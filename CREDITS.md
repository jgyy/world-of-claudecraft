...
| Guide and game-client webfonts (`public/fonts/*.woff2`: Cinzel by Natanael Gama; Alegreya, Alegreya Sans, and Alegreya Sans SC by Juan Pablo del Peral, Huerta Tipografica; woff2 subsets latin/latin-ext/cyrillic/vietnamese as served by Google Fonts, self-hosted for the /wiki guide and, since DESIGN.md's typography phase, the game client's `src/styles/fonts.css`) | Natanael Gama; Huerta Tipografica | https://fonts.google.com/specimen/Cinzel , https://fonts.google.com/specimen/Alegreya , https://fonts.google.com/specimen/Alegreya+Sans , https://fonts.google.com/specimen/Alegreya+Sans+SC | SIL OFL 1.1 |
