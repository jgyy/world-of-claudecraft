...
var WAR = ["warrior", "paladin", "shaman"];
var MAG = ["mage", "priest", "warlock", "druid"];
var ROG = ["rogue", "hunter"];
var FERAL = ["druid"];
var CASTER_ALL = [
  "mage",
  "priest",
...
var HUNTER_ONLY = ["hunter"];
var CASTER_WEAPON_CLASSES = [
  "mage",
  "priest",
  "warlock",
  "shaman",
...
var BASE_ITEMS = {
  ...
  riding_training: {
    ...
    sellValue: 0,
    buyValue: 8e5,
    // 80 gold in copper, mirrors RIDING_SKILL_FEE_COPPER
    noMarketList: true
  },
  ...
  // Solmane the Sunveil Charger: earmarked for the Claudium store once mounts
  // are wired into that category (docs/claudium-store.md), same shape as the
  // Courser, the Boar, the Hound, and the Panther above, no player-facing
  // acquisition path yet (see content/mounts.ts). Unbound like every player
  // reins (the tradable-reins policy).
...
var FISHING_TABLES = FISHING_TABLES_BY_BAND[0];
var FISHING_RARE_ID = "glimmerfin_koi";
var RAW_COOKING_CATCH_IDS = /* @__PURE__ */ new Set([
  "raw_mirror_trout",
  "raw_river_perch",
  "raw_marsh_pike",
  "raw_bog_eel",
...
function isRawCookingCatch(itemId) {
