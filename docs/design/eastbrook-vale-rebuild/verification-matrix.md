...
| SRC-01 | Rebuild-v1 town source remains deterministic                   | `tests/eastbrook_town_assets.test.ts`                                                      | Historical town source fingerprint remains `c39af06913c75689d31f8f834001b91186320b2cdba672d5978203b3a6da9048`                                                   | PASS   |
| SRC-02 | Shared atlas remains deterministic                             | `build_surface_atlas.mjs --check` contract                                                 | Fingerprint `35003d8a0d974d69314b7bf3016a20cfd891ee70bec16f6c8d34c1027e66df21`; shipping SHA `d66f2fab603aa83e6c73c6fc4bdde2d545a6d8c1a0d4a58d42a3fb227e5a3f9b` | PASS   |
| SRC-03 | New mailbox source is fingerprinted                            | `tests/eastbrook_mailbox_asset.test.ts`                                                    | `3c6803552368b495ac05758cf7dbe8dd393f8c6cfd4625c587362898e6db687b`                                                                                              | PASS   |
| SRC-04 | New noticeboard source is fingerprinted                        | `tests/eastbrook_noticeboard_asset.test.ts`                                                | `12435757b245583bb91a26450f5bfcf76c3532399b5d8f024af8dae30078265e`                                                                                              | PASS   |
...
| ------ | -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------ |
| GLB-01 | Ravenpost mailbox bytes and hash                   | `32,884`; SHA `24678a6bbc8e8b25926b3c17298b959f0cbd149c7641e1a3331a02a3c19c4207`                                               | PASS                           |
| GLB-02 | Ravenpost mailbox topology                         | `1.65 x 2.9 x 1.05`; `1,640` triangles (`1,336` opaque, `304` metal); `2/2`; two sockets                                       | PASS                           |
| GLB-03 | Noticeboard bytes and hash                         | `24,684`; SHA `a53a3f9818ca57f593ccc448cb1b60862a28bf9cf0d1b17baf43eb6942a0516f`                                               | PASS                           |
