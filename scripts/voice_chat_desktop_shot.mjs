...
try {
  ...
  if (box)
    await page.screenshot({ path: `${OUT_DIR}/voice-chat-desktop-audio-panel-off.png`, clip: box });
  await page.screenshot({ path: `${OUT_DIR}/voice-chat-desktop-options-open-off.png` });

  await clickVoiceToggle(page);
  await wait(300);
  box = await panelBox(page);
  if (box)
    await page.screenshot({ path: `${OUT_DIR}/voice-chat-desktop-audio-panel-on.png`, clip: box });
  await page.screenshot({ path: `${OUT_DIR}/voice-chat-desktop-options-open-on.png` });
